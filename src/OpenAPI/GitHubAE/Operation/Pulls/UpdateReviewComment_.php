...
final class UpdateReviewComment_
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C2B891Cd8673Ab76868860C2Cfd0Baf2A::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
    ...
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequestReviewComment
    {
