...
final class ListSelfHostedRunnersForEnterprise
{
    ...
    {
        return new Request('get', str_replace(['{enterprise}', '{per_page}', '{page}'], [$this->enterprise, $this->per_page, $this->page], '/enterprises/{enterprise}/actions/runners?per_page={per_page}&page={page}'));
    }
