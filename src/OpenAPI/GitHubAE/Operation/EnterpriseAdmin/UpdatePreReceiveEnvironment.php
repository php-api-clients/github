...
final class UpdatePreReceiveEnvironment
{
    ...
    {
        return new Request('patch', str_replace(['{pre_receive_environment_id}'], [$this->pre_receive_environment_id], '/admin/pre-receive-environments/{pre_receive_environment_id}?'));
    }
