...
final class ListEventsForRepo_
{
    ...
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C59Cb7D1390Ff81628624D579E6B02F52|\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\ValidationError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C59Cb7D1390Ff81628624D579E6B02F52::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\GitHubAE\\Schema\\Unknown\\C59Cb7D1390Ff81628624D579E6B02F52', $body);
                }
                break;
