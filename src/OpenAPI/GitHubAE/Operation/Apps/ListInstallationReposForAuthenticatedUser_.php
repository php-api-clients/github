...
final class ListInstallationReposForAuthenticatedUser_
{
    ...
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CC245133E837A8Cb3C2C89E1Abdb58Ec8|\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CC245133E837A8Cb3C2C89E1Abdb58Ec8::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\GitHubAE\\Schema\\Unknown\\CC245133E837A8Cb3C2C89E1Abdb58Ec8', $body);
                }
                break;
            /**Resource not found**/
            case 404:
