...
final class ListAlertInstances
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{alert_number}', '{page}', '{per_page}', '{ref}'], [$this->owner, $this->repo, $this->alert_number, $this->page, $this->per_page, $this->ref], '/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}/instances?page={page}&per_page={per_page}&ref={ref}'));
    }
