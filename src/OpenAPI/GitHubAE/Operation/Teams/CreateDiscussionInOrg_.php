...
final class CreateDiscussionInOrg_
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C45Fc12Bc3634C3A1Ed56D5C4Bb2Ea678::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
