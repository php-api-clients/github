...
final class ListCollaborators
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{affiliation}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->affiliation, $this->per_page, $this->page], '/repos/{owner}/{repo}/collaborators?affiliation={affiliation}&per_page={per_page}&page={page}'));
    }
