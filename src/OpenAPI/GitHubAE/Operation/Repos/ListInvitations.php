...
final class ListInvitations
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->per_page, $this->page], '/repos/{owner}/{repo}/invitations?per_page={per_page}&page={page}'));
    }
