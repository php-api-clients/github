...
final class UpdateWebhook_
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CD55D6Eb4246C7Dda9F5Ee9802F2052Ab::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
    ...
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Hook|\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\ValidationError|\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Hook::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\GitHubAE\\Schema\\Hook', $body);
                }
                break;
