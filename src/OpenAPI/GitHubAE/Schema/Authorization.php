...
final class Authorization
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\App::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\App $app;
    private $note;
    private $note_url;
    ...
    private $fingerprint;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\User $user;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\Installation::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\Installation $installation;
    private $expires_at;
    ...
    public function app() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\App
    {
        return $this->app;
    }
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\User
    {
        return $this->user;
    }
    public function installation() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Authorization\Installation
    {
