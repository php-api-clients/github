...
final class FileCommit
{
    ...
    private $content;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\FileCommit\Commit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\FileCommit\Commit $commit;
    public function content()
    {
        return $this->content;
    }
    public function commit() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\FileCommit\Commit
    {
        return $this->commit;
    }
}
