...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookCheckSuiteRerequested;
...
final class CheckSuite
{
    ...
    public const SCHEMA_TITLE = 'WebhookCheckSuiteRerequested\\CheckSuite';
