...
final class GistComment
{
    ...
    private string $body;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistComment\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistComment\User $user;
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistComment\User
    {
        return $this->user;
    }
