...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\DependabotAlert;
...
final class Dependency
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\DependabotAlertPackage::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\DependabotAlertPackage $package;
    /**
     ...
     * Details for the vulnerable package.
     */
    public function package() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\DependabotAlertPackage
    {
        return $this->package;
    }
    /**
