...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookCodeScanningAlertFixed;
...
final class Alert
{
    ...
    public const SCHEMA_TITLE = 'WebhookCodeScanningAlertFixed\\Alert';
    ...
    private int $number;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Rule::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Rule $rule;
    /**
     * State of a code scanning alert.
     */
    private string $state;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Tool::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Tool $tool;
    private string $url;
    /**
     * The time that the alert was created in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ.`
     */
    ...
    public function rule() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Rule
    {
        return $this->rule;
    }
    /**
    ...
    public function tool() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Alert\Tool
    {
        return $this->tool;
    }
