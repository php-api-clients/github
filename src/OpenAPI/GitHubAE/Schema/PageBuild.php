...
final class PageBuild
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Error::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Error $error;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Pusher::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Pusher $pusher;
    ...
    public function error() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Error
    {
        return $this->error;
    }
    public function pusher() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PageBuild\Pusher
    {
        return $this->pusher;
    }
