...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookSponsorshipPendingTierChange;
...
final class Sponsorship
{
    ...
    public const SCHEMA_TITLE = 'WebhookSponsorshipPendingTierChange\\Sponsorship';
