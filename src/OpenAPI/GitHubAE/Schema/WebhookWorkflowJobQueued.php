...
final class WebhookWorkflowJobQueued
{
    ...
    private array $workflow_job = array();
    /**
     * A request for a specific ref(branch,sha,tag) to be deployed
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Deployment::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Deployment $deployment = null;
    ...
    public function workflow_job() : array
    {
     ...
     * A request for a specific ref(branch,sha,tag) to be deployed
     */
    public function deployment() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Deployment
    {
