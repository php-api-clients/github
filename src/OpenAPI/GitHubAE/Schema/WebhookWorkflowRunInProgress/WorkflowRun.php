...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookWorkflowRunInProgress;
...
final class WorkflowRun
{
    ...
    private $head_branch;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadCommit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadCommit $head_commit;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadRepository::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadRepository $head_repository;
    ...
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\PullRequests>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\PullRequests::class)
     */
    private array $pull_requests = array();
    private $referenced_workflows;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\Repository::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\Repository $repository;
    ...
    public function head_commit() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadCommit
    {
        return $this->head_commit;
    }
    public function head_repository() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\HeadRepository
    {
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\PullRequests>
     */
    ...
    public function repository() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WorkflowRun\Repository
    {
