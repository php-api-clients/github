...
final class GistHistory
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\User $user;
    private string $version;
    private string $committed_at;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\ChangeStatus::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\ChangeStatus $change_status;
    private string $url;
    public function user() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\User
    {
        return $this->user;
    }
    ...
    public function change_status() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GistHistory\ChangeStatus
    {
