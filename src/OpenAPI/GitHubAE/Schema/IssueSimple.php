...
final class IssueSimple
{
    ...
    private $user;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Label>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Label::class)
     */
