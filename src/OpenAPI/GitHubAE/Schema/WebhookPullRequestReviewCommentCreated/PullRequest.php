...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookPullRequestReviewCommentCreated;
...
final class PullRequest
{
    ...
    public const SCHEMA_TITLE = 'WebhookPullRequestReviewCommentCreated\\PullRequest';
