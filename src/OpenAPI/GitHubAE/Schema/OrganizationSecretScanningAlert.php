...
final class OrganizationSecretScanningAlert
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\UpdatedAt::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\UpdatedAt $updated_at;
    /**
    ...
    private $resolved_at;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\ResolvedBy::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\ResolvedBy $resolved_by;
    /**
    ...
    */
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\PushProtectionBypassedBy::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\PushProtectionBypassedBy $push_protection_bypassed_by;
    /**
    ...
    public function updated_at() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\UpdatedAt
    {
    ...
    public function resolved_by() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\ResolvedBy
    {
    ...
    */
    ...
    public function push_protection_bypassed_by() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrganizationSecretScanningAlert\PushProtectionBypassedBy
    {
