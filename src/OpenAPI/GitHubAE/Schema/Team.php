...
final class Team
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Permissions::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Permissions $permissions = null;
    private string $url;
    private string $html_url;
    private string $members_url;
    private string $repositories_url;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Parent::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Parent $parent;
    ...
    public function permissions() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Permissions
    {
    ...
    public function parent() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Team\Parent
    {
        return $this->parent;
    }
}
