...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookPullRequestLocked;
...
final class PullRequest
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Links::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Links $_links;
    private $active_lock_reason;
    private ?int $additions = null;
    private $assignee;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Assignees>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Assignees::class)
     */
    ...
    private $auto_merge;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Base::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Base $base;
    private $body;
    ...
    private bool $draft;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Head::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Head $head;
    ...
    private $rebaseable;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedReviewers>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedReviewers::class)
     */
    private array $requested_reviewers = array();
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedTeams>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedTeams::class)
     */
    ...
    private string $url;
    private $user;
    public function _links() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Links
    {
        return $this->_links;
    }
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Assignees>
     */
    ...
    public function base() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Base
    {
        return $this->base;
    }
    ...
    public function head() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Head
    {
        return $this->head;
    }
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\Labels>
     */
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedReviewers>
     */
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\PullRequest\RequestedTeams>
     */
