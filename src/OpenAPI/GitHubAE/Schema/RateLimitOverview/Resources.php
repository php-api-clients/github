...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimitOverview;
...
final class Resources
{
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $core;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $graphql = null;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $search;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $source_import = null;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $integration_manifest = null;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $code_scanning_upload = null;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $actions_runner_registration = null;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit $scim = null;
    public function core() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->core;
    }
    public function graphql() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->graphql;
    }
    public function search() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->search;
    }
    public function source_import() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->source_import;
    }
    public function integration_manifest() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->integration_manifest;
    }
    public function code_scanning_upload() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->code_scanning_upload;
    }
    public function actions_runner_registration() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->actions_runner_registration;
    }
    public function scim() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RateLimit
    {
        return $this->scim;
    }
}
