...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookSponsorshipPendingCancellation;
...
final class Sponsorship
{
    ...
    public const SCHEMA_TITLE = 'WebhookSponsorshipPendingCancellation\\Sponsorship';
    public const SCHEMA_DESCRIPTION = '';
    private string $created_at;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Maintainer::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Maintainer $maintainer = null;
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Tier::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Tier $tier;
    public function created_at() : string
    {
        return $this->created_at;
    }
    public function maintainer() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Maintainer
    {
     ...
     * The `tier_changed` and `pending_tier_change` will include the original tier before the change or pending change. For more information, see the pending tier change payload.
     */
    public function tier() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Sponsorship\Tier
    {
        return $this->tier;
    }
}
