...
final class LicenseContent
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\Links::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\Links $_links;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\License::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\License $license;
    ...
    public function _links() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\Links
    {
        return $this->_links;
    }
    public function license() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\LicenseContent\License
    {
        return $this->license;
    }
}
