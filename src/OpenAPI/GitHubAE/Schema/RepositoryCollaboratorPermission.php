...
final class RepositoryCollaboratorPermission
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RepositoryCollaboratorPermission\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RepositoryCollaboratorPermission\User $user;
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\RepositoryCollaboratorPermission\User
    {
        return $this->user;
    }
}
