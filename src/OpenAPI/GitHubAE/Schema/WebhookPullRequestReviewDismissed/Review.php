...
final class Review
{
    ...
    public const SCHEMA_TITLE = 'WebhookPullRequestReviewDismissed\\Review';
    public const SCHEMA_DESCRIPTION = 'The review that was affected.';
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Review\Links::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Review\Links $_links;
    /**
    ...
    private $user;
    public function _links() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Review\Links
    {
        return $this->_links;
    }
    /**
