...
final class CFd7F1157Ce674175F74751Ab8Ade34Da
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CF0Aa5C2C04Ddaff523Ad29517A1A1Fb6::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CF0Aa5C2C04Ddaff523Ad29517A1A1Fb6 $author = null;
    /**
     * Information about the person who is making the commit. By default, `committer` will use the information set in `author`. See the `author` and `committer` object below for details.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C149119C3D24Cf440D9Ef06B7F1A0B3E7::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C149119C3D24Cf440D9Ef06B7F1A0B3E7 $committer = null;
    /**
     ...
     * Information about the author of the commit. By default, the `author` will be the authenticated user and the current date. See the `author` and `committer` object below for details.
     */
    public function author() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CF0Aa5C2C04Ddaff523Ad29517A1A1Fb6
    {
        return $this->author;
    }
    /**
     * Information about the person who is making the commit. By default, `committer` will use the information set in `author`. See the `author` and `committer` object below for details.
     */
    public function committer() : ?\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\C149119C3D24Cf440D9Ef06B7F1A0B3E7
    {
