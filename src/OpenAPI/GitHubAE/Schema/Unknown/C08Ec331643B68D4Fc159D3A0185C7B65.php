...
final class C08Ec331643B68D4Fc159D3A0185C7B65
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CEba3A0C125A64A1A89496A54C3A51740::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CEba3A0C125A64A1A89496A54C3A51740 $app;
    private $before;
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CFf56Cc5Ba763Eea771Aa4Ac6F5624593>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CFf56Cc5Ba763Eea771Aa4Ac6F5624593::class)
     */
     ...
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     */
    public function app() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CEba3A0C125A64A1A89496A54C3A51740
    {
        return $this->app;
    }
    ...
    /**
     * An array of pull requests that match this check suite. A pull request matches a check suite if they have the same `head_sha` and `head_branch`. When the check suite's `head_branch` is in a forked repository it will be `null` and the `pull_requests` array will be empty.
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Unknown\CFf56Cc5Ba763Eea771Aa4Ac6F5624593>
     */
