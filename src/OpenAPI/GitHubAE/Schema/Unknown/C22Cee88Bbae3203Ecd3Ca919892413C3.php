...
final class C22Cee88Bbae3203Ecd3Ca919892413C3
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\C22Cee88Bbae3203Ecd3Ca919892413C3\Source::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\C22Cee88Bbae3203Ecd3Ca919892413C3\Source $source;
    /**
     * The process in which the Page will be built. Possible values are `"legacy"` and `"workflow"`.
     */
     ...
     * The source branch and directory used to publish your Pages site.
     */
    public function source() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\C22Cee88Bbae3203Ecd3Ca919892413C3\Source
    {
        return $this->source;
    }
}
