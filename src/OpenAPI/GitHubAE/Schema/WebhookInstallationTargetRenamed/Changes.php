...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookInstallationTargetRenamed;
...
final class Changes
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Changes\Slug::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Changes\Slug $slug;
    public function login() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Changes\Login
    {
        return $this->login;
    }
    public function slug() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\Changes\Slug
    {
        return $this->slug;
    }
}
