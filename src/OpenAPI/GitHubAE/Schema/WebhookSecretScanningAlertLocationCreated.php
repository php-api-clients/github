...
final class WebhookSecretScanningAlertLocationCreated
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningAlert::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningAlert $alert;
    /**
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningLocation::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningLocation $location;
    /**
    ...
    public function alert() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningAlert
    {
        return $this->alert;
    }
    /**
    ...
    public function location() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\SecretScanningLocation
    {
