...
final class GitCommit
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Author::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Author $author;
    /**
     * Identifying information for the git-user
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Committer::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Committer $committer;
    /**
     * Message describing the purpose of the commit
     */
    private string $message;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Tree::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Tree $tree;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Parents>
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Verification::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Verification $verification;
     ...
     * Identifying information for the git-user
     */
    public function author() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Author
    {
        return $this->author;
    }
    /**
     * Identifying information for the git-user
     */
    public function committer() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Committer
    {
    ...
    public function tree() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Tree
    {
        return $this->tree;
    }
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Parents>
     */
    public function parents() : array
    {
        return $this->parents;
    }
    public function verification() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\GitCommit\Verification
    {
