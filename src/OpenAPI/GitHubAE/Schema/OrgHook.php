...
final class OrgHook
{
    ...
    private string $name;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Events>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Events::class)
     */
    private array $events = array();
    private bool $active;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Config::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Config $config;
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Events>
     */
    ...
    public function config() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\OrgHook\Config
    {
        return $this->config;
    }
