...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookPullRequestReviewCommentDeleted;
...
final class PullRequest
{
    ...
    public const SCHEMA_TITLE = 'WebhookPullRequestReviewCommentDeleted\\PullRequest';
