...
namespace ApiClients\Client\Github\OpenAPI\GitHubAE\Schema\WebhookSponsorshipCancelled;
...
final class Sponsorship
{
    ...
    public const SCHEMA_TITLE = 'WebhookSponsorshipCancelled\\Sponsorship';
