...
final class Client
{
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Meta();
    }
    public function enterpriseAdmin() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\EnterpriseAdmin
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\EnterpriseAdmin();
    }
    public function apps() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Apps
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Apps();
    }
    public function codesOfConduct() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\CodesOfConduct
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\CodesOfConduct();
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Gists();
    }
    public function gitignore() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Gitignore
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Gitignore();
    }
    public function issues() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Issues
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Issues();
    }
    public function licenses() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Licenses
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Licenses();
    }
    public function markdown() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Markdown
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Markdown();
    }
    public function orgs() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Orgs
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Orgs();
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Migrations();
    }
    public function projects() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Projects
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Projects();
    }
    public function repos() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Repos
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Repos();
    }
    public function reactions() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Reactions
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Reactions();
    }
    public function rateLimit() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\RateLimit
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\RateLimit();
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Search();
    }
    public function users() : \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Users
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubAE\Operation\Users();
    }
}
