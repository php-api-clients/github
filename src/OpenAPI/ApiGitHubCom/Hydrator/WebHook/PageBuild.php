...
class PageBuild implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild' => $this->hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild($payload),
                'ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build' => $this->hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild⚡️Build($payload),
                ...
                'ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error' => $this->hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️PageBuild⚡️Error($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild(array $payload): \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild⚡️Build($value);
                    } finally {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️PageBuild⚡️Error($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild\Build', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️PageBuild⚡️Error(array $payload): \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PageBuild\Error', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPageBuild);
        $result = [];
        ...
        $build = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️WebhookPageBuild⚡️Build($build);
