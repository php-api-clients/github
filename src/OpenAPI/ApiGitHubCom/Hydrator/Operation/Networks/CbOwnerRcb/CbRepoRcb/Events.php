...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Actor;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Event;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Event\Payload;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Event\Repo;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\PullRequest;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\IssueComment;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ReactionRollup;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repository;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repository\Permissions;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repository\TemplateRepository;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repository\TemplateRepository\Owner;
...
class Events implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Event(array $payload): Event
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Event::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Event⚡️Repo(array $payload): Repo
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Event⚡️Payload(array $payload): Payload
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Issue(array $payload): Issue
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️IssueComment(array $payload): IssueComment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Issue⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️ReactionRollup(array $payload): ReactionRollup
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Repository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Repository⚡️TemplateRepository(array $payload): TemplateRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Repository⚡️TemplateRepository⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof Event);
        $result = [];
