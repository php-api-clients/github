...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SecretScanningAlert;
...
class CbAlertNumberRcb implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️SecretScanningAlert(array $payload): SecretScanningAlert
    {
        $properties    = [];
        $missingFields = [];
        try {
