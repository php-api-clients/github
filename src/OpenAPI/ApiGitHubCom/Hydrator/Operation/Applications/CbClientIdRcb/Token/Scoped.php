...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Authorization;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Authorization\App;
...
class Scoped implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Authorization(array $payload): Authorization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️OpenAPI⚡️ApiGitHubCom⚡️Schema⚡️Authorization⚡️App(array $payload): App
    {
        $properties    = [];
        $missingFields = [];
        try {
