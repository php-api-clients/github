...
final class ListDiscussionsInOrg
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\Discussions $hydrator, string $org, string $team_slug, string $pinned, string $direction = 'desc', int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
