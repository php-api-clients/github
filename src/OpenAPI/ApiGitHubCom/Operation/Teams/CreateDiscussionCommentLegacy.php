...
final class CreateDiscussionCommentLegacy
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateDiscussionCommentLegacy\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
