...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Teams\CbTeamIdRcb\Repos;
...
final class ListReposLegacy
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Repos $hydrator, int $team_id, int $per_page = 30, int $page = 1)
    {
