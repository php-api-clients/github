...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Teams\UpdateLegacy\Request\Applicationjson;
...
final class UpdateLegacy
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, CbTeamIdRcb $hydrator, int $team_id)
    {
    ...
    function createResponse(ResponseInterface $response): TeamFull|BasicError|ValidationError
    {
