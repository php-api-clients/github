...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\Projects;
...
final class ListProjectsInOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Projects $hydrator, string $org, string $team_slug, int $per_page = 30, int $page = 1)
    {
        $this->org                     = $org;
