...
final class List_
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Teams $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    /**
     * @return Observable<Team>|BasicError
     */
