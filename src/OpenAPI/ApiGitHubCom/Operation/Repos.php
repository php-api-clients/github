...
final class Repos
{
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\ListCollaborators_($owner, $repo, $affiliation, $permission, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\ListDeploymentBranchPolicies_($owner, $repo, $environment_name, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\CreateDeploymentBranchPolicy_($owner, $repo, $environment_name);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\GetDeploymentBranchPolicy_($owner, $repo, $environment_name, $branch_policy_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\UpdateDeploymentBranchPolicy_($owner, $repo, $environment_name, $branch_policy_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\DeleteDeploymentBranchPolicy_($owner, $repo, $environment_name, $branch_policy_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\ListWebhookDeliveries_($owner, $repo, $hook_id, $per_page, $cursor, $redelivery);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Repos\CreatePagesDeployment_($owner, $repo);
    }
