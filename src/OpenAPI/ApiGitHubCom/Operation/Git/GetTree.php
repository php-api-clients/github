...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Trees\CbTreeShaRcb;
...
final class GetTree
{
    ...
    private readonly CbTreeShaRcb $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, CbTreeShaRcb $hydrator, string $owner, string $repo, string $tree_sha, string $recursive)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request(self::METHOD, str_replace(['{owner}', '{repo}', '{tree_sha}', '{recursive}'], [$this->owner, $this->repo, $this->tree_sha, $this->recursive], self::PATH . '?recursive={recursive}'));
    }
