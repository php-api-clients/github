...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Commits;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateCommit\Request\Applicationjson;
...
final class CreateCommit
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Commits $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): GitCommit|ValidationError|BasicError
    {
