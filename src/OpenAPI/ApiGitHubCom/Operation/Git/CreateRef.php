...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Refs;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateRef\Request\Applicationjson;
...
final class CreateRef
{
    ...
    private readonly Refs $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Refs $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): GitRef|ValidationError
    {
