...
final class CreateRef
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateRef\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
