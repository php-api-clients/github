...
final class CreateTree
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateTree\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
