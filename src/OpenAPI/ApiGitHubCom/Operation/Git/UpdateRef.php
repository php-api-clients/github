...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\UpdateRef\Request\Applicationjson;
...
final class UpdateRef
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, CbRefRcb $hydrator, string $owner, string $repo, string $ref)
    {
