...
final class UpdateRef
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateRef\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
