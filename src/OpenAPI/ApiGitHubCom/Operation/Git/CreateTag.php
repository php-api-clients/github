...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Tags;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateTag\Request\Applicationjson;
...
final class CreateTag
{
    ...
    private readonly Tags $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Tags $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): GitTag|ValidationError
    {
