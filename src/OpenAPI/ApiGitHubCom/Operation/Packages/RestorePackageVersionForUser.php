...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Users\CbUsernameRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions\CbPackageVersionIdRcb\Restore;
...
final class RestorePackageVersionForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Restore $hydrator, string $package_type, string $package_name, string $username, int $package_version_id)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{package_type}', '{package_name}', '{username}', '{package_version_id}'], [$this->package_type, $this->package_name, $this->username, $this->package_version_id], self::PATH));
    }
