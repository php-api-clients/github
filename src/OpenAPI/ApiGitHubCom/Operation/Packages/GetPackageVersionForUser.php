...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Users\CbUsernameRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions\CbPackageVersionIdRcb;
...
final class GetPackageVersionForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbPackageVersionIdRcb $hydrator, string $package_type, string $package_name, int $package_version_id, string $username)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{package_type}', '{package_name}', '{package_version_id}', '{username}'], [$this->package_type, $this->package_name, $this->package_version_id, $this->username], self::PATH));
    }
