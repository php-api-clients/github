...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Packages\CbPackageTypeRcb\CbPackageNameRcb;
...
final class GetPackageForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbPackageNameRcb $hydrator, string $package_type, string $package_name)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{package_type}', '{package_name}'], [$this->package_type, $this->package_name], self::PATH));
    }
