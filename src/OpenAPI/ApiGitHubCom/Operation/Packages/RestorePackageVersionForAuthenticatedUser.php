...
final class RestorePackageVersionForAuthenticatedUser
{
    ...
    {
        return new Request('post', str_replace(['{package_type}', '{package_name}', '{package_version_id}'], [$this->package_type, $this->package_name, $this->package_version_id], '/user/packages/{package_type}/{package_name}/versions/{package_version_id}/restore?'));
    }
