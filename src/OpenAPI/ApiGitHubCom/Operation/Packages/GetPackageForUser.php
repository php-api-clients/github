...
final class GetPackageForUser
{
    ...
    {
        return new Request('get', str_replace(['{package_type}', '{package_name}', '{username}'], [$this->package_type, $this->package_name, $this->username], '/users/{username}/packages/{package_type}/{package_name}?'));
    }
