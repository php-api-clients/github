...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions\CbPackageVersionIdRcb;
...
final class DeletePackageVersionForOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbPackageVersionIdRcb $hydrator, string $package_type, string $package_name, string $org, int $package_version_id)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{package_type}', '{package_name}', '{org}', '{package_version_id}'], [$this->package_type, $this->package_name, $this->org, $this->package_version_id], self::PATH));
    }
