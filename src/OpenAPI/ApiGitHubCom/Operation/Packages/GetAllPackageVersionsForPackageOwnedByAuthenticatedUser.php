...
final class GetAllPackageVersionsForPackageOwnedByAuthenticatedUser
{
    ...
    {
        return new Request('get', str_replace(['{package_type}', '{package_name}', '{page}', '{per_page}', '{state}'], [$this->package_type, $this->package_name, $this->page, $this->per_page, $this->state], '/user/packages/{package_type}/{package_name}/versions?page={page}&per_page={per_page}&state={state}'));
    }
