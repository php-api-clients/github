...
final class GetPackageForOrganization
{
    ...
    {
        return new Request('get', str_replace(['{package_type}', '{package_name}', '{org}'], [$this->package_type, $this->package_name, $this->org], '/orgs/{org}/packages/{package_type}/{package_name}?'));
    }
