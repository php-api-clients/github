...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Applications\CbClientIdRcb\Token;
...
final class DeleteToken
{
    ...
    private readonly Token $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Token $hydrator, string $client_id)
    {
