...
final class DeleteToken
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DeleteToken\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
