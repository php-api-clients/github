...
final class CreateInstallationAccessToken
{
    ...
    private readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\App\Installations\CbInstallationIdRcb\AccessTokens $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\App\Installations\CbInstallationIdRcb\AccessTokens $hydrator, int $installation_id)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Apps\CreateInstallationAccessToken\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
