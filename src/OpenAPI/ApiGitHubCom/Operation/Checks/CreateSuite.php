...
final class CreateSuite
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\CD8C76D7Ad348Ab6504A3950D2F39Fc13::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\CheckSuite', $body);
                }
                break;
