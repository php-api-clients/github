...
final class SetSuitesPreferences
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\CAccd9C475167Af80Ae0Dbc2336B02326::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\CheckSuitePreference', $body);
                }
                break;
        }
