...
final class Create
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\C4A55E2F068Cfeb8D8A6F8A787C75Be55::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
            ...
            case 201:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\CheckRun', $body);
                }
                break;
        }
