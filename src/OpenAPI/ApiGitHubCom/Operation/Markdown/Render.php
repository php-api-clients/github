...
final class Render
{
    ...
    /**
     * @return \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\Render\Response\Text\Html\H200
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\Render\Response\Text\Html\H200
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'text/html':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\Operation\\Render\\Response\\Text\\Html\\H200', $body);
                }
                break;
            /**Not modified**/
            case 304:
