...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Users\CbUsernameRcb\Settings\Billing\Packages;
...
final class GetGithubPackagesBillingUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Packages $hydrator, string $username)
    {
