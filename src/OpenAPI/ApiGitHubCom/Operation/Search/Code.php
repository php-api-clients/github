...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\Search\Code\Response\Applicationjson\H200;
...
final class Code
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Search\Code $hydrator, string $q, string $sort, string $order = 'desc', int $per_page = 30, int $page = 1)
    {
        $this->q                       = $q;
        $this->sort                    = $sort;
        $this->order                   = $order;
