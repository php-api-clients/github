...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators\CbUsernameRcb;
...
final class RemoveCollaborator
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbUsernameRcb $hydrator, int $project_id, string $username)
    {
