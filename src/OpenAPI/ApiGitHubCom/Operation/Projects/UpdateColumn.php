...
final class UpdateColumn
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateColumn\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
