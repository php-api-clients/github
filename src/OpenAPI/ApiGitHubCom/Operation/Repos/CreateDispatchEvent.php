...
final class CreateDispatchEvent
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateDispatchEvent\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
