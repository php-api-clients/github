...
final class GetPagesHealthCheck_
{
    private const OPERATION_ID = 'repos/get-pages-health-check';
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\PagesHealthCheck', $body);
                }
                break;
            /**Empty response**/
            case 202:
