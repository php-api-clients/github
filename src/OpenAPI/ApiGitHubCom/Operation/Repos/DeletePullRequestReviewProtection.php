...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\RequiredPullRequestReviews;
...
final class DeletePullRequestReviewProtection
{
    ...
    private readonly RequiredPullRequestReviews $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, RequiredPullRequestReviews $hydrator, string $owner, string $repo, string $branch)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->branch                  = $branch;
