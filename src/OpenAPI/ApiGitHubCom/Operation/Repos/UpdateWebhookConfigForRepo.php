...
final class UpdateWebhookConfigForRepo
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateWebhookConfigForRepo\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
