...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\ReplaceAllTopics\Request\Applicationjson;
...
final class ReplaceAllTopics
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Topics $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): Topic|BasicError|ValidationErrorSimple
    {
