...
final class MergeUpstream
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MergeUpstream\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
