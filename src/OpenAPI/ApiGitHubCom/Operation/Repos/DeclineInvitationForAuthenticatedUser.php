...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\RepositoryInvitations\CbInvitationIdRcb;
...
final class DeclineInvitationForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbInvitationIdRcb $hydrator, int $invitation_id)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{invitation_id}'], [$this->invitation_id], self::PATH));
    }
