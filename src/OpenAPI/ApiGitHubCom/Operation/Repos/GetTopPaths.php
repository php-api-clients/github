            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) use($hydrator) : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ContentTraffic {
                            return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\ContentTraffic', $body);
                        });
                }
                break;
            /**Forbidden**/
