...
final class CreateOrUpdateFileContents
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateOrUpdateFileContents\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
