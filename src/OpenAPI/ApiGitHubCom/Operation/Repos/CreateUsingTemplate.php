...
final class CreateUsingTemplate
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateUsingTemplate\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
