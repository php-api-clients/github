...
final class AddUserAccessRestrictions
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AddUserAccessRestrictions\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
