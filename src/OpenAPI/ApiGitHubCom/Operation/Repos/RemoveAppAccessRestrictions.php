...
final class RemoveAppAccessRestrictions
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RemoveAppAccessRestrictions\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
