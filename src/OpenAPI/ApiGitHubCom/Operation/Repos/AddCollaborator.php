...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Collaborators\CbUsernameRcb;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\AddCollaborator\Request\Applicationjson;
...
final class AddCollaborator
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, CbUsernameRcb $hydrator, string $owner, string $repo, string $username)
    {
    ...
    function createResponse(ResponseInterface $response): RepositoryInvitation|ValidationError|BasicError
    {
