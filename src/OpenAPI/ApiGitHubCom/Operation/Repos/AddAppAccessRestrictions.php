...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\Restrictions\Apps;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Integration;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\SetAppAccessRestrictions\Request\Applicationjson;
...
final class AddAppAccessRestrictions
{
    ...
    private readonly Apps $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Apps $hydrator, string $owner, string $repo, string $branch)
    {
    ...
    /**
     * @return Observable<Integration>|ValidationError
     */
