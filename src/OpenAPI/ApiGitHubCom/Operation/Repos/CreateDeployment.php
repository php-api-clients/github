            ...
            case 202:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\Operation\\CreateDeployment\\Response\\Application\\Json\\H202', $body);
                }
                break;
