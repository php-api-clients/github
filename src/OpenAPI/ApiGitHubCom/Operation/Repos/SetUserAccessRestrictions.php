...
final class SetUserAccessRestrictions
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetUserAccessRestrictions\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
