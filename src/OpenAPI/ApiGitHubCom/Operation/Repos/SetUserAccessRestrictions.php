...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\Restrictions\Users;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\SetUserAccessRestrictions\Request\Applicationjson;
...
final class SetUserAccessRestrictions
{
    ...
    private readonly Users $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Users $hydrator, string $owner, string $repo, string $branch)
    {
    ...
    /**
     * @return Observable<SimpleUser>|ValidationError
     */
