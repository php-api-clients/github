...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Teams;
...
final class ListTeams
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Teams $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
