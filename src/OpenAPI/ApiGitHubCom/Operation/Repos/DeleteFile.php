...
final class DeleteFile
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\DeleteFile\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
