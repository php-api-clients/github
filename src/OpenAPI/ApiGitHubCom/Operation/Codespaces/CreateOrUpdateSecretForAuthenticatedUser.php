...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Codespaces\CreateOrUpdateSecretForAuthenticatedUser\Request\Applicationjson;
...
final class CreateOrUpdateSecretForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, CbSecretNameRcb $hydrator, string $secret_name)
    {
    ...
    function createRequest(array $data = []): RequestInterface
    {
        ...
        return new Request(self::METHOD, str_replace(['{secret_name}'], [$this->secret_name], self::PATH), ['Content-Type' => 'application/json'], json_encode($data));
    }

    function createResponse(ResponseInterface $response): EmptyObject|ValidationError|BasicError
    {
