...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Start;
...
final class StartForAuthenticatedUser
{
    ...
    private readonly Start $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Start $hydrator, string $codespace_name)
    {
    ...
    function createResponse(ResponseInterface $response): Codespace|BasicError|ScimError
    {
