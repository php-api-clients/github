...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Members\CbUsernameRcb\Codespaces\CbCodespaceNameRcb\Stop;
...
final class StopInOrganization
{
    ...
    private readonly Stop $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Stop $hydrator, string $org, string $username, string $codespace_name)
    {
        $this->org                     = $org;
