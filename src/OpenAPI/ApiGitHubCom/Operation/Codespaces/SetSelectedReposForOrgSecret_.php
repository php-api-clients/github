...
final class SetSelectedReposForOrgSecret_
{
    ...
    {
        return new \RingCentral\Psr7\Request('put', \str_replace(array('{org}', '{secret_name}'), array($this->org, $this->secret_name), '/orgs/{org}/codespaces/secrets/{secret_name}/repositories'));
    }
