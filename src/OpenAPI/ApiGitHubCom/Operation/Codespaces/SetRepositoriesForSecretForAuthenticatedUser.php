...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\Applicationjson;
...
final class SetRepositoriesForSecretForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Repositories $hydrator, string $secret_name)
    {
