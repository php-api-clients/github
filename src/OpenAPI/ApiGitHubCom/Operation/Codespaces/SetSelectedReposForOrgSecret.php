...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Codespaces\SetSelectedReposForOrgSecret\Request\Applicationjson;
...
final class SetSelectedReposForOrgSecret
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Repositories $hydrator, string $org, string $secret_name)
    {
