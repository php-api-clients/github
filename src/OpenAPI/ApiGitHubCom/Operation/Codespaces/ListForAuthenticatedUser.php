...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Codespaces;
...
final class ListForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Codespaces $hydrator, int $repository_id, int $per_page = 30, int $page = 1)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{repository_id}', '{per_page}', '{page}'], [$this->repository_id, $this->per_page, $this->page], self::PATH . '?repository_id={repository_id}&per_page={per_page}&page={page}'));
    }
