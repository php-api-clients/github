...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Codespaces\Secrets;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\Codespaces\ListSecretsForAuthenticatedUser\Response\Applicationjson\H200;
...
final class ListSecretsForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Secrets $hydrator, int $per_page = 30, int $page = 1)
    {
