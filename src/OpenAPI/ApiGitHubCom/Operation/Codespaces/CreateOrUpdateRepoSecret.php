...
final class CreateOrUpdateRepoSecret
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\C7Cd73Cefb28D28C904A063250578A3Ad::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
