...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Codespaces\CreateForAuthenticatedUser\Request\Applicationjson;
...
final class CreateForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Codespaces $hydrator)
    {
