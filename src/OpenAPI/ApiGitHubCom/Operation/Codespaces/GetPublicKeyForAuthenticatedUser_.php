...
final class GetPublicKeyForAuthenticatedUser_
{
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\CodespacesUserPublicKey', $body);
                }
                break;
        }
