...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Codespaces\Secrets\CbSecretNameRcb;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RepoCodespacesSecret;
...
final class GetRepoSecret
{
    ...
    function createResponse(ResponseInterface $response): RepoCodespacesSecret
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(RepoCodespacesSecret::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
