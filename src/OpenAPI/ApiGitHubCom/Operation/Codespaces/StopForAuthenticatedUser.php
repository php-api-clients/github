...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Stop;
...
final class StopForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Stop $hydrator, string $codespace_name)
    {
