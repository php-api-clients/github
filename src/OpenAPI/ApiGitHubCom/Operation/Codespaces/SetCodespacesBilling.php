...
final class SetCodespacesBilling
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetCodespacesBilling\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
