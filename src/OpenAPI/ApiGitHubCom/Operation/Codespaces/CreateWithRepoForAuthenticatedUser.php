            ...
            case 503:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\Operation\\CreateWithRepoForAuthenticatedUser\\Response\\Application\\Json\\H503', $body);
                }
                break;
        }
