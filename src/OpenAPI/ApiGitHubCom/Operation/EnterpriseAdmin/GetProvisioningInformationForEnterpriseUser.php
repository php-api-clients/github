...
{
    private const OPERATION_ID = 'enterprise-admin/get-provisioning-information-for-enterprise-user';
    ...
    {
        return new Request('get', str_replace(['{enterprise}', '{scim_user_id}'], [$this->enterprise, $this->scim_user_id], '/scim/v2/enterprises/{enterprise}/Users/{scim_user_id}?'));
    }
