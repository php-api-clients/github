...
final class SetSelectedOrganizationsEnabledGithubActionsEnterprise
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetSelectedOrganizationsEnabledGithubActionsEnterprise\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
