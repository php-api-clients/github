...
final class UpdateSelfHostedRunnerGroupForEnterprise
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateSelfHostedRunnerGroupForEnterprise\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
