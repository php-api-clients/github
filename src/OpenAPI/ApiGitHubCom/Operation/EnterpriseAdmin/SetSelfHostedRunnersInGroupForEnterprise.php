...
final class SetSelfHostedRunnersInGroupForEnterprise
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetSelfHostedRunnersInGroupForEnterprise\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
