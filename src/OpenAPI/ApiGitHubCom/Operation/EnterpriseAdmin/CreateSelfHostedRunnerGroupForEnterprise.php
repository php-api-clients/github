...
final class CreateSelfHostedRunnerGroupForEnterprise
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateSelfHostedRunnerGroupForEnterprise\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
