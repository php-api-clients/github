...
final class Packages
{
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\ListPackagesForOrganization($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $org, $visibility);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageForOrganization($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org, $token);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org, $page, $per_page, $state);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageVersionForOrganization($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageVersionForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageVersionForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $org, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\ListPackagesForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $visibility);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $token);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetAllPackageVersionsForPackageOwnedByAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $page, $per_page, $state);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageVersionForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageVersionForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageVersionForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\ListPackagesForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $visibility, $username);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username, $token);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetAllPackageVersionsForPackageOwnedByUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\GetPackageVersionForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $package_version_id, $username);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\DeletePackageVersionForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username, $package_version_id);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Packages\RestorePackageVersionForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $package_type, $package_name, $username, $package_version_id);
    }
}
