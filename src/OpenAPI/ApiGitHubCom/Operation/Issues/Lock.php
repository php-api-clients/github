...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issues\Lock\Request\Applicationjson;
...
final class Lock
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Issues\CbIssueNumberRcb\Lock $hydrator, string $owner, string $repo, int $issue_number)
    {
