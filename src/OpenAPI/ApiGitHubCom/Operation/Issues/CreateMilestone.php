...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Milestones;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issues\CreateMilestone\Request\Applicationjson;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Milestone;
...
final class CreateMilestone
{
    ...
    private readonly Milestones $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Milestones $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): Milestone|BasicError|ValidationError
    {
