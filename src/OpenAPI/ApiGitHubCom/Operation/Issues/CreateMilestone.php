...
final class CreateMilestone
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issues\CreateMilestone\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
