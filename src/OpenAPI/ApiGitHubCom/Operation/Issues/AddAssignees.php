...
final class AddAssignees
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issues\AddAssignees\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
