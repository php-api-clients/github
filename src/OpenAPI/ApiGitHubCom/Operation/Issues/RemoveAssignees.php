...
final class RemoveAssignees
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RemoveAssignees\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
