...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Labels;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issues\CreateLabel\Request\Applicationjson;
...
final class CreateLabel
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Labels $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): Label|ValidationError|BasicError
    {
