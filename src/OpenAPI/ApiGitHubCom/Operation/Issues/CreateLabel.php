...
final class CreateLabel
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateLabel\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
