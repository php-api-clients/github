...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Migrations\StartImport\Request\Applicationjson;
...
final class StartImport
{
    ...
    function createResponse(ResponseInterface $response): \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Import|ValidationError|BasicError
    {
