...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Import\Lfs;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BasicError;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Import;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Migrations\SetLfsPreference\Request\Applicationjson;
...
final class SetLfsPreference
{
    ...
    private readonly Lfs $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Lfs $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): Import|ValidationError|BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Import::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
