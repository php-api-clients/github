...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Migrations\CbMigrationIdRcb\Repos\CbRepoNameRcb\Lock;
...
final class UnlockRepoForOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Lock $hydrator, string $org, int $migration_id, string $repo_name)
    {
        $this->org                     = $org;
    ...
    {
        return new Request(self::METHOD, str_replace(['{org}', '{migration_id}', '{repo_name}'], [$this->org, $this->migration_id, $this->repo_name], self::PATH));
    }
