...
final class ListReposForUser
{
    ...
    {
        return new Request('get', str_replace(['{migration_id}', '{per_page}', '{page}'], [$this->migration_id, $this->per_page, $this->page], '/user/migrations/{migration_id}/repositories?per_page={per_page}&page={page}'));
    }
