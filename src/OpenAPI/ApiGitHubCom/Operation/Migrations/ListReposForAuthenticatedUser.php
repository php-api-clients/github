...
final class ListReposForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Repositories $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Repositories $hydrator, int $migration_id, int $per_page = 30, int $page = 1)
    {
