...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Repositories;
...
final class ListReposForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Repositories $hydrator, int $migration_id, int $per_page = 30, int $page = 1)
    {
    ...
    {
        return new Request(self::METHOD, str_replace(['{migration_id}', '{per_page}', '{page}'], [$this->migration_id, $this->per_page, $this->page], self::PATH . '?per_page={per_page}&page={page}'));
    }
