...
final class CheckRepoIsStarredByAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Starred\CbOwnerRcb\CbRepoRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\User\Starred\CbOwnerRcb\CbRepoRcb $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
