...
final class ListPublicEventsForUser
{
    ...
    {
        return new Request('get', str_replace(['{username}', '{per_page}', '{page}'], [$this->username, $this->per_page, $this->page], '/users/{username}/events/public?per_page={per_page}&page={page}'));
    }
