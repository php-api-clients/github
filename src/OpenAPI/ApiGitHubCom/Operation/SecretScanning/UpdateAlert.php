...
final class UpdateAlert
{
    ...
    {
        return new Request('patch', str_replace(['{owner}', '{repo}', '{alert_number}'], [$this->owner, $this->repo, $this->alert_number], '/repos/{owner}/{repo}/secret-scanning/alerts/{alert_number}?'));
    }
