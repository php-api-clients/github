...
final class ListAlertsForOrg_
{
    ...
    function __construct(string $org, string $state, string $secret_type, string $resolution, string $sort = 'created', string $direction = 'desc', int $page = 1, int $per_page = 30, string $before, string $after)
    {
        $this->org = $org;
        $this->state = $state;
