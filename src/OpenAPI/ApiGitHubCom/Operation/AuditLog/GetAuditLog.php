...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\AuditLog;

final class GetAuditLog
{
    private const OPERATION_ID = 'audit-log/get-audit-log';
    ...
    {
        return new \RingCentral\Psr7\Request('get', \str_replace(array('{enterprise}', '{phrase}', '{include}', '{after}', '{before}', '{order}', '{page}', '{per_page}'), array($this->enterprise, $this->phrase, $this->include, $this->after, $this->before, $this->order, $this->page, $this->per_page), '/enterprises/{enterprise}/audit-log?phrase={phrase}&include={include}&after={after}&before={before}&order={order}&page={page}&per_page={per_page}'));
    }
