...
final class GetReview
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{pull_number}', '{review_id}'], [$this->owner, $this->repo, $this->pull_number, $this->review_id], '/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}?'));
    }
