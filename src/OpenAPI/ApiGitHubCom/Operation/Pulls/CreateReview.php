...
final class CreateReview
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateReview\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
