...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Pulls\Create\Request\Applicationjson;
...
final class Create
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Pulls $hydrator, string $owner, string $repo)
    {
    ...
    function createResponse(ResponseInterface $response): PullRequest|BasicError|ValidationError
    {
