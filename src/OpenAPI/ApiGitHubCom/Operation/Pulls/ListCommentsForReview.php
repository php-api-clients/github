...
final class ListCommentsForReview
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{pull_number}', '{review_id}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->pull_number, $this->review_id, $this->per_page, $this->page], '/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/comments?per_page={per_page}&page={page}'));
    }
