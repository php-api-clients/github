...
final class CreateReplyForReviewComment
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateReplyForReviewComment\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
