...
final class UpdateReviewComment
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateReviewComment\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
