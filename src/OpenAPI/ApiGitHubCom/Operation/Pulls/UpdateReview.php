...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Pulls\UpdateReview\Request\Applicationjson;
...
final class UpdateReview
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, CbReviewIdRcb $hydrator, string $owner, string $repo, int $pull_number, int $review_id)
    {
    ...
    function createResponse(ResponseInterface $response): PullRequestReview|ValidationErrorSimple
    {
