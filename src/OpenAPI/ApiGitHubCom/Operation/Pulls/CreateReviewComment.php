...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Pulls\CreateReviewComment\Request\Applicationjson;
...
final class CreateReviewComment
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Comments $hydrator, string $owner, string $repo, int $pull_number)
    {
    ...
    function createResponse(ResponseInterface $response): PullRequestReviewComment|ValidationError|BasicError
    {
