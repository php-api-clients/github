...
final class ListReviews
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Reviews $hydrator, string $owner, string $repo, int $pull_number, int $per_page = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
