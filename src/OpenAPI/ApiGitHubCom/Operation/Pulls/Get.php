...
final class Get
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, CbPullNumberRcb $hydrator, string $owner, string $repo, int $pull_number)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    function createResponse(ResponseInterface $response): PullRequest|BasicError|H503
    {
