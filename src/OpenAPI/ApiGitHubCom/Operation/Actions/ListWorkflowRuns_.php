...
final class ListWorkflowRuns_
{
    ...
    function __construct(string $owner, string $repo, $workflow_id, string $actor, string $branch, string $event, string $status, int $per_page = 30, int $page = 1, string $created, bool $exclude_pull_requests = false, int $check_suite_id, string $head_sha)
    {
        $this->owner = $owner;
        $this->repo = $repo;
