...
{
    private const OPERATION_ID = 'actions/delete-environment-variable';
    ...
    {
        return new \RingCentral\Psr7\Request('DELETE', \str_replace(array('{repository_id}', '{name}', '{environment_name}'), array($this->repository_id, $this->name, $this->environment_name), '/repositories/{repository_id}/environments/{environment_name}/variables/{name}'));
    }
    /**
     * @return int
     */
