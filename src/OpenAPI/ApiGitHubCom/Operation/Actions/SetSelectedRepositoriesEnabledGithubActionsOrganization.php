...
final class SetSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetSelectedRepositoriesEnabledGithubActionsOrganization\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
