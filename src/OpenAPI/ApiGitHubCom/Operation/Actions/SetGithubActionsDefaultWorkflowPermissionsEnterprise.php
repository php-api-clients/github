...
final class SetGithubActionsDefaultWorkflowPermissionsEnterprise
{
    ...
    function createRequest(array $data = array()) : \Psr\Http\Message\RequestInterface
    {
        ...
        return new \RingCentral\Psr7\Request('put', \str_replace(array('{enterprise}'), array($this->enterprise), '/enterprises/{enterprise}/actions/permissions/workflow'), array('Content-Type' => 'application/json'), json_encode($data));
    }
