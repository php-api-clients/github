...
final class AddSelfHostedRunnerToGroupForOrg
{
    ...
    {
        return new Request('put', str_replace(['{org}', '{runner_group_id}', '{runner_id}'], [$this->org, $this->runner_group_id, $this->runner_id], '/orgs/{org}/actions/runner-groups/{runner_group_id}/runners/{runner_id}?'));
    }
