...
{
    private const OPERATION_ID = 'actions/delete-org-variable';
    ...
    {
        return new \RingCentral\Psr7\Request('DELETE', \str_replace(array('{org}', '{name}'), array($this->org, $this->name), '/orgs/{org}/actions/variables/{name}'));
    }
    /**
     * @return int
     */
