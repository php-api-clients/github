...
final class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    private readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Permissions\Repositories $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Permissions\Repositories $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
