...
final class ReRunWorkflowFailedJobs
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ReRunWorkflowFailedJobs\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
