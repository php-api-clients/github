...
final class GetActionsCacheList
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Caches $hydrator, string $owner, string $repo, string $ref, string $key, int $per_page = 30, int $page = 1, string $sort = 'last_accessed_at', string $direction = 'desc')
    {
        $this->owner = $owner;
        $this->repo = $repo;
        $this->ref = $ref;
