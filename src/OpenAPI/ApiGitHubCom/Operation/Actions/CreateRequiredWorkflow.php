...
{
    private const OPERATION_ID = 'actions/create-required-workflow';
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateRequiredWorkflow\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        return new \RingCentral\Psr7\Request('POST', \str_replace(array('{org}'), array($this->org), '/orgs/{org}/actions/required_workflows'), array('Content-Type' => 'application/json'), json_encode($data));
    }
    /**
            ...
            case 201:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\ApiGitHubCom\\Schema\\RequiredWorkflow', $body);
                }
                break;
