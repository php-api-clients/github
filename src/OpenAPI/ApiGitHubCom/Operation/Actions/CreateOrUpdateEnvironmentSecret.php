...
final class CreateOrUpdateEnvironmentSecret
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateOrUpdateEnvironmentSecret\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
