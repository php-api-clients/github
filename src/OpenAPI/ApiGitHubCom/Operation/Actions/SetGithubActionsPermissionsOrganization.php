...
final class SetGithubActionsPermissionsOrganization
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetGithubActionsPermissionsOrganization\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
