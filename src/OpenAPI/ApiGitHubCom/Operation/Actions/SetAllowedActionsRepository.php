...
final class SetAllowedActionsRepository
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SelectedActions::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
