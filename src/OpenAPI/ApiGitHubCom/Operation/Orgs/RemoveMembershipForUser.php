...
final class RemoveMembershipForUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\Operation\Orgs\CbOrgRcb\Memberships\CbUsernameRcb $hydrator, string $org, string $username)
    {
        $this->org = $org;
