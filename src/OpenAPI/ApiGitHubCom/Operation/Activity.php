...
final class Activity
{
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Operation\Activity\ListNotificationsForAuthenticatedUser_($all, $participating, $since, $before, $page, $per_page);
    }
