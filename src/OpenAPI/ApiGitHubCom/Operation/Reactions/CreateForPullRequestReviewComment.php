...
final class CreateForPullRequestReviewComment
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForPullRequestReviewComment\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
