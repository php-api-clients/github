...
final class CreateForTeamDiscussionCommentLegacy
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForTeamDiscussionCommentLegacy\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
