...
final class CreateForIssue
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForIssue\Request\Application\Json::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
