...
final class CreateForIssue
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForIssue\Request::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
