...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookWorkflowRunCompleted;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookWorkflowRunInProgress;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookWorkflowRunRequested;
...
final class WorkflowRun implements WebHookInterface
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\WebHook\WorkflowRun $hydrator)
    {
    ...
    public function resolve(array $headers, array $data): string
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(WebhookWorkflowRunCompleted::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['X-GitHub-Delivery'], Reader::readFromJson(UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['X-Hub-Signature-256'], Reader::readFromJson(UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(WebhookWorkflowRunInProgress::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['X-GitHub-Delivery'], Reader::readFromJson(UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['X-Hub-Signature-256'], Reader::readFromJson(UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(WebhookWorkflowRunRequested::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
