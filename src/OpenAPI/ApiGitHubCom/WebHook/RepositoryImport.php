...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryImport;
...
final class RepositoryImport implements WebHookInterface
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Hydrator\WebHook\RepositoryImport $hydrator)
    {
    ...
    public function resolve(array $headers, array $data): string
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(WebhookRepositoryImport::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
