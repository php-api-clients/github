...
final class ContributorActivity
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ContributorActivity\Author::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ContributorActivity\Author $author;
    private int $total;
    /**
    ...
    public function author() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ContributorActivity\Author
    {
        return $this->author;
    }
