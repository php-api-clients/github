...
final class BranchShort
{
    ...
    private string $name;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BranchShort\Commit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BranchShort\Commit $commit;
    private bool $protected;
    public function name() : string
    {
        return $this->name;
    }
    public function commit() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BranchShort\Commit
    {
        return $this->commit;
    }
