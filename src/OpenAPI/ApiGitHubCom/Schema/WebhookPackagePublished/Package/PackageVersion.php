...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPackagePublished\Package\PackageVersion\Release;
...
final readonly class PackageVersion
{
    ...
    public ?ContainerMetadata $container_metadata;
    ...
    public ?string $name;
    public ?NpmMetadata $npm_metadata;
    ...
    public function __construct(AnswerChosenBy $author, mixed $body, string $body_html, ContainerMetadata $container_metadata, string $created_at, string $description, array $docker_metadata, bool $draft, string $html_url, int $id, string $installation_command, string $manifest, array $metadata, string $name, NpmMetadata $npm_metadata, array $nuget_metadata, array $package_files, string $package_url, bool $prerelease, Release $release, array $rubygems_metadata, string $source_url, string $summary, string $tag_name, string $target_commitish, string $target_oid, string $updated_at, string $version)
    {
        $this->author               = $author;
        $this->body                 = $body;
