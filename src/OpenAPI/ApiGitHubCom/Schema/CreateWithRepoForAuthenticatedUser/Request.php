...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateWithRepoForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateWithRepoForAuthenticatedUser\\Request';
