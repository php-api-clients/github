...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesDeleted\Issue\Milestone;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesOpened\Changes\OldIssue\PerformedViaGithubApp;
...
final readonly class OldIssue
{
    ...
    public ?AnswerChosenBy $assignee;
    ...
    public function __construct(string $active_lock_reason, AnswerChosenBy $assignee, array $assignees, string $author_association, string $body, string $closed_at, int $comments, string $comments_url, string $created_at, bool $draft, string $events_url, string $html_url, int $id, array $labels, string $labels_url, bool $locked, Milestone $milestone, string $node_id, int $number, PerformedViaGithubApp $performed_via_github_app, PullRequest $pull_request, Reactions $reactions, string $repository_url, string $state, string $state_reason, string $timeline_url, string $title, string $updated_at, string $url, AnswerChosenBy $user)
    {
