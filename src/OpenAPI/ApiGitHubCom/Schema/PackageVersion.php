...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PackageVersion\Metadata;
...
final readonly class PackageVersion
{
    ...
    public function __construct(int $id, string $name, string $url, string $package_html_url, string $html_url, string $license, string $description, string $created_at, string $updated_at, string $deleted_at, Metadata $metadata)
    {
        $this->id               = $id;
        $this->name             = $name;
        $this->url              = $url;
