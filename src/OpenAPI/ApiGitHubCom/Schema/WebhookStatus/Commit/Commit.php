...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Commit\Verification;
...
final readonly class Commit
{
    ...
    public function __construct(mixed $author, int $comment_count, mixed $committer, string $message, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ShortBranch\Commit $tree, string $url, Verification $verification)
    {
        $this->author        = $author;
