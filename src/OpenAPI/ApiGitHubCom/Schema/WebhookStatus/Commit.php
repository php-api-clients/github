...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Author;
...
final readonly class Commit
{
    ...
    public function __construct(Author $author, string $comments_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Commit $commit, Author $committer, string $html_url, string $node_id, array $parents, string $sha, string $url)
    {
        $this->author       = $author;
