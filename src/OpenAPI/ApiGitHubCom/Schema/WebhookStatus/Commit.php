...
final readonly class Commit
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Author $author;
    public ?string $comments_url;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Commit $commit;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Author $committer;
    public ?string $html_url;
    public ?string $node_id;
    public ?array $parents;
    public ?string $sha;
    public ?string $url;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Author $author, string $comments_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Commit $commit, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookStatus\Commit\Author $committer, string $html_url, string $node_id, array $parents, string $sha, string $url)
    {
        $this->author = $author;
