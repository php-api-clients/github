...
final readonly class Answer
{
    ...
    public function __construct(string $author_association, string $body, int $child_comment_count, string $created_at, int $discussion_id, string $html_url, int $id, string $node_id, mixed $parent_id, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\Reactions $reactions, string $repository_url, string $updated_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $user)
    {
