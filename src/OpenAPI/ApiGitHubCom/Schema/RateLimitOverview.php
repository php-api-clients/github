...
final readonly class RateLimitOverview
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RateLimitOverview\Resources $resources;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RateLimit $rate;
