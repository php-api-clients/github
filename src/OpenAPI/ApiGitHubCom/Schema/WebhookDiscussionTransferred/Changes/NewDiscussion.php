...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDiscussionTransferred\Changes;
...
final readonly class NewDiscussion
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $answer_chosen_by;
    ...
    public ?string $body;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\Category $category;
    public ?int $comments;
    ...
    public function __construct(string $active_lock_reason, string $answer_chosen_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $answer_chosen_by, string $answer_html_url, string $author_association, string $body, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\Category $category, int $comments, string $created_at, string $html_url, int $id, bool $locked, string $node_id, int $number, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\Reactions $reactions, string $repository_url, string $state, string $timeline_url, string $title, string $updated_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $user)
    {
