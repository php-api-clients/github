...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetRepositoriesForSecretForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetRepositoriesForSecretForAuthenticatedUser\\Request';
