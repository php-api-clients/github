...
final readonly class DeploymentStatus
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp $performed_via_github_app;
    ...
    public ?string $url;
    public function __construct(string $created_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $creator, string $deployment_url, string $description, string $environment, string $environment_url, int $id, string $log_url, string $node_id, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp $performed_via_github_app, string $repository_url, string $state, string $target_url, string $updated_at, string $url)
    {
