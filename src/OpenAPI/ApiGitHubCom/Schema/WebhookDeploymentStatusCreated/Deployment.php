...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp;
...
final readonly class Deployment
{
    ...
    public function __construct(string $created_at, AnswerChosenBy $creator, string $description, string $environment, int $id, string $node_id, string $original_environment, mixed $payload, PerformedViaGithubApp $performed_via_github_app, bool $production_environment, string $ref, string $repository_url, string $sha, string $statuses_url, string $task, bool $transient_environment, string $updated_at, string $url)
    {
