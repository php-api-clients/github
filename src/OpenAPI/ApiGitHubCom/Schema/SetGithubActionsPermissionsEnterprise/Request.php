...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetGithubActionsPermissionsEnterprise;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetGithubActionsPermissionsEnterprise\\Request';
