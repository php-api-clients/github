...
final readonly class Invitation
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $inviter;
    public ?string $login;
    public ?string $node_id;
    public ?string $role;
    public ?int $team_count;
    public string $invitation_source;
    public function __construct(string $created_at, string $email, string $failed_at, string $failed_reason, int $id, string $invitation_teams_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $inviter, string $login, string $node_id, string $role, int $team_count, string $invitation_source)
    {
