...
final class RequiredPullRequestReviews
{
    ...
    public const SCHEMA_TITLE = 'Json\\RequiredPullRequestReviews';
    ...
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RequiredPullRequestReviews\DismissalRestrictions $dismissal_restrictions, bool $dismiss_stale_reviews, bool $require_code_owner_reviews, int $required_approving_review_count, bool $require_last_push_approval, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RequiredPullRequestReviews\BypassPullRequestAllowances $bypass_pull_request_allowances)
    {
