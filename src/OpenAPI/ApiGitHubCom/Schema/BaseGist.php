...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\BaseGist\Files;
...
final readonly class BaseGist
{
    ...
    public function __construct(string $url, string $forks_url, string $commits_url, string $id, string $node_id, string $git_pull_url, string $git_push_url, string $html_url, Files $files, bool $public, string $created_at, string $updated_at, string $description, int $comments, mixed $user, string $comments_url, SimpleUser $owner, bool $truncated, array $forks, array $history)
    {
        $this->url          = $url;
