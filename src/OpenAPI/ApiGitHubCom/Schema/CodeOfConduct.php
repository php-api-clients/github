...
final class CodeOfConduct
{
    ...
    public function __construct(string $key, string $name, string $url, string $body, string $html_url)
    {
        $this->key = $key;
        $this->name = $name;
        $this->url = $url;
