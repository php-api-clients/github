...
final class Issue
{
     ...
     */
    public function __construct(string $active_lock_reason, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\Assignee $assignee, array $assignees, string $author_association, string $body, string $closed_at, int $comments, string $comments_url, string $created_at, bool $draft, string $events_url, string $html_url, int $id, array $labels, string $labels_url, bool $locked, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\Milestone $milestone, string $node_id, int $number, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\PerformedViaGithubApp $performed_via_github_app, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\PullRequest $pull_request, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\Reactions $reactions, string $repository_url, string $state, string $state_reason, string $timeline_url, string $title, string $updated_at, string $url, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Issue\User $user)
    {
