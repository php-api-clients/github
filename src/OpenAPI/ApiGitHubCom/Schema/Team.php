...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Team\Permissions;
...
final readonly class Team
{
    ...
    public function __construct(int $id, string $node_id, string $name, string $slug, string $description, string $privacy, string $permission, Permissions $permissions, string $url, string $html_url, string $members_url, string $repositories_url, mixed $parent)
    {
        $this->id               = $id;
