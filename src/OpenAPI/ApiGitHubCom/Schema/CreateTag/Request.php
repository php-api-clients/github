...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateTag;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateTag\\Request';
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tagger::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tagger $tagger = null;
    /**
     * The tag's name. This is typically a version (e.g., "v0.0.1").
     */
     ...
     * An object with information about the individual creating the tag.
     */
    public function tagger() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tagger
    {
        return $this->tagger;
    }
}
