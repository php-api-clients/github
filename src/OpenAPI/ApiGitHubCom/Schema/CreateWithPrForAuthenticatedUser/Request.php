...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateWithPrForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateWithPrForAuthenticatedUser\\Request';
