...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateWithPrForAuthenticatedUser\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateWithPrForAuthenticatedUser\\Request\\Application\\Json';
