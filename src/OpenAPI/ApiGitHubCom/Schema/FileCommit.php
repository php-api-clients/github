...
final class FileCommit
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Content::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Content $content;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Commit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Commit $commit;
    public function content() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Content
    {
        return $this->content;
    }
    public function commit() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Commit
    {
        return $this->commit;
    }
}
