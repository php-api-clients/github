...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Commit;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FileCommit\Content;
...
final readonly class FileCommit
{
    ...
    public function __construct(Content $content, Commit $commit)
    {
