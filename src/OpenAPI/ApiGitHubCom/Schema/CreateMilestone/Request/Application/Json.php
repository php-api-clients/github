...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateMilestone\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateMilestone\\Request\\Application\\Json';
