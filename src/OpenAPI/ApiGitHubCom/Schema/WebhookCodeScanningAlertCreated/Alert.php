...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertCreated\Alert\Tool;
...
final readonly class Alert
{
    ...
    public function __construct(string $created_at, mixed $dismissed_at, mixed $dismissed_by, string $dismissed_comment, mixed $dismissed_reason, mixed $fixed_at, string $html_url, string $instances_url, MostRecentInstance $most_recent_instance, int $number, Rule $rule, string $state, Tool $tool, string $updated_at, string $url)
    {
