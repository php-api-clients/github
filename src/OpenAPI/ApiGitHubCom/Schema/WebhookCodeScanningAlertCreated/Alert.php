...
final readonly class Alert
{
     ...
     */
    public ?string $state;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertCreated\Alert\Tool $tool;
    public ?string $updated_at;
    public ?string $url;
    public function __construct(string $created_at, mixed $dismissed_at, mixed $dismissed_by, string $dismissed_comment, mixed $dismissed_reason, mixed $fixed_at, string $html_url, string $instances_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertClosedByUser\Alert\Rule $rule, string $state, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertCreated\Alert\Tool $tool, string $updated_at, string $url)
    {
