...
final class Changes
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\Color::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\Color $color;
    /**
    ...
    public function color() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\Color
    {
        return $this->color;
    }
