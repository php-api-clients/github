...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookLabelEdited\Changes\Color $color;
    ...
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookLabelEdited\Changes\Color $color, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookLabelEdited\Changes\Description $description, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookLabelEdited\Changes\Name $name)
    {
        $this->color = $color;
