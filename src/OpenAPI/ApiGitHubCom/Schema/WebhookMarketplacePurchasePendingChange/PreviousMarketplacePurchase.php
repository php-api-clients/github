...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchasePendingChange;
...
final readonly class PreviousMarketplacePurchase
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account;
    public ?string $billing_cycle;
    public ?string $free_trial_ends_on;
    public ?string $next_billing_date;
    public ?bool $on_free_trial;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan;
    public ?int $unit_count;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, string $billing_cycle, string $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, int $unit_count)
    {
