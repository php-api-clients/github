...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan;
...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(Account $account, string $billing_cycle, string $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, Plan $plan, int $unit_count)
    {
