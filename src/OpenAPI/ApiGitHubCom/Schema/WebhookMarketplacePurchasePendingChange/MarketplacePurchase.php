...
final class MarketplacePurchase
{
    ...
    public function __construct(array $account, string $billing_cycle, string $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, array $plan, int $unit_count)
    {
