...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DependabotAlertPackage;
...
final readonly class Dependency
{
     ...
     */
    public ?DependabotAlertPackage $package;
    /**
    ...
    public function __construct(DependabotAlertPackage $package, string $manifest_path, string $scope)
    {
