...
final readonly class Review
{
    ...
    public function __construct(Links $_links, string $author_association, string $body, string $commit_id, string $html_url, int $id, string $node_id, string $pull_request_url, string $state, string $submitted_at, AnswerChosenBy $user)
    {
        $this->_links             = $_links;
