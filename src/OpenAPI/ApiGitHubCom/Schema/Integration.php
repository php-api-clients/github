...
final readonly class Integration
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Integration\Permissions $permissions;
    /**
    ...
    public string $pem;
    public function __construct(int $id, string $slug, string $node_id, mixed $owner, string $name, string $description, string $external_url, string $html_url, string $created_at, string $updated_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Integration\Permissions $permissions, array $events, int $installations_count, string $client_id, string $client_secret, string $webhook_secret, string $pem)
    {
        $this->id = $id;
        $this->slug = $slug;
