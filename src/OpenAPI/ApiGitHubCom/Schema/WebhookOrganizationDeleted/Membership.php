...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookOrganizationDeleted;
...
final readonly class Membership
{
    ...
    public function __construct(string $organization_url, string $role, string $state, string $url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $user)
    {
