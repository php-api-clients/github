...
final class Forks
{
    ...
    public const SCHEMA_EXAMPLE = '{"user":{"private_gists":1,"total_private_repos":2,"owned_private_repos":2,"disk_usage":1,"collaborators":3}}';
    ...
    public function __construct(string $id, string $url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PublicUser $user, string $created_at, string $updated_at)
    {
        $this->id = $id;
        $this->url = $url;
        $this->user = $user;
