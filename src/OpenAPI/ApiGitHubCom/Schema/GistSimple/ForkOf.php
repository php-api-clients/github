...
final class ForkOf
{
    ...
    public readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ForkOf\Files $files;
    public readonly bool $public;
    public readonly string $created_at;
    public readonly string $updated_at;
    public readonly ?string $description;
    public readonly int $comments;
    public readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ForkOf\User $user;
    public readonly string $comments_url;
    public readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ForkOf\Owner $owner;
