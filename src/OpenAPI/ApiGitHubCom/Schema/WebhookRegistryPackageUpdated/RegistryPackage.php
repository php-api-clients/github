...
final class RegistryPackage
{
    ...
    public readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RegistryPackage\Owner $owner;
    ...
    public function __construct(string $created_at, mixed $description, string $ecosystem, string $html_url, int $id, string $name, string $namespace, object $owner, string $package_type, object $package_version, object $registry, string $updated_at)
    {
