...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateTree\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateTree\\Request\\Application\\Json';
