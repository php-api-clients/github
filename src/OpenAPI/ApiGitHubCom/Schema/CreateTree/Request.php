...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateTree;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateTree\\Request';
    public const SCHEMA_DESCRIPTION = '';
    /**
     * Objects (of `path`, `mode`, `type`, and `sha`) specifying a tree structure.
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tree>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tree::class)
     */
    ...
    */
    ...
    /**
     * Objects (of `path`, `mode`, `type`, and `sha`) specifying a tree structure.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Tree>
     */
