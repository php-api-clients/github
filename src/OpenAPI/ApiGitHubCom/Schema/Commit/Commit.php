...
final readonly class Commit
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Commit\Commit\Tree $tree;
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Verification $verification;
    public function __construct(string $url, mixed $author, mixed $committer, string $message, int $comment_count, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Commit\Commit\Tree $tree, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Verification $verification)
    {
        $this->url = $url;
        $this->author = $author;
