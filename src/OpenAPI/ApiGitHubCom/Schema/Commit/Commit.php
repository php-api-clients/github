...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Commit\Commit\Tree;
...
final readonly class Commit
{
    ...
    public function __construct(string $url, mixed $author, mixed $committer, string $message, int $comment_count, Tree $tree, Verification $verification)
    {
        $this->url           = $url;
        $this->author        = $author;
