...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetSelfHostedRunnersInGroupForOrg;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetSelfHostedRunnersInGroupForOrg\\Request';
