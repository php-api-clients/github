...
final class PageDeployment
{
    ...
    public const SCHEMA_EXAMPLE = '{"status_url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/pages\\/deployments\\/4fd754f7e594640989b406850d0bc8f06a121251\\/status","page_url":"hello-world.github.io","preview_url":"monalisa-1231a2312sa32-23sda74.drafts.github.io"}';
    public const SCHEMA_TITLE = 'GitHub Pages';
    public const SCHEMA_DESCRIPTION = 'The GitHub Pages deployment status.';
    /**
     * The URI to monitor GitHub Pages deployment status.
     */
    public readonly string $status_url;
    /**
