...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CommitSearchResultItem\Commit\Author;
...
final readonly class Commit
{
    ...
    public function __construct(Author $author, mixed $committer, int $comment_count, string $message, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ShortBranch\Commit $tree, string $url, Verification $verification)
    {
        $this->author        = $author;
