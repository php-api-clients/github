...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions;
...
final readonly class OrgMembership
{
    ...
    public function __construct(string $url, string $state, string $role, string $organization_url, OrganizationSimple $organization, mixed $user, Permissions $permissions)
    {
        $this->url              = $url;
        $this->state            = $state;
        $this->role             = $role;
