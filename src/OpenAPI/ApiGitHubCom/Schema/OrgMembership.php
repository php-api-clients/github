...
final readonly class OrgMembership
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrganizationSimple $organization;
    public mixed $user;
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions $permissions;
    public function __construct(string $url, string $state, string $role, string $organization_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrganizationSimple $organization, mixed $user, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions $permissions)
    {
        $this->url = $url;
        $this->state = $state;
        $this->role = $role;
