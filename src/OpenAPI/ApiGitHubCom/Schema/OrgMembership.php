...
final class OrgMembership
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\User $user;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions $permissions = null;
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\User
    {
        return $this->user;
    }
    public function permissions() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\OrgMembership\Permissions
    {
