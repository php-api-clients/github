...
final readonly class TeamDiscussionComment
{
    ...
    public function __construct(mixed $author, string $body, string $body_html, string $body_version, string $created_at, string $last_edited_at, string $discussion_url, string $html_url, string $node_id, int $number, string $updated_at, string $url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ReactionRollup $reactions)
    {
        $this->author = $author;
        $this->body = $body;
