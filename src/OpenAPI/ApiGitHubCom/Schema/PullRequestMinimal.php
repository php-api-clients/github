...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PullRequestMinimal\Head;
...
final readonly class PullRequestMinimal
{
    ...
    public function __construct(int $id, int $number, string $url, Head $head, Head $base)
    {
        $this->id     = $id;
        $this->number = $number;
        $this->url    = $url;
