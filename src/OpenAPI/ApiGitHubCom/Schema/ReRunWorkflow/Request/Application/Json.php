...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ReRunWorkflow\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'ReRunWorkflow\\Request\\Application\\Json';
