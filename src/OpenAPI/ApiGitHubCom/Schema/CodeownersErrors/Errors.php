...
final class Errors
{
    ...
    public const SCHEMA_EXAMPLE = '{"line":7,"column":3,"source":"* user","kind":"Invalid owner","suggestion":"The pattern `\\/` will never match anything, did you mean `*` instead?","message":"Invalid owner on line 7:\\n\\n  * user\\n    ^","path":".github\\/CODEOWNERS"}';
