...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdatePullRequestReviewProtection;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'UpdatePullRequestReviewProtection\\Request';
    public const SCHEMA_DESCRIPTION = '';
    /**
     * Specify which users, teams, and apps can dismiss pull request reviews. Pass an empty `dismissal_restrictions` object to disable. User and team `dismissal_restrictions` are only available for organization-owned repositories. Omit this parameter for personal repositories.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\DismissalRestrictions::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\DismissalRestrictions $dismissal_restrictions;
    /**
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\BypassPullRequestAllowances::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\BypassPullRequestAllowances $bypass_pull_request_allowances;
    /**
     * Specify which users, teams, and apps can dismiss pull request reviews. Pass an empty `dismissal_restrictions` object to disable. User and team `dismissal_restrictions` are only available for organization-owned repositories. Omit this parameter for personal repositories.
     */
    public function dismissal_restrictions() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\DismissalRestrictions
    {
     ...
     * Allow specific users, teams, or apps to bypass pull request requirements.
     */
    public function bypass_pull_request_allowances() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\BypassPullRequestAllowances
    {
