...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RemoveTeamAccessRestrictions;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'RemoveTeamAccessRestrictions\\Request';
