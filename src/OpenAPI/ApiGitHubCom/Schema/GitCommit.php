...
final readonly class GitCommit
{
    ...
    public function __construct(string $sha, string $node_id, string $url, Author $author, Author $committer, string $message, Tree $tree, array $parents, Verification $verification, string $html_url)
    {
        $this->sha          = $sha;
