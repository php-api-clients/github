...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\UpdateWebhook\Request\Applicationjson\Config;
...
final readonly class Applicationjson
{
    ...
    public function __construct(Config $config, array $events, bool $active, string $name)
    {
        $this->config = $config;
        $this->events = $events;
        $this->active = $active;
