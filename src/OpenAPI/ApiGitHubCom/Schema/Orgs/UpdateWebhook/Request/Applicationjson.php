...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\UpdateWebhook\Request;
...
final readonly class Applicationjson
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\UpdateWebhook\Request\Applicationjson\Config $config;
    /**
    ...
    public ?bool $active;
    public ?string $name;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\UpdateWebhook\Request\Applicationjson\Config $config, array $events, bool $active, string $name)
    {
        $this->config = $config;
        $this->events = $events;
        $this->active = $active;
