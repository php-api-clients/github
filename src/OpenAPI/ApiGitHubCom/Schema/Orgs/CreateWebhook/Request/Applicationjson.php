...
final readonly class Applicationjson
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\CreateWebhook\Request\Applicationjson\Config $config;
    /**
     ...
     */
    public bool $active;
    public function __construct(string $name, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Orgs\CreateWebhook\Request\Applicationjson\Config $config, array $events, bool $active)
    {
        $this->name = $name;
        $this->config = $config;
        $this->events = $events;
