...
final readonly class HeadCommit
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Author $author;
    /**
     * Metaproperties for Git author/committer information.
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Author $committer;
    public ?string $id;
    public ?string $message;
    public ?string $timestamp;
    public ?string $tree_id;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Author $author, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Author $committer, string $id, string $message, string $timestamp, string $tree_id)
    {
        $this->author = $author;
