...
final readonly class Alert
{
    ...
    public ?string $url;
    public function __construct(string $created_at, string $dismissed_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $dismissed_by, string $dismissed_reason, string $html_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertClosedByUser\Alert\Rule $rule, string $state, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertClosedByUser\Alert\Tool $tool, string $url)
    {
