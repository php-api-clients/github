...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MarkRepoNotificationsAsRead;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'MarkRepoNotificationsAsRead\\Request';
