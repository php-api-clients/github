...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Gists\Create\Request\Applicationjson\Files;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $description, Files $files, mixed $public)
    {
