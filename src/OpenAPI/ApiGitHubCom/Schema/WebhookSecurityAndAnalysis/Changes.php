...
final class Changes
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\From::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\From $from;
    public function from() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Changes\From
    {
        return $this->from;
    }
}
