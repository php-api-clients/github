...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSecurityAndAnalysis\Changes;
...
final readonly class From
{
    ...
    public function __construct(SecurityAndAnalysis $security_and_analysis)
    {
