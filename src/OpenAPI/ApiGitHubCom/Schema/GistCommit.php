...
final class GistCommit
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\User $user;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\ChangeStatus::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\ChangeStatus $change_status;
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\User
    {
        return $this->user;
    }
    public function change_status() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistCommit\ChangeStatus
    {
