...
final readonly class GistCommit
{
    ...
    public function __construct(string $url, string $version, mixed $user, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistHistory\ChangeStatus $change_status, string $committed_at)
    {
        $this->url = $url;
