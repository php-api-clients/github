...
final class WebhookDependabotAlertCreated
{
    ...
    /**
     * A Dependabot alert.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DependabotAlert::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DependabotAlert $alert;
    /**
     ...
     * A Dependabot alert.
     */
    public function alert() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DependabotAlert
    {
        return $this->alert;
    }
    /**
