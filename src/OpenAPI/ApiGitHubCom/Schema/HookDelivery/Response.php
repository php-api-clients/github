...
final readonly class Response
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookDelivery\Response\Headers $headers;
    /**
     * The response payload received.
     */
    public ?string $payload;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookDelivery\Response\Headers $headers, string $payload)
    {
