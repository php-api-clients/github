...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\GetAlert\Response\Application\Json;

final class H503
{
    public const SCHEMA_JSON = '{"type":"object","properties":{"code":{"type":"string"},"message":{"type":"string"},"documentation_url":{"type":"string"}}}';
    public const SCHEMA_TITLE = 'Operation\\GetAlert\\Response\\Application\\Json\\H503';
