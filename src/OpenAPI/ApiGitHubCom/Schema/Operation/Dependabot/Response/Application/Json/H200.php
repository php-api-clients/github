...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\Dependabot\Response\Application\Json;
...
final class H200
{
    ...
    public const SCHEMA_EXAMPLE = '{"secrets":[{"name":"MY_ARTIFACTORY_PASSWORD"}]}';
    public const SCHEMA_TITLE = 'Operation\\Dependabot\\Response\\Application\\Json\\H200';
