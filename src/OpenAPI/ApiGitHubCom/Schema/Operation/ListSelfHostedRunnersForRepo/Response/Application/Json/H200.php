...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Operation\ListSelfHostedRunnersForRepo\Response\Application\Json;
...
final class H200
{
    ...
    public const SCHEMA_EXAMPLE = '{"runners":[{"id":5,"name":"iMac","os":"macos","status":"online"}]}';
    public const SCHEMA_TITLE = 'Operation\\ListSelfHostedRunnersForRepo\\Response\\Application\\Json\\H200';
