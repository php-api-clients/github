...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Apps\ScopeToken\Request;

use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AppPermissions;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $access_token, string $target, int $target_id, array $repositories, array $repository_ids, AppPermissions $permissions)
    {
