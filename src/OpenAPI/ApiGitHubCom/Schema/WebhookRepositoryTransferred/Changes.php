...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes\Owner $owner;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes\Owner $owner)
    {
        $this->owner = $owner;
    }
}
