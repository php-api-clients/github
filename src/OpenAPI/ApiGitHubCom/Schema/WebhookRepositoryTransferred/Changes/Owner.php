...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes;
...
final readonly class Owner
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes\Owner\From $from;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes\Owner\From $from)
    {
        $this->from = $from;
    }
}
