...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookRepositoryTransferred\Changes\Owner\From\Organization;
...
final readonly class From
{
    ...
    public function __construct(Organization $organization, AnswerChosenBy $user)
    {
