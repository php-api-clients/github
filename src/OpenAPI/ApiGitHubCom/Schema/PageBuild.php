...
final class PageBuild
{
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NullableSimpleUser $pusher = null;
     ...
     * Simple User
     */
    public function pusher() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NullableSimpleUser
    {
        return $this->pusher;
    }
