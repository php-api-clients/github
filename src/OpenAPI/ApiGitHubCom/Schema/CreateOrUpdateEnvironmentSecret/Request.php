...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateOrUpdateEnvironmentSecret;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateOrUpdateEnvironmentSecret\\Request';
