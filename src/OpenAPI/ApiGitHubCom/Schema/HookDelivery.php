...
final readonly class HookDelivery
{
     ...
     */
    public string $url;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookDelivery\Request $request;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookDelivery\Response $response;
