...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookProjectClosed;
...
final readonly class Project
{
    ...
    public ?string $url;
    public function __construct(string $body, string $columns_url, string $created_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $creator, string $html_url, int $id, string $name, string $node_id, int $number, string $owner_url, string $state, string $updated_at, string $url)
    {
        $this->body = $body;
