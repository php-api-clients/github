...
final readonly class Project
{
    ...
    public function __construct(string $body, string $columns_url, string $created_at, AnswerChosenBy $creator, string $html_url, int $id, string $name, string $node_id, int $number, string $owner_url, string $state, string $updated_at, string $url)
    {
        $this->body        = $body;
