...
final readonly class UserMarketplacePurchase
{
    ...
    public function __construct(string $billing_cycle, string $next_billing_date, int $unit_count, bool $on_free_trial, string $free_trial_ends_on, string $updated_at, MarketplaceAccount $account, MarketplaceListingPlan $plan)
    {
