...
final class Reaction
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Reaction\User::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Reaction\User $user;
    /**
     * The reaction to use
     */
    ...
    public function user() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Reaction\User
    {
        return $this->user;
    }
    /**
