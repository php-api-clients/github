...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateDeployment;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateDeployment\\Request';
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredContexts>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredContexts::class)
     */
    ...
    /**
     * The [status](https://docs.github.com/rest/commits/statuses) contexts to verify against commit status checks. If you omit this parameter, GitHub verifies all unique contexts before creating a deployment. To bypass checking entirely, pass an empty array. Defaults to all unique contexts.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredContexts>
     */
