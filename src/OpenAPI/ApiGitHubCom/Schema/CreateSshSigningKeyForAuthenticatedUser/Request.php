...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateSshSigningKeyForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateSshSigningKeyForAuthenticatedUser\\Request';
