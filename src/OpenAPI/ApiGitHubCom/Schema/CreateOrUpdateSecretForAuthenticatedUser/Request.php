...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateOrUpdateSecretForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateOrUpdateSecretForAuthenticatedUser\\Request';
