...
final readonly class ProjectsV2
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SimpleUser $creator;
    public ?string $title;
    ...
    public function __construct(int $id, string $node_id, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SimpleUser $owner, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SimpleUser $creator, string $title, string $description, bool $public, string $closed_at, string $created_at, string $updated_at, int $number, string $short_description, string $deleted_at, mixed $deleted_by)
    {
        $this->id = $id;
