...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateSelfHostedRunnerGroupForOrg;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'UpdateSelfHostedRunnerGroupForOrg\\Request';
