...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookResponse;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPing\Hook\Config;
...
final readonly class Hook
{
    ...
    public function __construct(bool $active, int $app_id, Config $config, string $created_at, string $deliveries_url, array $events, int $id, HookResponse $last_response, string $name, string $ping_url, string $test_url, string $type, string $updated_at, string $url)
    {
        $this->active         = $active;
        $this->app_id         = $app_id;
        $this->config         = $config;
