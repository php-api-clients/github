...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateTag\Request\Applicationjson\Tagger;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $tag, string $message, string $object, string $type, Tagger $tagger)
    {
        $this->tag     = $tag;
