...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateTag\Request;
...
final readonly class Applicationjson
{
     ...
     */
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateTag\Request\Applicationjson\Tagger $tagger;
    public function __construct(string $tag, string $message, string $object, string $type, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateTag\Request\Applicationjson\Tagger $tagger)
    {
        $this->tag = $tag;
