...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateCommit\Request\Applicationjson\Author;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Git\CreateCommit\Request\Applicationjson\Committer;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $message, string $tree, array $parents, Author $author, Committer $committer, string $signature)
    {
