...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Artifact\WorkflowRun;
...
final readonly class Artifact
{
    ...
    public function __construct(int $id, string $node_id, string $name, int $size_in_bytes, string $url, string $archive_download_url, bool $expired, string $created_at, string $expires_at, string $updated_at, WorkflowRun $workflow_run)
    {
        $this->id                   = $id;
