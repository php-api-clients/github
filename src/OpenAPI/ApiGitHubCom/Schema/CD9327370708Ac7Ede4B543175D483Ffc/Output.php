...
final class Output
{
    ...
    public const SCHEMA_TITLE = 'CD9327370708Ac7Ede4B543175D483Ffc\\Output';
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Annotations>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Annotations::class)
     */
    private array $annotations = array();
    /**
     * Adds images to the output displayed in the GitHub pull request UI.
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Images>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Images::class)
     */
    ...
    /**
     * Adds information from your analysis to specific lines of code. Annotations are visible in GitHub's pull request UI. Annotations are visible in GitHub's pull request UI. The Checks API limits the number of annotations to a maximum of 50 per API request. To create more than 50 annotations, you have to make multiple requests to the [Update a check run](https://docs.github.com/rest/reference/checks#update-a-check-run) endpoint. Each time you update the check run, annotations are appended to the list of annotations that already exist for the check run. For details about annotations in the UI, see "[About status checks](https://docs.github.com/articles/about-status-checks#checks)".
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Annotations>
     */
    ...
    /**
     * Adds images to the output displayed in the GitHub pull request UI.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Output\Images>
     */
