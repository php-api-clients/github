...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Snapshot\Detector;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Snapshot\Job;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Snapshot\Manifests;
...
final readonly class Snapshot
{
    ...
    public function __construct(int $version, Job $job, string $sha, string $ref, Detector $detector, Metadata $metadata, Manifests $manifests, string $scanned)
    {
