...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForTeamDiscussionCommentInOrg;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateForTeamDiscussionCommentInOrg\\Request';
