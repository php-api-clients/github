...
final readonly class Hook
{
    ...
    public ?bool $active;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMetaDeleted\Hook\Config $config;
    ...
    public function __construct(bool $active, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMetaDeleted\Hook\Config $config, string $created_at, array $events, int $id, string $name, string $type, string $updated_at)
    {
        $this->active = $active;
        $this->config = $config;
