...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AddLabels\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'AddLabels\\Request\\Application\\Json';
