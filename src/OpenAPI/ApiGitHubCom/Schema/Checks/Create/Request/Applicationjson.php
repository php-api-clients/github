...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Checks\Create\Request\Applicationjson\Output;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $name, string $head_sha, string $details_url, string $external_id, string $status, string $started_at, string $conclusion, string $completed_at, Output $output, array $actions)
    {
        $this->name         = $name;
