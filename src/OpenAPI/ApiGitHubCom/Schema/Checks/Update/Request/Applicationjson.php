...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Checks\Update\Request;
...
final readonly class Applicationjson
{
    ...
    */
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Checks\Update\Request\Applicationjson\Output $output;
    /**
     * Possible further actions the integrator can perform, which a user may trigger. Each action includes a `label`, `identifier` and `description`. A maximum of three actions are accepted. See the [`actions` object](https://docs.github.com/rest/reference/checks#actions-object) description. To learn more about check runs and requested actions, see "[Check runs and requested actions](https://docs.github.com/rest/reference/checks#check-runs-and-requested-actions)."
     */
    public ?array $actions;
    public function __construct(string $name, string $details_url, string $external_id, string $started_at, string $status, string $conclusion, string $completed_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Checks\Update\Request\Applicationjson\Output $output, array $actions)
    {
        $this->name = $name;
