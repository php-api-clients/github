...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Checks\Update\Request\Applicationjson\Output;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $name, string $details_url, string $external_id, string $started_at, string $status, string $conclusion, string $completed_at, Output $output, array $actions)
    {
        $this->name         = $name;
