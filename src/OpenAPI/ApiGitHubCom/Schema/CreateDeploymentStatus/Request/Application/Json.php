...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateDeploymentStatus\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateDeploymentStatus\\Request\\Application\\Json';
     ...
     */
    public readonly ?string $environment_url;
    /**
     * Adds a new `inactive` status to all prior non-transient, non-production environment deployments with the same repository and `environment` name as the created status's deployment. An `inactive` status is only added to deployments that had a `success` state. Default: `true`
     */
    public readonly ?bool $auto_inactive;
