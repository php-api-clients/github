...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipPendingTierChange\Changes\Tier $tier;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipPendingTierChange\Changes\Tier $tier)
    {
        $this->tier = $tier;
    }
}
