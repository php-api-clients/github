...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipPendingTierChange\Changes;
...
final readonly class Tier
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $from;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $from)
    {
        $this->from = $from;
    }
}
