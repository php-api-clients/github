...
final readonly class Release
{
    ...
    public function __construct(string $url, string $html_url, string $assets_url, string $upload_url, string $tarball_url, string $zipball_url, int $id, string $node_id, string $tag_name, string $target_commitish, string $name, string $body, bool $draft, bool $prerelease, string $created_at, string $published_at, SimpleUser $author, array $assets, string $body_html, string $body_text, int $mentions_count, string $discussion_url, ReactionRollup $reactions)
    {
        $this->url              = $url;
