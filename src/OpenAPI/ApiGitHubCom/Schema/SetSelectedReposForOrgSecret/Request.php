...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetSelectedReposForOrgSecret;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetSelectedReposForOrgSecret\\Request';
