...
final readonly class CodeScanningCodeqlDatabase
{
    ...
    public function __construct(int $id, string $name, string $language, SimpleUser $uploader, string $content_type, int $size, string $created_at, string $updated_at, string $url)
    {
        $this->id           = $id;
        $this->name         = $name;
