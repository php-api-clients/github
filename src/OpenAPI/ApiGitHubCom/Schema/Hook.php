...
final class Hook
{
    ...
    public const SCHEMA_EXAMPLE = '{"id":42,"name":"web","active":true,"events":"pull_request","config":{"email":"\\"foo@bar.com\\"","password":"\\"foo\\"","room":"\\"roomer\\"","subdomain":"\\"foo\\"","url":"https:\\/\\/example.com\\/webhook","content_type":"\\"json\\"","digest":"\\"sha256\\"","secret":"\\"********\\"","token":"\\"abc\\""},"updated_at":"2011-09-06T20:39:23Z","created_at":"2011-09-06T17:26:27Z","url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1","test_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1\\/test","ping_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1\\/pings","deliveries_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1\\/deliveries"}';
     ...
     */
    public function __construct(string $type, int $id, string $name, bool $active, array $events, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Hook\Config $config, string $updated_at, string $created_at, string $url, string $test_url, string $ping_url, string $deliveries_url, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\HookResponse $last_response)
    {
        $this->type = $type;
        $this->id = $id;
        $this->name = $name;
