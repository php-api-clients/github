...
final class TimelineCommittedEvent
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Author::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Author $author;
    /**
     * Identifying information for the git-user
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Committer::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Committer $committer;
    /**
     * Message describing the purpose of the commit
     */
    private string $message;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Tree::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Tree $tree;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Parents>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Parents::class)
     */
    private array $parents = array();
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Verification::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Verification $verification;
     ...
     * Identifying information for the git-user
     */
    public function author() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Author
    {
        return $this->author;
    }
    /**
     * Identifying information for the git-user
     */
    public function committer() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Committer
    {
    ...
    public function tree() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Tree
    {
        return $this->tree;
    }
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Parents>
     */
    public function parents() : array
    {
        return $this->parents;
    }
    public function verification() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\TimelineCommittedEvent\Verification
    {
