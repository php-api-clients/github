...
final class AutoMerge
{
    ...
    public function __construct(string $commit_message, string $commit_title, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AutoMerge\EnabledBy $enabled_by, string $merge_method)
    {
