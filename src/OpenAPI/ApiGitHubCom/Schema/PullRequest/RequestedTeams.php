...
final class RequestedTeams
{
    ...
    public function __construct(bool $deleted, string $description, string $html_url, int $id, string $members_url, string $name, string $node_id, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RequestedTeams\Parent_ $parent, string $permission, string $privacy, string $repositories_url, string $slug, string $url)
    {
