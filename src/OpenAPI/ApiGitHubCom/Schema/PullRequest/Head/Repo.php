...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PullRequest\Head;
...
final readonly class Repo
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PullRequest\Head\Repo\Owner $owner;
    public ?bool $private;
    ...
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\FullRepository\Permissions $permissions;
    public string $temp_clone_token;
    public bool $allow_merge_commit;
    public bool $allow_squash_merge;
    public bool $allow_rebase_merge;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PullRequest\Head\Repo\License $license;
