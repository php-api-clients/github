...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateOrgVariable\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'UpdateOrgVariable\\Request\\Application\\Json';
