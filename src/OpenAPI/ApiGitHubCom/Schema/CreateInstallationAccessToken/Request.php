...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateInstallationAccessToken;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateInstallationAccessToken\\Request';
    public const SCHEMA_DESCRIPTION = '';
    /**
     * List of repository names that the token should have access to
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Repositories>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Repositories::class)
     */
    private array $repositories = array();
    /**
     * List of repository IDs that the token should have access to
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RepositoryIds>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RepositoryIds::class)
     */
    ...
    /**
     * List of repository names that the token should have access to
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Repositories>
     */
    ...
    /**
     * List of repository IDs that the token should have access to
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RepositoryIds>
     */
