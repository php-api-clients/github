...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateInstallationAccessToken\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateInstallationAccessToken\\Request\\Application\\Json';
