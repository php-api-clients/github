...
final readonly class Comment
{
    ...
    public function __construct(string $author_association, string $body, string $created_at, string $html_url, int $id, string $issue_url, string $node_id, mixed $performed_via_github_app, Reactions $reactions, string $updated_at, string $url, AnswerChosenBy $user)
    {
