...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CommunityProfile\Files;
...
final readonly class CommunityProfile
{
    ...
    public function __construct(int $health_percentage, string $description, string $documentation, Files $files, string $updated_at, bool $content_reports_enabled)
    {
