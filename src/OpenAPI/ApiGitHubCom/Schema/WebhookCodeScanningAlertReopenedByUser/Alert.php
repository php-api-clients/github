...
final readonly class Alert
{
    ...
    public function __construct(string $created_at, mixed $dismissed_at, mixed $dismissed_by, mixed $dismissed_reason, string $html_url, MostRecentInstance $most_recent_instance, int $number, Rule $rule, string $state, Tool $tool, string $url)
    {
