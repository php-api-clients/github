...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AddCustomLabelsToSelfHostedRunnerForEnterprise;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'AddCustomLabelsToSelfHostedRunnerForEnterprise\\Request';
