...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteRequested;
...
final class CheckSuite
{
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\App $app;
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\HeadCommit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\HeadCommit $head_commit;
    /**
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\PullRequests>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\PullRequests::class)
     */
     ...
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     */
    public function app() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\App
    {
        return $this->app;
    }
    ...
    public function head_commit() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\HeadCommit
    {
    ...
    /**
     * An array of pull requests that match this check suite. A pull request matches a check suite if they have the same `head_sha` and `head_branch`. When the check suite's `head_branch` is in a forked repository it will be `null` and the `pull_requests` array will be empty.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CheckSuite\PullRequests>
     */
