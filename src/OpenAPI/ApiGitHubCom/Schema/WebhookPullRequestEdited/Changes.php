...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestEdited\Changes\Base $base;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookProjectEdited\Changes\Body $body;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMilestoneEdited\Changes\Title $title;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestEdited\Changes\Base $base, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookProjectEdited\Changes\Body $body, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMilestoneEdited\Changes\Title $title)
    {
        $this->base = $base;
        $this->body = $body;
        $this->title = $title;
