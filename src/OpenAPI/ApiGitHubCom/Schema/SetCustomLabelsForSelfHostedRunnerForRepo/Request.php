...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetCustomLabelsForSelfHostedRunnerForRepo;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetCustomLabelsForSelfHostedRunnerForRepo\\Request';
