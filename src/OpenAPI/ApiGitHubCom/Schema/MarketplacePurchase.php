...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MarketplacePurchase\MarketplacePendingChange;
...
final readonly class MarketplacePurchase
{
    ...
    public ?string $email;
    public ?MarketplacePendingChange $marketplace_pending_change;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MarketplacePurchase\MarketplacePurchase $marketplace_purchase;

    public function __construct(string $url, string $type, int $id, string $login, string $organization_billing_email, string $email, MarketplacePendingChange $marketplace_pending_change, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MarketplacePurchase\MarketplacePurchase $marketplace_purchase)
    {
        $this->url                        = $url;
        $this->type                       = $type;
        $this->id                         = $id;
