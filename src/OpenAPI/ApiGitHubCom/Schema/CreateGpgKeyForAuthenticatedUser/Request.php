...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateGpgKeyForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateGpgKeyForAuthenticatedUser\\Request';
