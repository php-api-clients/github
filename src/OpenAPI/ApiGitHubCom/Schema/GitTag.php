...
final readonly class GitTag
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GitTag\Tagger $tagger;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GitTag\Object_ $object;
