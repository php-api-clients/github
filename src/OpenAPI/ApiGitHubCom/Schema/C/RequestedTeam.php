...
final class RequestedTeam
{
    ...
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RequestedTeam\Parent_ $parent;
    /**
    ...
    public function __construct(bool $deleted, string $description, string $html_url, int $id, string $members_url, string $name, string $node_id, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RequestedTeam\Parent_ $parent, string $permission, string $privacy, string $repositories_url, string $slug, string $url)
    {
