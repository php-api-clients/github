...
final class ProjectsV2Item
{
    ...
    public function __construct(int $id, string $node_id, string $project_node_id, string $content_node_id, string $content_type, array $creator, string $created_at, string $updated_at, string $archived_at)
    {
        $this->id = $id;
