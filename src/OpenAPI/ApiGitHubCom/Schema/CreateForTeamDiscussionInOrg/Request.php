...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateForTeamDiscussionInOrg;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateForTeamDiscussionInOrg\\Request';
