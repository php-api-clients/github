...
final readonly class OrganizationInvitation
{
    ...
    public function __construct(int $id, string $login, string $email, string $role, string $created_at, string $failed_at, string $failed_reason, SimpleUser $inviter, int $team_count, string $node_id, string $invitation_teams_url, string $invitation_source)
    {
        $this->id                   = $id;
        $this->login                = $login;
        $this->email                = $email;
