...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(Account $account, string $billing_cycle, mixed $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, Plan $plan, int $unit_count)
    {
