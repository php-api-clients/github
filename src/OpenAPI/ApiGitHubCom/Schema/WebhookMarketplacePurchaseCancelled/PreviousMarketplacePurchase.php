...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled;
...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, string $billing_cycle, mixed $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, int $unit_count)
    {
