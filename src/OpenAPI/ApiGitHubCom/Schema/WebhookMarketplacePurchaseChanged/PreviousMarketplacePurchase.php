...
final class PreviousMarketplacePurchase
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PreviousMarketplacePurchase\Account::class)
     */
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PreviousMarketplacePurchase\Plan $plan;
    private int $unit_count;
    public function account() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PreviousMarketplacePurchase\Account
    {
        return $this->account;
    }
    ...
    public function on_free_trial()
    {
        return $this->on_free_trial;
    }
    public function plan() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PreviousMarketplacePurchase\Plan
    {
        return $this->plan;
    }
