...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\ActionsBillingUsage\MinutesUsedBreakdown;
...
final readonly class ActionsBillingUsage
{
    ...
    public ?MinutesUsedBreakdown $minutes_used_breakdown;

    public function __construct(int $total_minutes_used, int $total_paid_minutes_used, int $included_minutes, MinutesUsedBreakdown $minutes_used_breakdown)
    {
