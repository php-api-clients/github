...
final class Page
{
    ...
    public const SCHEMA_EXAMPLE = '{"url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/pages","status":"built","cname":"example.com","protected_domain_state":"pending","custom_404":false,"html_url":"https:\\/\\/example.com","build_type":"legacy","public":true,"https_certificate":{"state":"approved","description":"Certificate is approved","domains":"www.example.com"},"https_enforced":true}';
     ...
     */
    public readonly ?string $protected_domain_state;
    /**
     * The timestamp when a pending domain becomes unverified.
     */
    public readonly ?string $pending_domain_unverified_at;
    /**
     * Whether the Page has a custom 404 page.
     */
    public readonly bool $custom_404;
    /**
