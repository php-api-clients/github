...
final readonly class Deployment
{
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp $performed_via_github_app;
    ...
    public ?string $url;
    public function __construct(string $created_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $creator, string $description, string $environment, int $id, string $node_id, string $original_environment, mixed $payload, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp $performed_via_github_app, bool $production_environment, string $ref, string $repository_url, string $sha, string $statuses_url, string $task, bool $transient_environment, string $updated_at, string $url)
    {
