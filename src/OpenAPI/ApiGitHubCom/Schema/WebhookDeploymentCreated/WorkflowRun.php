...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository;
...
final readonly class WorkflowRun
{
    ...
    public HeadRepository $head_repository;
    ...
    public ?AnswerChosenBy $triggering_actor;
    public ?string $updated_at;
    public ?string $url;
    public ?int $workflow_id;
    public string $workflow_url;

    public function __construct(AnswerChosenBy $actor, string $artifacts_url, string $cancel_url, int $check_suite_id, string $check_suite_node_id, string $check_suite_url, string $conclusion, string $created_at, string $display_title, string $event, string $head_branch, mixed $head_commit, HeadRepository $head_repository, string $head_sha, string $html_url, int $id, string $jobs_url, string $logs_url, string $name, string $node_id, string $path, mixed $previous_attempt_url, array $pull_requests, array $referenced_workflows, HeadRepository $repository, string $rerun_url, int $run_attempt, int $run_number, string $run_started_at, string $status, AnswerChosenBy $triggering_actor, string $updated_at, string $url, int $workflow_id, string $workflow_url)
    {
        $this->actor                = $actor;
