...
final readonly class GistHistory
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistHistory\ChangeStatus $change_status;
    public ?string $url;
    public function __construct(mixed $user, string $version, string $committed_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\GistHistory\ChangeStatus $change_status, string $url)
    {
        $this->user = $user;
