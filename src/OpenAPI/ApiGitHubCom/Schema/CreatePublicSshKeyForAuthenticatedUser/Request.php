...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreatePublicSshKeyForAuthenticatedUser;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreatePublicSshKeyForAuthenticatedUser\\Request';
