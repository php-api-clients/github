...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSecurityAdvisoryPublished;

use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSecurityAdvisoryPublished\SecurityAdvisory\Cvss;
...
final readonly class SecurityAdvisory
{
    ...
    public function __construct(Cvss $cvss, array $cwes, string $description, string $ghsa_id, array $identifiers, string $published_at, array $references, string $severity, string $summary, string $updated_at, array $vulnerabilities, string $withdrawn_at)
    {
        $this->cvss            = $cvss;
        $this->cwes            = $cwes;
