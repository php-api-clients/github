...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RunnerGroupsEnterprise;
...
final class SelectedWorkflows
{
    ...
    public const SCHEMA_TITLE = 'RunnerGroupsEnterprise\\SelectedWorkflows';
