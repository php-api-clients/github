...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetCustomLabelsForSelfHostedRunnerForEnterprise;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetCustomLabelsForSelfHostedRunnerForEnterprise\\Request';
