...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetStatusCheckContexts\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'SetStatusCheckContexts\\Request\\Application\\Json';
