...
final class MergeGroup
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MergeGroup\HeadCommit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MergeGroup\HeadCommit $head_commit;
    /**
     * The SHA of the merge group.
     */
    ...
    public function head_commit() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\MergeGroup\HeadCommit
    {
