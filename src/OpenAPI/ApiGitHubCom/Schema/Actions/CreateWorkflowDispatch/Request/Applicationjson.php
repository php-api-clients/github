...
final readonly class Applicationjson
{
     ...
     */
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Actions\CreateWorkflowDispatch\Request\Applicationjson\Inputs $inputs;
    public function __construct(string $ref, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Actions\CreateWorkflowDispatch\Request\Applicationjson\Inputs $inputs)
    {
        $this->ref = $ref;
        $this->inputs = $inputs;
    }
