...
final class Tier
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Tier\From::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Tier\From $from;
    /**
     * The `tier_changed` and `pending_tier_change` will include the original tier before the change or pending change. For more information, see the pending tier change payload.
     */
    public function from() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Tier\From
    {
        return $this->from;
    }
}
