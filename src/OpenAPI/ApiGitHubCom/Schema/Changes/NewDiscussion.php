...
final class NewDiscussion
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\AnswerChosenBy::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\AnswerChosenBy $answer_chosen_by;
    ...
    private string $body;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Category::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Category $category;
    ...
    private int $number;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Reactions::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Reactions $reactions = null;
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\User::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\User $user;
    ...
    public function answer_chosen_by() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\AnswerChosenBy
    {
    ...
    public function category() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Category
    {
    ...
    public function reactions() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\Reactions
    {
    ...
    public function user() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewDiscussion\User
    {
        return $this->user;
    }
}
