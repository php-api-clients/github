...
final class Owner
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Owner\From::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Owner\From $from;
    public function from() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Owner\From
    {
        return $this->from;
    }
}
