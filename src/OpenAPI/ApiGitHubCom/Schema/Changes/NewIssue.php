...
final class NewIssue
{
    ...
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Assignee $assignee;
    /**
     ...
     */
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Milestone $milestone;
    public readonly string $node_id;
    public readonly int $number;
    /**
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     */
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\PerformedViaGithubApp $performed_via_github_app;
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\PullRequest $pull_request;
    public readonly \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Reactions $reactions;
    ...
    public readonly ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\User $user;
    /**
     * @param array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Assignees> $assignees
     * @param array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Labels> $labels
     */
    public function __construct(string $active_lock_reason, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Assignee $assignee, array $assignees, string $author_association, string $body, string $closed_at, int $comments, string $comments_url, string $created_at, bool $draft, string $events_url, string $html_url, int $id, array $labels, string $labels_url, bool $locked, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Milestone $milestone, string $node_id, int $number, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\PerformedViaGithubApp $performed_via_github_app, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\PullRequest $pull_request, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\Reactions $reactions, string $repository_url, string $state, string $state_reason, string $timeline_url, string $title, string $updated_at, string $url, ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\NewIssue\User $user)
    {
