...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\DeleteFile\Request\Applicationjson\Author;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\DeleteFile\Request\Applicationjson\Committer;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $message, string $sha, string $branch, Committer $committer, Author $author)
    {
