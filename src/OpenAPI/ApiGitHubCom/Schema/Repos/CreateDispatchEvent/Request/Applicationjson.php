...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\CreateDispatchEvent\Request\Applicationjson\ClientPayload;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $event_type, ClientPayload $client_payload)
    {
