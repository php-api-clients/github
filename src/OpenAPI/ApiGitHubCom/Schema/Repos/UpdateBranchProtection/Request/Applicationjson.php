...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredStatusChecks;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\Restrictions;
...
final readonly class Applicationjson
{
    ...
    public function __construct(RequiredStatusChecks $required_status_checks, bool $enforce_admins, RequiredPullRequestReviews $required_pull_request_reviews, Restrictions $restrictions, bool $required_linear_history, bool $allow_force_pushes, bool $allow_deletions, bool $block_creations, bool $required_conversation_resolution, bool $lock_branch, bool $allow_fork_syncing)
    {
