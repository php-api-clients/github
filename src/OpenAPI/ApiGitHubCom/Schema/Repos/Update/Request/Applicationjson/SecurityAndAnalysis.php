...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\AdvancedSecurity;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanning;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanningPushProtection;
...
You can check which security and analysis features are currently enabled by using a `GET /repos/{owner}/{repo}` request.';
    ...
    public function __construct(AdvancedSecurity $advanced_security, SecretScanning $secret_scanning, SecretScanningPushProtection $secret_scanning_push_protection)
    {
