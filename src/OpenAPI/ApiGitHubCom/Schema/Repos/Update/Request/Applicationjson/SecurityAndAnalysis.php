...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson;
...
You can check which security and analysis features are currently enabled by using a `GET /repos/{owner}/{repo}` request.';
     ...
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\AdvancedSecurity $advanced_security;
    /**
     * Use the `status` property to enable or disable secret scanning for this repository. For more information, see "[About secret scanning](/code-security/secret-security/about-secret-scanning)."
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanning $secret_scanning;
    /**
     * Use the `status` property to enable or disable secret scanning push protection for this repository. For more information, see "[Protecting pushes with secret scanning](/code-security/secret-scanning/protecting-pushes-with-secret-scanning)."
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanningPushProtection $secret_scanning_push_protection;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\AdvancedSecurity $advanced_security, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanning $secret_scanning, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\Update\Request\Applicationjson\SecurityAndAnalysis\SecretScanningPushProtection $secret_scanning_push_protection)
    {
