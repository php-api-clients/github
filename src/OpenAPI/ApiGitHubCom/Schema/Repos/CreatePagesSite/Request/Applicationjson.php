...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\CreatePagesSite\Request\Applicationjson\Source;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $build_type, Source $source)
    {
