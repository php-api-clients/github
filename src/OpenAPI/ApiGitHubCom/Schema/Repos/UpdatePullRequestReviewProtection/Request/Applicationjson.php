...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews\BypassPullRequestAllowances;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews\DismissalRestrictions;
...
final readonly class Applicationjson
{
     ...
     */
    public ?BypassPullRequestAllowances $bypass_pull_request_allowances;

    public function __construct(DismissalRestrictions $dismissal_restrictions, bool $dismiss_stale_reviews, bool $require_code_owner_reviews, int $required_approving_review_count, bool $require_last_push_approval, BypassPullRequestAllowances $bypass_pull_request_allowances)
    {
