...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\UpdateWebhook\Request\Applicationjson\Config;
...
final readonly class Applicationjson
{
    ...
    public function __construct(Config $config, array $events, array $add_events, array $remove_events, bool $active)
    {
        $this->config        = $config;
        $this->events        = $events;
