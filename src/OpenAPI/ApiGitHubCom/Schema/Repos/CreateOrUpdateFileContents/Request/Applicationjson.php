...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\CreateOrUpdateFileContents\Request\Applicationjson\Author;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Repos\CreateOrUpdateFileContents\Request\Applicationjson\Committer;
...
final readonly class Applicationjson
{
    ...
    public function __construct(string $message, string $content, string $sha, string $branch, Committer $committer, Author $author)
    {
