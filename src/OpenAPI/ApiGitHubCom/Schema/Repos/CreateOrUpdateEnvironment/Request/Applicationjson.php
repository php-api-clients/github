...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DeploymentBranchPolicySettings;
...
final readonly class Applicationjson
{
     ...
     */
    public ?DeploymentBranchPolicySettings $deployment_branch_policy;

    public function __construct(int $wait_timer, array $reviewers, DeploymentBranchPolicySettings $deployment_branch_policy)
    {
