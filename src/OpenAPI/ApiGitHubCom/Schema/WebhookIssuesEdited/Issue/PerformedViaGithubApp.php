...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesEdited\Issue;
...
final readonly class PerformedViaGithubApp
{
     ...
     */
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesAssigned\Issue\PerformedViaGithubApp\Permissions $permissions;
    /**
     * The slug name of the GitHub app
     */
    public string $slug;
    public ?string $updated_at;
    public function __construct(string $created_at, string $description, array $events, string $external_url, string $html_url, int $id, string $name, string $node_id, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $owner, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesAssigned\Issue\PerformedViaGithubApp\Permissions $permissions, string $slug, string $updated_at)
    {
