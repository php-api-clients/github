...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssueCommentEdited\Changes\Body $body;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesEdited\Changes\Title $title;
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssueCommentEdited\Changes\Body $body, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssuesEdited\Changes\Title $title)
    {
        $this->body = $body;
        $this->title = $title;
    }
