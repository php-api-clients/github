...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool;
...
final readonly class Alert
{
    ...
    public function __construct(string $created_at, string $dismissed_at, AnswerChosenBy $dismissed_by, string $dismissed_reason, string $html_url, MostRecentInstance $most_recent_instance, int $number, Rule $rule, string $state, Tool $tool, string $url)
    {
