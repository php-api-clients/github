...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CodeScanningAlertInstance\Message;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Location;
...
final readonly class MostRecentInstance
{
    ...
    public function __construct(string $analysis_key, array $classifications, string $commit_sha, string $environment, Location $location, Message $message, string $ref, string $state)
    {
