...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Manifest\File;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Manifest\Resolved;
...
final readonly class Manifest
{
    ...
    public function __construct(string $name, File $file, Metadata $metadata, Resolved $resolved)
    {
        $this->name     = $name;
        $this->file     = $file;
