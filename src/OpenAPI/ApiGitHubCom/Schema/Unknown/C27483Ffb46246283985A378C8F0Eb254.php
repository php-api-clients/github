...
final class C27483Ffb46246283985A378C8F0Eb254
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C27483Ffb46246283985A378C8F0Eb254\Inputs::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C27483Ffb46246283985A378C8F0Eb254\Inputs $inputs = null;
    /**
     * The git reference for the workflow. The reference can be a branch or tag name.
     */
     ...
     * Input keys and values configured in the workflow file. The maximum number of properties is 10. Any default properties configured in the workflow file will be used when `inputs` are omitted.
     */
    public function inputs() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C27483Ffb46246283985A378C8F0Eb254\Inputs
    {
        return $this->inputs;
    }
}
