...
final class CBa3Faccf3E2861657A3F4136D67Db6F1
{
    ...
    * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\CFa1F5016C613E4772588854C56E7C8D8::class)
    */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\CFa1F5016C613E4772588854C56E7C8D8 $files;
    /**
     * The description of the gist.
     */
    ...
    * The gist files to be updated, renamed, or deleted. Each `key` must match the current filename
    ...
    To delete a file, set the whole file to null. For example: `hello.py : null`.
    */
    public function files() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Unknown\CFa1F5016C613E4772588854C56E7C8D8
    {
        return $this->files;
    }
}
