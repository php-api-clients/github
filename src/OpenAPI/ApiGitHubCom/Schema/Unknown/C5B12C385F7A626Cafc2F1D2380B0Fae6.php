...
final class C5B12C385F7A626Cafc2F1D2380B0Fae6
{
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C5B12C385F7A626Cafc2F1D2380B0Fae6\Names>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C5B12C385F7A626Cafc2F1D2380B0Fae6\Names::class)
     */
    private array $names = array();
    /**
     * An array of topics to add to the repository. Pass one or more topics to _replace_ the set of existing topics. Send an empty array (`[]`) to clear all topics from the repository. **Note:** Topic `names` cannot contain uppercase letters.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\C5B12C385F7A626Cafc2F1D2380B0Fae6\Names>
     */
