...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled;
...
final readonly class Sponsorship
{
    ...
    public \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner $maintainer;
    public ?string $node_id;
    public ?string $privacy_level;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $sponsor;
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $sponsorable;
    /**
     * The `tier_changed` and `pending_tier_change` will include the original tier before the change or pending change. For more information, see the pending tier change payload.
     */
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $tier;
    public function __construct(string $created_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner $maintainer, string $node_id, string $privacy_level, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $sponsor, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Discussion\AnswerChosenBy $sponsorable, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $tier)
    {
