...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier;
...
final readonly class Sponsorship
{
    ...
    public Owner $maintainer;
    public ?string $node_id;
    public ?string $privacy_level;
    public ?AnswerChosenBy $sponsor;
    public ?AnswerChosenBy $sponsorable;
    /**
     * The `tier_changed` and `pending_tier_change` will include the original tier before the change or pending change. For more information, see the pending tier change payload.
     */
    public ?Tier $tier;

    public function __construct(string $created_at, Owner $maintainer, string $node_id, string $privacy_level, AnswerChosenBy $sponsor, AnswerChosenBy $sponsorable, Tier $tier)
    {
