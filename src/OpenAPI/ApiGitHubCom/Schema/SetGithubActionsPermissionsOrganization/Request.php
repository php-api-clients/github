...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\SetGithubActionsPermissionsOrganization;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'SetGithubActionsPermissionsOrganization\\Request';
