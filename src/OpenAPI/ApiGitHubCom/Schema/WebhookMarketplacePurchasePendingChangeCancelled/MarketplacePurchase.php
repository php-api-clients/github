...
final class MarketplacePurchase
{
    ...
    public function __construct(object $account, string $billing_cycle, mixed $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, object $plan, int $unit_count)
    {
