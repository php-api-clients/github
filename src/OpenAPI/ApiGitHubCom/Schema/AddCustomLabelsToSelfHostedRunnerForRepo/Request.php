...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\AddCustomLabelsToSelfHostedRunnerForRepo;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'AddCustomLabelsToSelfHostedRunnerForRepo\\Request';
