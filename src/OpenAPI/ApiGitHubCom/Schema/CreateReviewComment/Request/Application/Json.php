...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateReviewComment\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_EXAMPLE = '{"in_reply_to":2}';
    public const SCHEMA_TITLE = 'CreateReviewComment\\Request\\Application\\Json';
     ...
     */
    public readonly ?int $in_reply_to;
