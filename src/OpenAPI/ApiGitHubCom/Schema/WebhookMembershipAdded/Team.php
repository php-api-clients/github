...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMembershipAdded\Team\Parent_;
...
final readonly class Team
{
    ...
    public function __construct(bool $deleted, string $description, string $html_url, int $id, string $members_url, string $name, string $node_id, Parent_ $parent, string $permission, string $privacy, string $repositories_url, string $slug, string $url)
    {
