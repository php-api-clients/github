...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMembershipAdded;
...
final readonly class Team
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMembershipAdded\Team\Parent_ $parent;
    /**
     ...
     */
    public string $url;
    public function __construct(bool $deleted, string $description, string $html_url, int $id, string $members_url, string $name, string $node_id, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookMembershipAdded\Team\Parent_ $parent, string $permission, string $privacy, string $repositories_url, string $slug, string $url)
    {
