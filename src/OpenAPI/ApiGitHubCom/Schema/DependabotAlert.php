...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\DependabotAlertWithRepository\Dependency;
...
final readonly class DependabotAlert
{
     ...
     */
    public ?DependabotAlertSecurityAdvisory $security_advisory;
    /**
     * Details pertaining to one vulnerable version range for the advisory.
     */
    public ?DependabotAlertSecurityVulnerability $security_vulnerability;
    /**
    ...
    public function __construct(int $number, string $state, Dependency $dependency, DependabotAlertSecurityAdvisory $security_advisory, DependabotAlertSecurityVulnerability $security_vulnerability, string $url, string $html_url, string $created_at, string $updated_at, string $dismissed_at, mixed $dismissed_by, string $dismissed_reason, string $dismissed_comment, string $fixed_at)
    {
        $this->number                 = $number;
        $this->state                  = $state;
