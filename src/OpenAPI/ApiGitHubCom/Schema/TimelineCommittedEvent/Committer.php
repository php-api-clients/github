...
final class Committer
{
    ...
    public const SCHEMA_EXAMPLE = '{"date":"2014-08-09T08:02:04+12:00","email":"monalisa.octocat@example.com","name":"Monalisa Octocat"}';
    public const SCHEMA_TITLE = 'TimelineCommittedEvent\\Committer';
