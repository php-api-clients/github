...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookProjectCardDeleted;
...
final readonly class ProjectCard
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssueCommentDeleted\Comment\User $creator;
    /**
    ...
    public ?string $url;
    public function __construct(int $after_id, bool $archived, int $column_id, string $column_url, string $content_url, string $created_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssueCommentDeleted\Comment\User $creator, int $id, string $node_id, string $note, string $project_url, string $updated_at, string $url)
    {
