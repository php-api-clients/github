...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PatchSecurityAnalysisSettingsForEnterprise;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'PatchSecurityAnalysisSettingsForEnterprise\\Request';
