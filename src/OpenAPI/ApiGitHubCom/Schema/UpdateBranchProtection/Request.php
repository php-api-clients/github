...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateBranchProtection;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'UpdateBranchProtection\\Request';
    public const SCHEMA_DESCRIPTION = '';
    /**
     * Require status checks to pass before merging. Set to `null` to disable.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredStatusChecks::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredStatusChecks $required_status_checks;
    /**
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredPullRequestReviews::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredPullRequestReviews $required_pull_request_reviews;
    /**
     * Restrict who can push to the protected branch. User, app, and team `restrictions` are only available for organization-owned repositories. Set to `null` to disable.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Restrictions::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Restrictions $restrictions;
    /**
     ...
     * Require status checks to pass before merging. Set to `null` to disable.
     */
    public function required_status_checks() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredStatusChecks
    {
     ...
     * Require at least one approving review on a pull request, before merging. Set to `null` to disable.
     */
    public function required_pull_request_reviews() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\RequiredPullRequestReviews
    {
     ...
     * Restrict who can push to the protected branch. User, app, and team `restrictions` are only available for organization-owned repositories. Set to `null` to disable.
     */
    public function restrictions() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Restrictions
    {
