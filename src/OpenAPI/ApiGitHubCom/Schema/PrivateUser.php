...
final class PrivateUser
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PrivateUser\Plan::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PrivateUser\Plan $plan = null;
    ...
    public function plan() : ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\PrivateUser\Plan
    {
        return $this->plan;
    }
