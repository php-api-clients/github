...
final class Job
{
    ...
    public const SCHEMA_EXAMPLE = '{"id":"5622a2b0-63f6-4732-8c34-a1ab27e102a11","correlator":"yourworkflowname_yourjobname","html_url":"http:\\/\\/example.com\\/build"}';
    public const SCHEMA_TITLE = 'Snapshot\\Job';
     ...
     */
    public readonly string $correlator;
    /**
     * The url for the job.
     */
