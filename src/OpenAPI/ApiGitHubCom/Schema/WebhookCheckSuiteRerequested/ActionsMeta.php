...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookCheckSuiteRerequested\ActionsMeta\RerunInfo;
...
final readonly class ActionsMeta
{
    ...
    public ?RerunInfo $rerun_info;

    public function __construct(RerunInfo $rerun_info)
    {
