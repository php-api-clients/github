...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\RemoveAppAccessRestrictions;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'RemoveAppAccessRestrictions\\Request';
