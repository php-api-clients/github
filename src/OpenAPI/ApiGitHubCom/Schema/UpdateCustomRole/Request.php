...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateCustomRole;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'UpdateCustomRole\\Request';
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Permissions>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Permissions::class)
     */
    ...
    /**
     * A list of additional permissions included in this role. If specified, these permissions will replace any currently set on the role.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Permissions>
     */
