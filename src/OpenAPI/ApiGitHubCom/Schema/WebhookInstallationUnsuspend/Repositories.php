...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookInstallationUnsuspend;
...
final class Repositories
{
    ...
    public const SCHEMA_TITLE = 'WebhookInstallationUnsuspend\\Repositories';
