...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links;
...
final readonly class Comment
{
    ...
    public function __construct(Links $_links, string $author_association, string $body, string $commit_id, string $created_at, string $diff_hunk, string $html_url, int $id, int $in_reply_to_id, int $line, string $node_id, string $original_commit_id, int $original_line, int $original_position, int $original_start_line, string $path, int $position, int $pull_request_review_id, string $pull_request_url, Reactions $reactions, string $side, int $start_line, string $start_side, string $updated_at, string $url, AnswerChosenBy $user)
    {
        $this->_links                 = $_links;
