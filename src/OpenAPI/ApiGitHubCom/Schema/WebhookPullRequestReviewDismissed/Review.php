...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestReviewDismissed;
...
final readonly class Review
{
    ...
    public ?\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestReviewDismissed\Review\Links $_links;
    /**
    ...
    public function __construct(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPullRequestReviewDismissed\Review\Links $_links, string $author_association, string $body, string $commit_id, string $html_url, int $id, string $node_id, string $pull_request_url, string $state, string $submitted_at, \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookIssueCommentDeleted\Comment\User $user)
    {
        $this->_links = $_links;
