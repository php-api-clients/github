...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Commit\Files;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Commit\Parents;
...
final class Commit
{
    ...
    public function committer(): SimpleUser
    {
