...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateSelfHostedRunnerGroupForOrg;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateSelfHostedRunnerGroupForOrg\\Request';
