...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateSelfHostedRunnerGroupForOrg\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateSelfHostedRunnerGroupForOrg\\Request\\Application\\Json';
