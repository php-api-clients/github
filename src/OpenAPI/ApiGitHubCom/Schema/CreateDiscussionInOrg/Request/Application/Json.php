...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateDiscussionInOrg\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_TITLE = 'CreateDiscussionInOrg\\Request\\Application\\Json';
