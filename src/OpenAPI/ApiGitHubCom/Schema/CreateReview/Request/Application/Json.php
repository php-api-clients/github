...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateReview\Request\Application;
...
final class Json
{
    ...
    public const SCHEMA_EXAMPLE = '{"comments":[{"line":28,"side":"RIGHT","start_line":26,"start_side":"LEFT"}]}';
    public const SCHEMA_TITLE = 'CreateReview\\Request\\Application\\Json';
