...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\CreateReview;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'CreateReview\\Request';
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Comments>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Comments::class)
     */
    ...
    /**
     * Use the following table to specify the location, destination, and contents of the draft review comment.
     * @return array<\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Comments>
     */
