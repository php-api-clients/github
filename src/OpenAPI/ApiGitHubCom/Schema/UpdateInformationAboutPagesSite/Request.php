...
namespace ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\UpdateInformationAboutPagesSite;
...
final class Request
{
    ...
    public const SCHEMA_TITLE = 'UpdateInformationAboutPagesSite\\Request';
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Source::class)
     */
    private \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Source $source;
    /**
     * Specify a custom domain for the repository. Sending a `null` value will remove the custom domain. For more about custom domains, see "[Using a custom domain with GitHub Pages](https://docs.github.com/articles/using-a-custom-domain-with-github-pages/)."
     */
    ...
    public function source() : \ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\Request\Source
    {
        return $this->source;
    }
}
