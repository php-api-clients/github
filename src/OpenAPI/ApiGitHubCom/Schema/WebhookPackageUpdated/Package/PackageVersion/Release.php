...
final readonly class Release
{
    ...
    public function __construct(AnswerChosenBy $author, string $created_at, bool $draft, string $html_url, int $id, string $name, bool $prerelease, string $published_at, string $tag_name, string $target_commitish, string $url)
    {
        $this->author           = $author;
