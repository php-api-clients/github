...
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPackagePublished\Package\Registry;
use ApiClients\Client\Github\OpenAPI\ApiGitHubCom\Schema\WebhookPackageUpdated\Package\PackageVersion;
...
final readonly class Package
{
    ...
    public function __construct(string $created_at, string $description, string $ecosystem, string $html_url, int $id, string $name, string $namespace, AnswerChosenBy $owner, string $package_type, PackageVersion $package_version, Registry $registry, string $updated_at)
    {
