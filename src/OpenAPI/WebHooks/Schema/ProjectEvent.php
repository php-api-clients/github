...
{
    public const SCHEMA_TITLE = 'project_event';
    public const SCHEMA_DESCRIPTION = '';
    private string $action;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\WebHooks\Schema\Project::class)
     */
    private \ApiClients\Client\Github\OpenAPI\WebHooks\Schema\Project $project;
    /**
     * A git repository
    ...
    public function project() : \ApiClients\Client\Github\OpenAPI\WebHooks\Schema\Project
    {
        return $this->project;
    }
    /**
