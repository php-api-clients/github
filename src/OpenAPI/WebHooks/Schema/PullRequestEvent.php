...
{
    public const SCHEMA_TITLE = 'pull_request_event';
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\WebHooks\Schema\User $assignee;
    /**
     * A git repository
    ...
    public function assignee() : \ApiClients\Client\Github\OpenAPI\WebHooks\Schema\User
    {
