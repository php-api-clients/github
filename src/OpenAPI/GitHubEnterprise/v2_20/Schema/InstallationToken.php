...
final class InstallationToken
{
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_20\Schema\AppPermissions $permissions = null;
    private ?string $repository_selection = null;
    /**
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_20\Schema\Repository>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_20\Schema\Repository::class)
     */
     ...
     * The permissions granted to the user-to-server access token.
     */
    public function permissions() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_20\Schema\AppPermissions
    {
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_20\Schema\Repository>
     */
