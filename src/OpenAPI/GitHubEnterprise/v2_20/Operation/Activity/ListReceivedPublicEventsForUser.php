...
final class ListReceivedPublicEventsForUser
{
    ...
    {
        return new Request('get', str_replace(['{username}', '{per_page}', '{page}'], [$this->username, $this->per_page, $this->page], '/users/{username}/received_events/public?per_page={per_page}&page={page}'));
    }
