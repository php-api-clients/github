...
final class CFd7F1157Ce674175F74751Ab8Ade34Da
{
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Parents>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Parents::class)
     */
    private array $parents = array();
    /**
     * Information about the author of the commit. By default, the `author` will be the authenticated user and the current date. See the `author` and `committer` object below for details.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Author::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Author $author = null;
    /**
     * Information about the person who is making the commit. By default, `committer` will use the information set in `author`. See the `author` and `committer` object below for details.
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Committer::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Committer $committer = null;
    /**
    ...
    /**
     * The SHAs of the commits that were the parents of this commit. If omitted or empty, the commit will be written as a root commit. For a single parent, an array of one SHA should be provided; for a merge commit, an array of more than one should be provided.
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Parents>
     */
     ...
     * Information about the author of the commit. By default, the `author` will be the authenticated user and the current date. See the `author` and `committer` object below for details.
     */
    public function author() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Author
    {
        return $this->author;
    }
    /**
     * Information about the person who is making the commit. By default, `committer` will use the information set in `author`. See the `author` and `committer` object below for details.
     */
    public function committer() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\CFd7F1157Ce674175F74751Ab8Ade34Da\Committer
    {
