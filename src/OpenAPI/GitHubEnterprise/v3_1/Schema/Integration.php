...
final class Integration
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Owner::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Owner $owner;
    /**
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Permissions::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Permissions $permissions;
    /**
     * The list of events for the GitHub app
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Events>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Events::class)
     */
    ...
    public function owner() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Owner
    {
        return $this->owner;
    }
    /**
     ...
     * The set of permissions for the GitHub app
     */
    public function permissions() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Permissions
    {
        return $this->permissions;
    }
    /**
     * The list of events for the GitHub app
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Integration\Events>
     */
