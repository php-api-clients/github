...
namespace ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\RemovedFromProjectIssueEvent;
...
final class ProjectCard
{
    ...
    public const SCHEMA_TITLE = 'RemovedFromProjectIssueEvent\\ProjectCard';
