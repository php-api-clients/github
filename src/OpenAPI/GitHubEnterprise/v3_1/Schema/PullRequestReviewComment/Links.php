...
namespace ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\PullRequestReviewComment;
...
final class Links
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Links\Self::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Links\Self $self;
    /**
    ...
    public function self() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Links\Self
    {
        return $this->self;
    }
