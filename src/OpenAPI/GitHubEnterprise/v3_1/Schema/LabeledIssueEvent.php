...
final class LabeledIssueEvent
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\PerformedViaGithubApp::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\PerformedViaGithubApp $performed_via_github_app;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\Label::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\Label $label;
    ...
    public function performed_via_github_app() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\PerformedViaGithubApp
    {
        return $this->performed_via_github_app;
    }
    public function label() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\LabeledIssueEvent\Label
    {
        return $this->label;
    }
}
