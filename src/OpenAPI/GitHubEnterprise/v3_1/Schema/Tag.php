...
final class Tag
{
    ...
    private string $name;
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Tag\Commit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Tag\Commit $commit;
    ...
    public function commit() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Tag\Commit
    {
        return $this->commit;
    }
