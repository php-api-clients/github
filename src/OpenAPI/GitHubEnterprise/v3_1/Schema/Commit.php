...
final class Commit
{
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Commit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Commit $commit;
    /**
    ...
    /**
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Stats::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Stats $stats = null;
    /**
    ...
    public function commit() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Commit
    {
        return $this->commit;
    }
    ...
    public function stats() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Commit\Stats
    {
        return $this->stats;
    }
    /**
