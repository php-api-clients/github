...
final class PagesHttpsCertificate
{
     ...
     * @var array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\PagesHttpsCertificate\Domains>
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\PagesHttpsCertificate\Domains::class)
     */
    ...
    /**
     * Array of the domain set and its alternate name (if it is configured)
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\PagesHttpsCertificate\Domains>
     */
