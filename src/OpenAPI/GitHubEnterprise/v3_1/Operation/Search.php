...
final class Search
{
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Code_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $sort, $order, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Commits_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $sort, $order, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\IssuesAndPullRequests_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $sort, $order, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Labels_($this->requestSchemaValidator, $this->responseSchemaValidator, $repository_id, $q, $sort, $order, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Repos_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $sort, $order, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Topics_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $per_page, $page);
    }
    ...
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Operation\Search\Users_($this->requestSchemaValidator, $this->responseSchemaValidator, $q, $sort, $order, $per_page, $page);
    }
}
