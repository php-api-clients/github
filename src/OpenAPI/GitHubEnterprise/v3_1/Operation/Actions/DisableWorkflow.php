...
final class DisableWorkflow
{
    ...
    {
        return new Request('put', str_replace(['{owner}', '{repo}', '{workflow_id}'], [$this->owner, $this->repo, $this->workflow_id], '/repos/{owner}/{repo}/actions/workflows/{workflow_id}/disable?'));
    }
