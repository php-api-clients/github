            ...
            case 200:
                switch ($contentType) {
                    ...
                    case 'application/vnd.github.v3.star+json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Unknown\C8D13A2018821C89360F78Fa638427Ff2::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\GitHubEnterprise\\v3_1\\Schema\\Unknown\\C8D13A2018821C89360F78Fa638427Ff2', $body);
                }
                break;
            /**Not modified**/
            case 304:
