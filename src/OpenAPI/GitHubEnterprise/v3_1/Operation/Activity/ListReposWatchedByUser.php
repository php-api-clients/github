...
final class ListReposWatchedByUser
{
    ...
    {
        return new Request('get', str_replace(['{username}', '{per_page}', '{page}'], [$this->username, $this->per_page, $this->page], '/users/{username}/subscriptions?per_page={per_page}&page={page}'));
    }
