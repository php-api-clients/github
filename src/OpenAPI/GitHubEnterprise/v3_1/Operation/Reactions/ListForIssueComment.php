...
final class ListForIssueComment
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{comment_id}', '{content}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->comment_id, $this->content, $this->per_page, $this->page], '/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions?content={content}&per_page={per_page}&page={page}'));
    }
