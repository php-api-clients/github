...
final class ListWebhooks_
{
    ...
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Unknown\CB67C6Ee16Ad4A7D622A946776B49230E|\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Unknown\CB67C6Ee16Ad4A7D622A946776B49230E::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $hydrator->hydrate('\\ApiClients\\Client\\Github\\OpenAPI\\GitHubEnterprise\\v3_1\\Schema\\Unknown\\CB67C6Ee16Ad4A7D622A946776B49230E', $body);
                }
                break;
            /**Resource not found**/
            case 404:
