...
final class AddAuthorizedSshKey_
{
    ...
    function createRequest(array $data = array()) : \Psr\Http\Message\RequestInterface
    {
        ...
        return new \RingCentral\Psr7\Request('post', \str_replace(array(), array(), '/setup/api/settings/authorized-keys'), array('Content-Type' => 'application/x-www-form-urlencoded'), json_encode($data));
    }
