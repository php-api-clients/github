...
final class SetOrgAccessToSelfHostedRunnerGroupInEnterprise_
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_1\Schema\Unknown\CDdef0D007Da9A93C251Bdd64742Bc67F::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
