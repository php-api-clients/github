...
namespace ApiClients\Client\Github\OpenAPI\GitHubEnterprise\2.20\Operation\Reactions;

final class ListForTeamDiscussion
{
    private const OPERATION_ID = 'reactions/list-for-team-discussion';
    ...
    function __construct(string $accept = 'application/vnd.github.squirrel-girl-preview+json', $team_id, $discussion_number, $content, int $per_page = 30, int $page = 1)
    {
        $this->accept = $accept;
