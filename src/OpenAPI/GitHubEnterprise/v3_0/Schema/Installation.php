...
final class Installation
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\AppPermissions::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\AppPermissions $permissions;
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\NullableSimpleUser $suspended_by = null;
    ...
    public function account() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\SimpleUser
    {
        return $this->account;
    }
    /**
     ...
     * The permissions granted to the user-to-server access token.
     */
    public function permissions() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\AppPermissions
    {
     ...
     * Simple User
     */
    public function suspended_by() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v3_0\Schema\NullableSimpleUser
    {
