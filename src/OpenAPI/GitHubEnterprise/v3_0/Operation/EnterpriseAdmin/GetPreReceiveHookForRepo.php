...
final class GetPreReceiveHookForRepo
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{pre_receive_hook_id}'], [$this->owner, $this->repo, $this->pre_receive_hook_id], '/repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}?'));
    }
