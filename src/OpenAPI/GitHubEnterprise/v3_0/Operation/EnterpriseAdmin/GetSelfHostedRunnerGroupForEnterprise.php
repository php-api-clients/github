...
final class GetSelfHostedRunnerGroupForEnterprise
{
    ...
    {
        return new Request('get', str_replace(['{enterprise}', '{runner_group_id}'], [$this->enterprise, $this->runner_group_id], '/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}?'));
    }
