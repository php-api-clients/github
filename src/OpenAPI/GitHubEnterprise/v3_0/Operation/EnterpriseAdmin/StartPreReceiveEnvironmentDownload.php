...
final class StartPreReceiveEnvironmentDownload
{
    ...
    {
        return new Request('post', str_replace(['{pre_receive_environment_id}'], [$this->pre_receive_environment_id], '/admin/pre-receive-environments/{pre_receive_environment_id}/downloads?'));
    }
