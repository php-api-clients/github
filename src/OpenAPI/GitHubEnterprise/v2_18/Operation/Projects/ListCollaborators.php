...
final class ListCollaborators
{
    ...
    {
        return new Request('get', str_replace(['{project_id}', '{affiliation}', '{per_page}', '{page}'], [$this->project_id, $this->affiliation, $this->per_page, $this->page], '/projects/{project_id}/collaborators?affiliation={affiliation}&per_page={per_page}&page={page}'));
    }
