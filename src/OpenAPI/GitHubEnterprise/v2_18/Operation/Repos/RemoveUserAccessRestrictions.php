...
final class RemoveUserAccessRestrictions
{
    ...
    {
        return new Request('delete', str_replace(['{owner}', '{repo}', '{branch}'], [$this->owner, $this->repo, $this->branch], '/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users?'));
    }
