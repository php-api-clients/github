...
final class NullableScopedInstallation
{
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\AppPermissions $permissions;
    /**
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\SimpleUser $account;
    /**
     * The permissions granted to the user-to-server access token.
     */
     ...
     * Simple User
     */
    public function account() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\SimpleUser
    {
        return $this->account;
    }
}
