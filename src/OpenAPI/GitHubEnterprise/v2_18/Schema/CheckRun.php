...
final class CheckRun
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\DeploymentSimple::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\DeploymentSimple $deployment = null;
    /**
     * The id of the check.
     */
     ...
     * A deployment created as the result of an Actions check run from a workflow that references an environment
     */
    public function deployment() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_18\Schema\DeploymentSimple
    {
