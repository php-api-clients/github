...
final class ListCommitStatusesForRef
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{ref}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->ref, $this->per_page, $this->page], '/repos/{owner}/{repo}/commits/{ref}/statuses?per_page={per_page}&page={page}'));
    }
