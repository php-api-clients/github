...
final class SetStatusCheckContexts
{
    ...
    {
        return new Request('put', str_replace(['{owner}', '{repo}', '{branch}'], [$this->owner, $this->repo, $this->branch], '/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts?'));
    }
