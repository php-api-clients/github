...
final class ListForks
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{sort}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->sort, $this->per_page, $this->page], '/repos/{owner}/{repo}/forks?sort={sort}&per_page={per_page}&page={page}'));
    }
