...
final class ListReposStarredByAuthenticatedUser
{
    ...
    {
        return new Request('get', str_replace(['{sort}', '{direction}', '{per_page}', '{page}'], [$this->sort, $this->direction, $this->per_page, $this->page], '/user/starred?sort={sort}&direction={direction}&per_page={per_page}&page={page}'));
    }
