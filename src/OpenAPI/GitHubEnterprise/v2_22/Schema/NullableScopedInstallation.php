...
final class NullableScopedInstallation
{
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\AppPermissions $permissions;
    /**
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\SimpleUser $account;
    /**
     * The permissions granted to the user-to-server access token.
     */
    public function permissions() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\AppPermissions
    {
