...
final class CheckSuite
{
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\NullableIntegration $app = null;
    /**
     * Minimal Repository
    ...
    /**
     * Simple Commit
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\SimpleCommit::class)
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\SimpleCommit $head_commit;
     ...
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     */
    public function app() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\NullableIntegration
    {
        return $this->app;
    }
    /**
     ...
     * Simple Commit
     */
    public function head_commit() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\SimpleCommit
    {
