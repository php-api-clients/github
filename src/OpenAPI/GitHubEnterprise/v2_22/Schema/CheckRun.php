...
final class CheckRun
{
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\DeploymentSimple $deployment = null;
    /**
     * The id of the check.
     */
     ...
     * A deployment created as the result of an Actions check run from a workflow that references an environment
     */
    public function deployment() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_22\Schema\DeploymentSimple
    {
