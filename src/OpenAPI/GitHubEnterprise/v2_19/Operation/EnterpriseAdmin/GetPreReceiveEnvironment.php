...
final class GetPreReceiveEnvironment
{
    ...
    {
        return new Request('get', str_replace(['{pre_receive_environment_id}'], [$this->pre_receive_environment_id], '/admin/pre-receive-environments/{pre_receive_environment_id}?'));
    }
