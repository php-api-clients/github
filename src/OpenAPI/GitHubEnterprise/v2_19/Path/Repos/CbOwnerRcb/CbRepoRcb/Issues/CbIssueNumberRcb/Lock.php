...
final class Lock
{
    ...
    function delete($owner, $repo, $issue_number) : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_19\Operation\Issues\Unlock
    {
        return new \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_19\Operation\Issues\Unlock($owner, $repo, $issue_number);
    }
}
