...
final class CheckSuite
{
     ...
     * @\WyriHaximus\Hydrator\Attribute\HydrateArray(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\PullRequestMinimal::class)
     */
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableIntegration $app = null;
    /**
     * Minimal Repository
     ...
     */
    private \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\SimpleCommit $head_commit;
    ...
    /**
     * @return array<\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\PullRequestMinimal>
     */
     ...
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     */
    public function app() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableIntegration
    {
        return $this->app;
    }
    /**
     ...
     * Simple Commit
     */
    public function head_commit() : \ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\SimpleCommit
    {
