...
final class FullRepository
{
    ...
    /**
     * A git repository
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableRepository::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableRepository $template_repository = null;
    ...
    /**
     * License Simple
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableLicenseSimple::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableLicenseSimple $license = null;
    /**
     * Simple User
     ...
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableSimpleUser $organization = null;
    /**
     * A git repository
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository $parent = null;
    /**
     * A git repository
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository $source = null;
    private int $forks;
     ...
     * @\WyriHaximus\Hydrator\Attribute\Hydrate(\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\CodeOfConductSimple::class)
     */
    private ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\CodeOfConductSimple $code_of_conduct = null;
     ...
     * A git repository
     */
    public function template_repository() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableRepository
    {
     ...
     * License Simple
     */
    public function license() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableLicenseSimple
    {
        return $this->license;
    }
    /**
     * Simple User
     */
    public function organization() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\NullableSimpleUser
    {
     ...
     * A git repository
     */
    public function parent() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository
    {
        return $this->parent;
    }
    /**
     * A git repository
     */
    public function source() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\Repository
    {
        return $this->source;
    }
     ...
     * Code of Conduct Simple
     */
    public function code_of_conduct() : ?\ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Schema\CodeOfConductSimple
    {
