...
final class Commits
{
    ...
    {
        return new Request('get', str_replace(['{q}', '{sort}', '{order}', '{per_page}', '{page}'], [$this->q, $this->sort, $this->order, $this->per_page, $this->page], '/search/commits?q={q}&sort={sort}&order={order}&per_page={per_page}&page={page}'));
    }
