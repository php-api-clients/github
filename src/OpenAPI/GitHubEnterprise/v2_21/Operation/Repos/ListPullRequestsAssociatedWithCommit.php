...
final class ListPullRequestsAssociatedWithCommit
{
    ...
    {
        return new Request('get', str_replace(['{owner}', '{repo}', '{commit_sha}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->commit_sha, $this->per_page, $this->page], '/repos/{owner}/{repo}/commits/{commit_sha}/pulls?per_page={per_page}&page={page}'));
    }
