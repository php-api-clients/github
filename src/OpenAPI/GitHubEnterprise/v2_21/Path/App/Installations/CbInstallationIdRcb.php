...
use ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Operation\Apps\DeleteInstallation;
use ApiClients\Client\Github\OpenAPI\GitHubEnterprise\v2_21\Operation\Apps\GetInstallation;
...
final class CbInstallationIdRcb
{
    ...
    function delete(string $accept = 'application/vnd.github.machine-man-preview+json', $installation_id): DeleteInstallation
    {
