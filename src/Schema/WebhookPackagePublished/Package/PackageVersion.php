...
final readonly class PackageVersion
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata $container_metadata;
    ...
    public ?string $name;
    public ?\ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata $npm_metadata;
    public ?array $nuget_metadata;
    public ?array $package_files;
    public string $package_url;
    public bool $prerelease;
    public \ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\Release $release;
    ...
    public function __construct(\ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $author, mixed $body, string $body_html, \ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata $container_metadata, string $created_at, string $description, array $docker_metadata, bool $draft, string $html_url, int $id, string $installation_command, string $manifest, array $metadata, string $name, \ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata $npm_metadata, array $nuget_metadata, array $package_files, string $package_url, bool $prerelease, \ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\Release $release, array $rubygems_metadata, string $source_url, string $summary, string $tag_name, string $target_commitish, string $target_oid, string $updated_at, string $version)
    {
        $this->author = $author;
        $this->body = $body;
