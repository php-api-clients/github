...
final readonly class Release
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $author;
    public ?array $assets;
    ...
    public function __construct(string $url, string $html_url, string $assets_url, string $upload_url, string $tarball_url, string $zipball_url, int $id, string $node_id, string $tag_name, string $target_commitish, string $name, string $body, bool $draft, bool $prerelease, string $created_at, string $published_at, \ApiClients\Client\Github\Schema\SimpleUser $author, array $assets, string $body_html, string $body_text, int $mentions_count, string $discussion_url, \ApiClients\Client\Github\Schema\ReactionRollup $reactions)
    {
        $this->url = $url;
