...
final readonly class GitTag
{
    ...
    public ?\ApiClients\Client\Github\Schema\GitTag\Tagger $tagger;
    public ?\ApiClients\Client\Github\Schema\GitTag\Object_ $object;
    public \ApiClients\Client\Github\Schema\Verification $verification;
    public function __construct(string $node_id, string $tag, string $sha, string $url, string $message, \ApiClients\Client\Github\Schema\GitTag\Tagger $tagger, \ApiClients\Client\Github\Schema\GitTag\Object_ $object, \ApiClients\Client\Github\Schema\Verification $verification)
    {
