...
final readonly class ProjectCard
{
    ...
    public ?string $url;
    public function __construct(int $after_id, bool $archived, int $column_id, string $column_url, string $content_url, string $created_at, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $creator, int $id, string $node_id, string $note, string $project_url, string $updated_at, string $url)
    {
