...
final readonly class ActionsBillingUsage
{
    ...
    public ?\ApiClients\Client\Github\Schema\ActionsBillingUsage\MinutesUsedBreakdown $minutes_used_breakdown;
    public function __construct(int $total_minutes_used, int $total_paid_minutes_used, int $included_minutes, \ApiClients\Client\Github\Schema\ActionsBillingUsage\MinutesUsedBreakdown $minutes_used_breakdown)
    {
