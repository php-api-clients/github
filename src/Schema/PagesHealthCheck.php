...
final readonly class PagesHealthCheck
{
    ...
    public ?\ApiClients\Client\Github\Schema\PagesHealthCheck\Domain $domain;
    public ?\ApiClients\Client\Github\Schema\PagesHealthCheck\AltDomain $alt_domain;
    public function __construct(\ApiClients\Client\Github\Schema\PagesHealthCheck\Domain $domain, \ApiClients\Client\Github\Schema\PagesHealthCheck\AltDomain $alt_domain)
    {
        $this->domain = $domain;
