...
final readonly class Build
{
    ...
    public ?int $duration;
    public ?\ApiClients\Client\Github\Schema\PageBuild\Error $error;
    public ?\ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $pusher;
    public ?string $status;
    public ?string $updated_at;
    public ?string $url;
    public function __construct(string $commit, string $created_at, int $duration, \ApiClients\Client\Github\Schema\PageBuild\Error $error, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $pusher, string $status, string $updated_at, string $url)
    {
        $this->commit = $commit;
