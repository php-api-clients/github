...
final readonly class AutoMerge
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $enabled_by;
    /**
    ...
    public function __construct(\ApiClients\Client\Github\Schema\SimpleUser $enabled_by, string $merge_method, string $commit_title, string $commit_message)
    {
