...
final readonly class ProjectsV2
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $owner;
    /**
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $creator;
    public ?string $title;
