...
final readonly class Comment
{
    ...
    public function __construct(string $author_association, string $body, int $child_comment_count, string $created_at, int $discussion_id, string $html_url, int $id, string $node_id, int $parent_id, \ApiClients\Client\Github\Schema\Discussion\Reactions $reactions, string $repository_url, string $updated_at, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $user)
    {
