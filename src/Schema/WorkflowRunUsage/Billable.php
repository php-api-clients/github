...
final readonly class Billable
{
    ...
    public ?\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $UBUNTU;
    public ?\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $MACOS;
    public ?\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $WINDOWS;
    public function __construct(\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $UBUNTU, \ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $MACOS, \ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable\Ubuntu $WINDOWS)
    {
        $this->UBUNTU = $UBUNTU;
        $this->MACOS = $MACOS;
