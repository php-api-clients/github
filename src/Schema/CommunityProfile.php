...
final readonly class CommunityProfile
{
    ...
    public ?\ApiClients\Client\Github\Schema\CommunityProfile\Files $files;
    public ?string $updated_at;
    public bool $content_reports_enabled;
    public function __construct(int $health_percentage, string $description, string $documentation, \ApiClients\Client\Github\Schema\CommunityProfile\Files $files, string $updated_at, bool $content_reports_enabled)
    {
