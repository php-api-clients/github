...
final readonly class Release
{
    ...
    public function __construct(array $assets, string $assets_url, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $author, string $body, string $created_at, string $discussion_url, bool $draft, string $html_url, int $id, string $name, string $node_id, bool $prerelease, string $published_at, \ApiClients\Client\Github\Schema\Discussion\Reactions $reactions, string $tag_name, string $tarball_url, string $target_commitish, string $upload_url, string $url, string $zipball_url)
    {
        $this->assets = $assets;
