...
final readonly class Owner
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookRepositoryTransferred\Changes\Owner\From $from;
    public function __construct(\ApiClients\Client\Github\Schema\WebhookRepositoryTransferred\Changes\Owner\From $from)
    {
        $this->from = $from;
    }
}
