...
final readonly class OrgHook
{
    ...
    public ?array $events;
    public ?bool $active;
    public ?\ApiClients\Client\Github\Schema\OrgHook\Config $config;
    public ?string $updated_at;
    public ?string $created_at;
    public ?string $type;
    public function __construct(int $id, string $url, string $ping_url, string $deliveries_url, string $name, array $events, bool $active, \ApiClients\Client\Github\Schema\OrgHook\Config $config, string $updated_at, string $created_at, string $type)
    {
        $this->id = $id;
        $this->url = $url;
