...
final readonly class DependabotAlertSecurityAdvisory
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\DependabotAlertSecurityAdvisory\Cvss $cvss;
    /**
    ...
    public function __construct(string $ghsa_id, string $cve_id, string $summary, string $description, array $vulnerabilities, string $severity, \ApiClients\Client\Github\Schema\DependabotAlertSecurityAdvisory\Cvss $cvss, array $cwes, array $identifiers, array $references, string $published_at, string $updated_at, string $withdrawn_at)
    {
