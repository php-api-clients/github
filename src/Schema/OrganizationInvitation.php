...
final readonly class OrganizationInvitation
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $inviter;
    public ?int $team_count;
    public ?string $node_id;
    public ?string $invitation_teams_url;
    public string $invitation_source;
    public function __construct(int $id, string $login, string $email, string $role, string $created_at, string $failed_at, string $failed_reason, \ApiClients\Client\Github\Schema\SimpleUser $inviter, int $team_count, string $node_id, string $invitation_teams_url, string $invitation_source)
    {
        $this->id = $id;
        $this->login = $login;
        $this->email = $email;
