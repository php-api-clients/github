...
final readonly class Applicationjson
{
    ...
    */
    public ?\ApiClients\Client\Github\Schema\Gists\Update\Request\Applicationjson\Files $files;
    public function __construct(string $description, \ApiClients\Client\Github\Schema\Gists\Update\Request\Applicationjson\Files $files)
    {
