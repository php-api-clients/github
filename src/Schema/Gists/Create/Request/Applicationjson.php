...
final readonly class Applicationjson
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\Gists\Create\Request\Applicationjson\Files $files;
    public mixed $public;
    public function __construct(string $description, \ApiClients\Client\Github\Schema\Gists\Create\Request\Applicationjson\Files $files, mixed $public)
    {
