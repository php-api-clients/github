...
final readonly class Links
{
    ...
    public ?\ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\Self_ $self;
    public ?\ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\Html $html;
    public ?\ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\PullRequest $pull_request;
    public function __construct(\ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\Self_ $self, \ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\Html $html, \ApiClients\Client\Github\Schema\PullRequestReviewComment\Links\PullRequest $pull_request)
    {
        $this->self = $self;
        $this->html = $html;
