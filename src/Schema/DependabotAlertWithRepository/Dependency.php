...
final readonly class Dependency
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\DependabotAlertPackage $package;
    /**
     ...
     */
    public ?string $scope;
    public function __construct(\ApiClients\Client\Github\Schema\DependabotAlertPackage $package, string $manifest_path, string $scope)
    {
