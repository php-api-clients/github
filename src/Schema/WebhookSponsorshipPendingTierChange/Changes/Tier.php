...
final readonly class Tier
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $from;
    public function __construct(\ApiClients\Client\Github\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier $from)
    {
        $this->from = $from;
    }
}
