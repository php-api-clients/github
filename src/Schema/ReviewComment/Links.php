...
final readonly class Links
{
     ...
     * Hypermedia Link
     */
    public ?\ApiClients\Client\Github\Schema\Link $pull_request;
    public function __construct(\ApiClients\Client\Github\Schema\Link $self, \ApiClients\Client\Github\Schema\Link $html, \ApiClients\Client\Github\Schema\Link $pull_request)
    {
        $this->self = $self;
        $this->html = $html;
