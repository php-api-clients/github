...
final readonly class BaseGist
{
    ...
    public ?\ApiClients\Client\Github\Schema\BaseGist\Files $files;
    public ?bool $public;
    ...
    public function __construct(string $url, string $forks_url, string $commits_url, string $id, string $node_id, string $git_pull_url, string $git_push_url, string $html_url, \ApiClients\Client\Github\Schema\BaseGist\Files $files, bool $public, string $created_at, string $updated_at, string $description, int $comments, mixed $user, string $comments_url, \ApiClients\Client\Github\Schema\SimpleUser $owner, bool $truncated, array $forks, array $history)
    {
        $this->url = $url;
