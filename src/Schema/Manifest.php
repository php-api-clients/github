...
final readonly class Manifest
{
     ...
     */
    public ?string $name;
    public \ApiClients\Client\Github\Schema\Manifest\File $file;
    /**
     ...
     */
    public \ApiClients\Client\Github\Schema\Manifest\Resolved $resolved;
    public function __construct(string $name, \ApiClients\Client\Github\Schema\Manifest\File $file, \ApiClients\Client\Github\Schema\Metadata $metadata, \ApiClients\Client\Github\Schema\Manifest\Resolved $resolved)
    {
        $this->name = $name;
        $this->file = $file;
