...
final readonly class Hook
{
     ...
     */
    public ?array $events;
    public ?\ApiClients\Client\Github\Schema\Hook\Config $config;
    ...
    public function __construct(string $type, int $id, string $name, bool $active, array $events, \ApiClients\Client\Github\Schema\Hook\Config $config, string $updated_at, string $created_at, string $url, string $test_url, string $ping_url, string $deliveries_url, \ApiClients\Client\Github\Schema\HookResponse $last_response)
    {
        $this->type = $type;
        $this->id = $id;
        $this->name = $name;
