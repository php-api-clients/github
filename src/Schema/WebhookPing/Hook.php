...
final readonly class Hook
{
     ...
     */
    public int $app_id;
    public ?\ApiClients\Client\Github\Schema\WebhookPing\Hook\Config $config;
     ...
     */
    public ?int $id;
    public \ApiClients\Client\Github\Schema\HookResponse $last_response;
    /**
    ...
    public string $url;
    public function __construct(bool $active, int $app_id, \ApiClients\Client\Github\Schema\WebhookPing\Hook\Config $config, string $created_at, string $deliveries_url, array $events, int $id, \ApiClients\Client\Github\Schema\HookResponse $last_response, string $name, string $ping_url, string $test_url, string $type, string $updated_at, string $url)
    {
        $this->active = $active;
        $this->app_id = $app_id;
        $this->config = $config;
