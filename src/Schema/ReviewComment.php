...
final readonly class ReviewComment
{
    ...
    public ?\ApiClients\Client\Github\Schema\ReviewComment\Links $_links;
    ...
    public function __construct(string $url, int $pull_request_review_id, int $id, string $node_id, string $diff_hunk, string $path, int $position, int $original_position, string $commit_id, string $original_commit_id, int $in_reply_to_id, mixed $user, string $body, string $created_at, string $updated_at, string $html_url, string $pull_request_url, string $author_association, \ApiClients\Client\Github\Schema\ReviewComment\Links $_links, string $body_text, string $body_html, \ApiClients\Client\Github\Schema\ReactionRollup $reactions, string $side, string $start_side, int $line, int $original_line, int $start_line, int $original_start_line)
    {
        $this->url = $url;
