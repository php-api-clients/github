...
final readonly class SimpleCommit
{
    ...
    public ?\ApiClients\Client\Github\Schema\SimpleCommit\Author $author;
    public ?\ApiClients\Client\Github\Schema\SimpleCommit\Author $committer;
    public function __construct(string $id, string $tree_id, string $message, string $timestamp, \ApiClients\Client\Github\Schema\SimpleCommit\Author $author, \ApiClients\Client\Github\Schema\SimpleCommit\Author $committer)
    {
        $this->id = $id;
