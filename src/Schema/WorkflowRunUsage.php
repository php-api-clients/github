...
final readonly class WorkflowRunUsage
{
    ...
    public ?\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable $billable;
    public int $run_duration_ms;
    public function __construct(\ApiClients\Client\Github\Schema\WorkflowRunUsage\Billable $billable, int $run_duration_ms)
    {
