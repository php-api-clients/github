...
final readonly class DeploymentStatus
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp $performed_via_github_app;
