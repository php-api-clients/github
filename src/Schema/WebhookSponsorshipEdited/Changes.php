...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookSponsorshipEdited\Changes\PrivacyLevel $privacy_level;
    public function __construct(\ApiClients\Client\Github\Schema\WebhookSponsorshipEdited\Changes\PrivacyLevel $privacy_level)
    {
