...
final readonly class HookDelivery
{
     ...
     */
    public string $url;
    public ?\ApiClients\Client\Github\Schema\HookDelivery\Request $request;
    public ?\ApiClients\Client\Github\Schema\HookDelivery\Response $response;
    public function __construct(int $id, string $guid, string $delivered_at, bool $redelivery, int $duration, string $status, int $status_code, string $event, string $action, int $installation_id, int $repository_id, string $url, \ApiClients\Client\Github\Schema\HookDelivery\Request $request, \ApiClients\Client\Github\Schema\HookDelivery\Response $response)
    {
        $this->id = $id;
        $this->guid = $guid;
