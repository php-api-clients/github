...
final readonly class Commit
{
    ...
    public ?string $url;
    public ?\ApiClients\Client\Github\Schema\WebhookStatus\Commit\Commit\Verification $verification;
    public function __construct(mixed $author, int $comment_count, mixed $committer, string $message, \ApiClients\Client\Github\Schema\ShortBranch\Commit $tree, string $url, \ApiClients\Client\Github\Schema\WebhookStatus\Commit\Commit\Verification $verification)
    {
        $this->author = $author;
