...
final readonly class TimelineReviewedEvent
{
    ...
    public function __construct(string $event, int $id, string $node_id, \ApiClients\Client\Github\Schema\SimpleUser $user, string $body, string $state, string $html_url, string $pull_request_url, \ApiClients\Client\Github\Schema\TimelineReviewedEvent\Links $_links, string $submitted_at, string $commit_id, string $body_html, string $body_text, string $author_association)
    {
        $this->event = $event;
        $this->id = $id;
