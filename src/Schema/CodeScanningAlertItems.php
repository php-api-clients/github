...
final readonly class CodeScanningAlertItems
{
    ...
    public ?\ApiClients\Client\Github\Schema\CodeScanningAlertRuleSummary $rule;
    public ?\ApiClients\Client\Github\Schema\CodeScanningAnalysisTool $tool;
    public ?\ApiClients\Client\Github\Schema\CodeScanningAlertInstance $most_recent_instance;
    public function __construct(int $number, string $created_at, string $updated_at, string $url, string $html_url, string $instances_url, string $state, string $fixed_at, mixed $dismissed_by, string $dismissed_at, string $dismissed_reason, string $dismissed_comment, \ApiClients\Client\Github\Schema\CodeScanningAlertRuleSummary $rule, \ApiClients\Client\Github\Schema\CodeScanningAnalysisTool $tool, \ApiClients\Client\Github\Schema\CodeScanningAlertInstance $most_recent_instance)
    {
        $this->number = $number;
