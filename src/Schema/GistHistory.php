...
final readonly class GistHistory
{
    ...
    public ?string $url;
    public function __construct(mixed $user, string $version, string $committed_at, \ApiClients\Client\Github\Schema\GistHistory\ChangeStatus $change_status, string $url)
    {
        $this->user = $user;
