...
final readonly class MergeGroup
{
    ...
    public function __construct(string $head_sha, string $head_ref, string $base_sha, string $base_ref, \ApiClients\Client\Github\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit $head_commit)
    {
