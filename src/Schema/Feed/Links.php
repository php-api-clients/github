...
final readonly class Links
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\LinkWithType $timeline;
    /**
     * Hypermedia Link with Type
     */
    public ?\ApiClients\Client\Github\Schema\LinkWithType $user;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $security_advisories;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $current_user;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $current_user_public;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $current_user_actor;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $current_user_organization;
    public array $current_user_organizations;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $repository_discussions;
    /**
     * Hypermedia Link with Type
     */
    public \ApiClients\Client\Github\Schema\LinkWithType $repository_discussions_category;
    public function __construct(\ApiClients\Client\Github\Schema\LinkWithType $timeline, \ApiClients\Client\Github\Schema\LinkWithType $user, \ApiClients\Client\Github\Schema\LinkWithType $security_advisories, \ApiClients\Client\Github\Schema\LinkWithType $current_user, \ApiClients\Client\Github\Schema\LinkWithType $current_user_public, \ApiClients\Client\Github\Schema\LinkWithType $current_user_actor, \ApiClients\Client\Github\Schema\LinkWithType $current_user_organization, array $current_user_organizations, \ApiClients\Client\Github\Schema\LinkWithType $repository_discussions, \ApiClients\Client\Github\Schema\LinkWithType $repository_discussions_category)
    {
