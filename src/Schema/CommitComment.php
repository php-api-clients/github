...
final readonly class CommitComment
{
    ...
    public function __construct(string $html_url, string $url, int $id, string $node_id, string $body, string $path, int $position, int $line, string $commit_id, mixed $user, string $created_at, string $updated_at, string $author_association, \ApiClients\Client\Github\Schema\ReactionRollup $reactions)
    {
