...
final readonly class Metadata
{
    ...
    public \ApiClients\Client\Github\Schema\PackageVersion\Metadata\Container $container;
    public \ApiClients\Client\Github\Schema\PackageVersion\Metadata\Docker $docker;
    public function __construct(string $package_type, \ApiClients\Client\Github\Schema\PackageVersion\Metadata\Container $container, \ApiClients\Client\Github\Schema\PackageVersion\Metadata\Docker $docker)
    {
