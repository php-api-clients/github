...
final readonly class FileCommit
{
    ...
    public ?\ApiClients\Client\Github\Schema\FileCommit\Content $content;
    public ?\ApiClients\Client\Github\Schema\FileCommit\Commit $commit;
    public function __construct(\ApiClients\Client\Github\Schema\FileCommit\Content $content, \ApiClients\Client\Github\Schema\FileCommit\Commit $commit)
    {
