...
final readonly class CheckSuite
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\WebhookCheckSuiteRerequested\CheckSuite\App $app;
     ...
     */
    public ?string $url;
    public function __construct(string $after, \ApiClients\Client\Github\Schema\WebhookCheckSuiteRerequested\CheckSuite\App $app, string $before, string $check_runs_url, string $conclusion, string $created_at, string $head_branch, \ApiClients\Client\Github\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit $head_commit, string $head_sha, int $id, int $latest_check_runs_count, string $node_id, array $pull_requests, bool $rerequestable, bool $runs_rerequestable, string $status, string $updated_at, string $url)
    {
        $this->after = $after;
        $this->app = $app;
        $this->before = $before;
