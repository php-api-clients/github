...
final readonly class HeadRepository
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner $owner;
    public ?bool $private;
