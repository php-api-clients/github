...
final readonly class Content
{
    ...
    public ?string $type;
    public ?\ApiClients\Client\Github\Schema\FileCommit\Content\Links $_links;
    public function __construct(string $name, string $path, string $sha, int $size, string $url, string $html_url, string $git_url, string $download_url, string $type, \ApiClients\Client\Github\Schema\FileCommit\Content\Links $_links)
    {
        $this->name = $name;
        $this->path = $path;
        $this->sha = $sha;
