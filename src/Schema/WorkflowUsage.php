...
final readonly class WorkflowUsage
{
    ...
    public ?\ApiClients\Client\Github\Schema\WorkflowUsage\Billable $billable;
    public function __construct(\ApiClients\Client\Github\Schema\WorkflowUsage\Billable $billable)
    {
