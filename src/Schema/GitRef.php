...
final readonly class GitRef
{
    ...
    public ?string $url;
    public ?\ApiClients\Client\Github\Schema\GitRef\Object_ $object;
    public function __construct(string $ref, string $node_id, string $url, \ApiClients\Client\Github\Schema\GitRef\Object_ $object)
    {
        $this->ref = $ref;
