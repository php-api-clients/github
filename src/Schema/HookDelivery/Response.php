...
final readonly class Response
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\HookDelivery\Response\Headers $headers;
    /**
     * The response payload received.
     */
    public ?string $payload;
    public function __construct(\ApiClients\Client\Github\Schema\HookDelivery\Response\Headers $headers, string $payload)
    {
