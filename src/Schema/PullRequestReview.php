...
final readonly class PullRequestReview
{
    ...
    public ?\ApiClients\Client\Github\Schema\TimelineReviewedEvent\Links $_links;
    ...
    public function __construct(int $id, string $node_id, mixed $user, string $body, string $state, string $html_url, string $pull_request_url, \ApiClients\Client\Github\Schema\TimelineReviewedEvent\Links $_links, string $submitted_at, string $commit_id, string $body_html, string $body_text, string $author_association)
    {
        $this->id = $id;
