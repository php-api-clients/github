...
final readonly class MostRecentInstance
{
    ...
    public \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Location $location;
     ...
     */
    public ?string $state;
    public function __construct(string $analysis_key, array $classifications, string $commit_sha, string $environment, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Location $location, \ApiClients\Client\Github\Schema\CodeScanningAlertInstance\Message $message, string $ref, string $state)
    {
