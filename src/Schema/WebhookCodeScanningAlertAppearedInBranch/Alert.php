...
final readonly class Alert
{
     ...
     */
    public ?int $number;
    public ?\ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule $rule;
    /**
     * State of a code scanning alert.
     */
    public ?string $state;
    public ?\ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool $tool;
    public ?string $url;
    public function __construct(string $created_at, string $dismissed_at, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $dismissed_by, string $dismissed_reason, string $html_url, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule $rule, string $state, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool $tool, string $url)
    {
