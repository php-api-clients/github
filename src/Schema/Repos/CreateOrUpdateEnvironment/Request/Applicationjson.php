...
final readonly class Applicationjson
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\DeploymentBranchPolicySettings $deployment_branch_policy;
    public function __construct(int $wait_timer, array $reviewers, \ApiClients\Client\Github\Schema\DeploymentBranchPolicySettings $deployment_branch_policy)
    {
