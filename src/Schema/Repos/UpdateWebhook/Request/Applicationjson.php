...
final readonly class Applicationjson
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\Repos\UpdateWebhook\Request\Applicationjson\Config $config;
    /**
     ...
     */
    public ?bool $active;
    public function __construct(\ApiClients\Client\Github\Schema\Repos\UpdateWebhook\Request\Applicationjson\Config $config, array $events, array $add_events, array $remove_events, bool $active)
    {
        $this->config = $config;
        $this->events = $events;
