...
final readonly class Applicationjson
{
     ...
     */
    public \ApiClients\Client\Github\Schema\Repos\CreateOrUpdateFileContents\Request\Applicationjson\Committer $committer;
    /**
    ...
    public function __construct(string $message, string $content, string $sha, string $branch, \ApiClients\Client\Github\Schema\Repos\CreateOrUpdateFileContents\Request\Applicationjson\Committer $committer, \ApiClients\Client\Github\Schema\Repos\CreateOrUpdateFileContents\Request\Applicationjson\Author $author)
    {
