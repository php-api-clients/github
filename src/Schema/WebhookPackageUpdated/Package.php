...
final readonly class Package
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookPackageUpdated\Package\PackageVersion $package_version;
    public ?\ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\Registry $registry;
    public ?string $updated_at;
    public function __construct(string $created_at, string $description, string $ecosystem, string $html_url, int $id, string $name, string $namespace, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $owner, string $package_type, \ApiClients\Client\Github\Schema\WebhookPackageUpdated\Package\PackageVersion $package_version, \ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\Registry $registry, string $updated_at)
    {
