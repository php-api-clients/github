...
final readonly class Tag
{
    ...
    public ?string $name;
    public ?\ApiClients\Client\Github\Schema\ShortBranch\Commit $commit;
    public ?string $zipball_url;
    public ?string $tarball_url;
    public ?string $node_id;
    public function __construct(string $name, \ApiClients\Client\Github\Schema\ShortBranch\Commit $commit, string $zipball_url, string $tarball_url, string $node_id)
    {
        $this->name = $name;
        $this->commit = $commit;
