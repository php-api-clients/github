...
final readonly class AutoMerge
{
    ...
    public ?\ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $enabled_by;
    /**
     * The merge method to use.
     */
    public ?string $merge_method;
    public function __construct(string $commit_message, string $commit_title, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $enabled_by, string $merge_method)
    {
