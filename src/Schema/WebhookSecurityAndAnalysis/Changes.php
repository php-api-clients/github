...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From $from;
    public function __construct(\ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From $from)
    {
        $this->from = $from;
    }
}
