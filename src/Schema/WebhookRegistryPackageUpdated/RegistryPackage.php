...
final readonly class RegistryPackage
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookRegistryPackagePublished\RegistryPackage\Owner $owner;
    public ?string $package_type;
    public ?\ApiClients\Client\Github\Schema\WebhookRegistryPackageUpdated\RegistryPackage\PackageVersion $package_version;
    public ?\ApiClients\Client\Github\Schema\WebhookCheckSuiteCompleted\ActionsMeta $registry;
    public ?string $updated_at;
    public function __construct(string $created_at, mixed $description, string $ecosystem, string $html_url, int $id, string $name, string $namespace, \ApiClients\Client\Github\Schema\WebhookRegistryPackagePublished\RegistryPackage\Owner $owner, string $package_type, \ApiClients\Client\Github\Schema\WebhookRegistryPackageUpdated\RegistryPackage\PackageVersion $package_version, \ApiClients\Client\Github\Schema\WebhookCheckSuiteCompleted\ActionsMeta $registry, string $updated_at)
    {
