...
final readonly class GistCommit
{
    ...
    public mixed $user;
    public ?\ApiClients\Client\Github\Schema\GistHistory\ChangeStatus $change_status;
    public ?string $committed_at;
    public function __construct(string $url, string $version, mixed $user, \ApiClients\Client\Github\Schema\GistHistory\ChangeStatus $change_status, string $committed_at)
    {
        $this->url = $url;
