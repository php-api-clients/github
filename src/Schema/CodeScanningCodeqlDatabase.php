...
final readonly class CodeScanningCodeqlDatabase
{
     ...
     * A GitHub user.
     */
    public ?\ApiClients\Client\Github\Schema\SimpleUser $uploader;
    /**
     ...
     */
    public ?string $url;
    public function __construct(int $id, string $name, string $language, \ApiClients\Client\Github\Schema\SimpleUser $uploader, string $content_type, int $size, string $created_at, string $updated_at, string $url)
    {
        $this->id = $id;
        $this->name = $name;
