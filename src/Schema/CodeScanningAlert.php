...
final readonly class CodeScanningAlert
{
    ...
    public ?\ApiClients\Client\Github\Schema\CodeScanningAlertRule $rule;
    ...
    public function __construct(int $number, string $created_at, string $updated_at, string $url, string $html_url, string $instances_url, string $state, string $fixed_at, mixed $dismissed_by, string $dismissed_at, string $dismissed_reason, string $dismissed_comment, \ApiClients\Client\Github\Schema\CodeScanningAlertRule $rule, \ApiClients\Client\Github\Schema\CodeScanningAnalysisTool $tool, \ApiClients\Client\Github\Schema\CodeScanningAlertInstance $most_recent_instance)
    {
        $this->number = $number;
