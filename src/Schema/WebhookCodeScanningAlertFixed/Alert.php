...
final readonly class Alert
{
    ...
    public ?\ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $dismissed_by;
    /**
    ...
    public ?string $url;
    public function __construct(string $created_at, string $dismissed_at, \ApiClients\Client\Github\Schema\Discussion\AnswerChosenBy $dismissed_by, string $dismissed_reason, string $html_url, string $instances_url, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertClosedByUser\Alert\Rule $rule, string $state, \ApiClients\Client\Github\Schema\WebhookCodeScanningAlertClosedByUser\Alert\Tool $tool, string $url)
    {
