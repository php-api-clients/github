...
final readonly class TimelineCommittedEvent
{
     ...
     */
    public ?\ApiClients\Client\Github\Schema\GitCommit\Author $author;
    /**
     * Identifying information for the git-user
     */
    public ?\ApiClients\Client\Github\Schema\GitCommit\Author $committer;
    /**
     * Message describing the purpose of the commit
     */
    public ?string $message;
    public ?\ApiClients\Client\Github\Schema\GitCommit\Tree $tree;
    public ?array $parents;
    public ?\ApiClients\Client\Github\Schema\GitCommit\Verification $verification;
    public ?string $html_url;
    public function __construct(string $event, string $sha, string $node_id, string $url, \ApiClients\Client\Github\Schema\GitCommit\Author $author, \ApiClients\Client\Github\Schema\GitCommit\Author $committer, string $message, \ApiClients\Client\Github\Schema\GitCommit\Tree $tree, array $parents, \ApiClients\Client\Github\Schema\GitCommit\Verification $verification, string $html_url)
    {
        $this->event = $event;
        $this->sha = $sha;
