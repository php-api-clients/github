...
final readonly class TeamProject
{
     ...
     */
    public bool $private;
    public ?\ApiClients\Client\Github\Schema\TeamProject\Permissions $permissions;
    public function __construct(string $owner_url, string $url, string $html_url, string $columns_url, int $id, string $node_id, string $name, string $body, int $number, string $state, \ApiClients\Client\Github\Schema\SimpleUser $creator, string $created_at, string $updated_at, string $organization_permission, bool $private, \ApiClients\Client\Github\Schema\TeamProject\Permissions $permissions)
    {
