...
final readonly class Commit
{
    ...
    public ?\ApiClients\Client\Github\Schema\CommitSearchResultItem\Commit\Author $author;
    public mixed $committer;
    public ?int $comment_count;
    public ?string $message;
    public ?\ApiClients\Client\Github\Schema\ShortBranch\Commit $tree;
    public ?string $url;
    public \ApiClients\Client\Github\Schema\Verification $verification;
    public function __construct(\ApiClients\Client\Github\Schema\CommitSearchResultItem\Commit\Author $author, mixed $committer, int $comment_count, string $message, \ApiClients\Client\Github\Schema\ShortBranch\Commit $tree, string $url, \ApiClients\Client\Github\Schema\Verification $verification)
    {
        $this->author = $author;
