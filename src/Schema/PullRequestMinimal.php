...
final readonly class PullRequestMinimal
{
    ...
    public ?int $number;
    public ?string $url;
    public ?\ApiClients\Client\Github\Schema\PullRequestMinimal\Head $head;
    public ?\ApiClients\Client\Github\Schema\PullRequestMinimal\Head $base;
    public function __construct(int $id, int $number, string $url, \ApiClients\Client\Github\Schema\PullRequestMinimal\Head $head, \ApiClients\Client\Github\Schema\PullRequestMinimal\Head $base)
    {
        $this->id = $id;
        $this->number = $number;
        $this->url = $url;
