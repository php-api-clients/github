...
final readonly class Changes
{
    ...
    public ?\ApiClients\Client\Github\Schema\WebhookDiscussionCategoryChanged\Changes\Category $category;
    public function __construct(\ApiClients\Client\Github\Schema\WebhookDiscussionCategoryChanged\Changes\Category $category)
    {
