...
class DependabotAlert implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityAdvisory\\References',
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoReopened(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityAdvisory\\References',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened);
        $result = [];
