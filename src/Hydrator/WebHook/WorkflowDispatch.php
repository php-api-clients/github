...
class WorkflowDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\WebhookWorkflowDispatch' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch($payload),
                ...
                'ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($payload),
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs(array $payload): \ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookWorkflowDispatch\Inputs', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch(mixed $object): mixed
    {
        ...
        $inputs = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($inputs);
