...
class WorkflowRun implements ObjectMapper
{
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit⚡️Committer($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Head(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunCompleted\WorkflowRun\PullRequests\Head
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️Repository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunCompleted\WorkflowRun\Repository
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️Repository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunInProgress\WorkflowRun\HeadCommit
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'author';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit⚡️Author($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'committer';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit⚡️Committer($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'base';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'head';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests\Base
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests\Head
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\HeadCommit
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'author';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit⚡️Author($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'committer';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit⚡️Committer($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\HeadRepository
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\PullRequests
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'base';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'head';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\PullRequests\Base
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\PullRequests\Head
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️Repository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookWorkflowRunRequested\WorkflowRun\Repository
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️Repository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\WebhookWorkflowRunCompleted\\WorkflowRun\\ReferencedWorkflows',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit⚡️Committer($committer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Base(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($repo);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Head(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
        ...
        $owner = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️Repository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\WebhookWorkflowRunInProgress\\WorkflowRun\\ReferencedWorkflows',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $author = $object->author;
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit⚡️Author($author);
        after_author:        $result['author'] = $author;

        
        $committer = $object->committer;
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadCommit⚡️Committer($committer);
        after_committer:        $result['committer'] = $committer;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests(mixed $object): mixed
    {
        ...
        $base = $object->base;
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base($base);
        after_base:        $result['base'] = $base;

        
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head($head);
        after_head:        $result['head'] = $head;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\WebhookWorkflowRunRequested\\WorkflowRun\\ReferencedWorkflows',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $author = $object->author;
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit⚡️Author($author);
        after_author:        $result['author'] = $author;

        
        $committer = $object->committer;
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadCommit⚡️Committer($committer);
        after_committer:        $result['committer'] = $committer;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository(mixed $object): mixed
    {
        ...
        $owner = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests(mixed $object): mixed
    {
        ...
        $base = $object->base;
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base($base);
        after_base:        $result['base'] = $base;

        
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head($head);
        after_head:        $result['head'] = $head;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head(mixed $object): mixed
    {
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
        ...
        $owner = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️Repository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
