...
class Discussion implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes(mixed $object): mixed
    {
        ...
        $new_discussion = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion($new_discussion);
        ...
        $new_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Repository($new_repository);
