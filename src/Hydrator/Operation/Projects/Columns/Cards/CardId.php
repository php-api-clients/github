...
class CardId implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\ProjectCard' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProjectCard($payload),
                ...
                'ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): \ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden);
        $result = [];
