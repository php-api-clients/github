...
class Codespaces implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Codespaces⚡️GetCodespacesForUserInOrg⚡️Response⚡️Applicationjson⚡️H200($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Codespaces⚡️GetCodespacesForUserInOrg⚡️Response⚡️Applicationjson⚡️H200(array $payload): \ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\Codespace',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Codespaces⚡️GetCodespacesForUserInOrg⚡️Response⚡️Applicationjson⚡️H200($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Codespaces⚡️GetCodespacesForUserInOrg⚡️Response⚡️Applicationjson⚡️H200(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\Operation\Codespaces\GetCodespacesForUserInOrg\Response\Applicationjson\H200);
        $result = [];
