...
class Assignees implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\Issue' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Issue($payload),
                ...
                'ApiClients\Client\GitHub\Schema\Issue\Labels' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Issue⚡️Labels($payload),
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\SimpleUser',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Issue⚡️Labels(array $payload): \ApiClients\Client\GitHub\Schema\Issue\Labels
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\Issue\Labels', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\Issue\Labels::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\Issue\Labels(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\Issue\Labels', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHub\Schema\Issue\Labels' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Issue⚡️Labels($object),
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\SimpleUser',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Issue⚡️Labels(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\Issue\Labels);
        $result = [];
