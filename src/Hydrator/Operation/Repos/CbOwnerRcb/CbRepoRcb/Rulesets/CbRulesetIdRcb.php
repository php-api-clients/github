...
namespace ApiClients\Client\GitHub\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Rulesets;
...
class CbRulesetIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\RepositoryRuleset' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleset($payload),
                'ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetBypassActor($payload),
                ...
                'ApiClients\Client\GitHub\Schema\RepositoryRuleCreation' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleCreation($payload),
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\RepositoryRulesetBypassActor',
));
            }
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleCreation',
));
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetBypassActor(array $payload): \ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleCreation(array $payload): \ApiClients\Client\GitHub\Schema\RepositoryRuleCreation
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RepositoryRuleCreation', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\RepositoryRuleCreation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\RepositoryRuleCreation(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RepositoryRuleCreation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetBypassActor($object),
            ...
            'ApiClients\Client\GitHub\Schema\RepositoryRulesetConditions' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetConditions($object),
            'ApiClients\Client\GitHub\Schema\RepositoryRulesetConditions\RefName' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetConditions⚡️RefName($object),
            'ApiClients\Client\GitHub\Schema\RepositoryRuleCreation' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleCreation($object),
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleCreation',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetBypassActor(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RepositoryRulesetBypassActor);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetConditions(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RepositoryRulesetConditions);
        $result = [];
        ...
        $refName = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetConditions⚡️RefName($refName);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRulesetConditions⚡️RefName(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RepositoryRulesetConditions\RefName);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleCreation(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RepositoryRuleCreation);
        $result = [];
