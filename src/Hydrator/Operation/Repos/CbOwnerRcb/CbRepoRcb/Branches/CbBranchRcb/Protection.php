...
class Protection implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHub\\Schema\\StatusCheckPolicy\\Checks',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews(mixed $object): mixed
    {
        ...
        $dismissal_restrictions = $object->dismissal_restrictions;
        $dismissal_restrictions = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews⚡️DismissalRestrictions($dismissal_restrictions);
        after_dismissal_restrictions:        $result['dismissal_restrictions'] = $dismissal_restrictions;

        
        $bypass_pull_request_allowances = $object->bypass_pull_request_allowances;
        $bypass_pull_request_allowances = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews⚡️BypassPullRequestAllowances($bypass_pull_request_allowances);
        after_bypass_pull_request_allowances:        $result['bypass_pull_request_allowances'] = $bypass_pull_request_allowances;
