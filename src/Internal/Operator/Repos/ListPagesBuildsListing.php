...
final readonly class ListPagesBuildsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\ListPagesBuildsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
