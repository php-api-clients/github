...
final readonly class GetOrgRuleSuitesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\GetOrgRuleSuitesListing($this->responseSchemaValidator, $this->hydrator, $org, $repositoryName, $actorName, $timePeriod, $ruleSuiteResult, $perPage, $page);
