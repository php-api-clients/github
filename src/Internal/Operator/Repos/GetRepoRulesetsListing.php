...
final readonly class GetRepoRulesetsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRulesetsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $targets, $perPage, $page, $includesParents);
