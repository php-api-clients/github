...
final readonly class DeleteHostedRunnerForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Actions\DeleteHostedRunnerForOrg($this->responseSchemaValidator, $this->hydrator, $org, $hostedRunnerId);
