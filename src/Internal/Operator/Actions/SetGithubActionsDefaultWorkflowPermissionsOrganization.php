...
final readonly class SetGithubActionsDefaultWorkflowPermissionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Actions\SetGithubActionsDefaultWorkflowPermissionsOrganization($this->requestSchemaValidator, $org);
