...
final readonly class ListSshSigningKeysForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Users\ListSshSigningKeysForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
