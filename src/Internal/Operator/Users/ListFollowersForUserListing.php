...
final readonly class ListFollowersForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Users\ListFollowersForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
