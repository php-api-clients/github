...
final readonly class GetCopilotSeatAssignmentDetailsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Copilot\GetCopilotSeatAssignmentDetailsForUser($this->responseSchemaValidator, $this->hydrator, $org, $username);
