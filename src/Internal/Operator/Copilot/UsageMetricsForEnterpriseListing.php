...
final readonly class UsageMetricsForEnterpriseListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Copilot\UsageMetricsForEnterpriseListing($this->responseSchemaValidator, $this->hydrator, $enterprise, $since, $until, $page, $perPage);
