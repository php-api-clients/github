...
final readonly class UsageMetricsForEnterpriseTeamListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Copilot\UsageMetricsForEnterpriseTeamListing($this->responseSchemaValidator, $this->hydrator, $enterprise, $teamSlug, $since, $until, $page, $perPage);
