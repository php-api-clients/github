...
final readonly class ListOrgRoleUsersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListOrgRoleUsersListing($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
