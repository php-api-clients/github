...
final readonly class ListMembersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListMembersListing($this->responseSchemaValidator, $this->hydrator, $org, $filter, $role, $perPage, $page);
