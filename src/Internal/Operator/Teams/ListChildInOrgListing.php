...
final readonly class ListChildInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Teams\ListChildInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
