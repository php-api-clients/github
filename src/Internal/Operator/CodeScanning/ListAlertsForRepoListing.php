...
final readonly class ListAlertsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\CodeScanning\ListAlertsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $toolName, $toolGuid, $ref, $pr, $state, $severity, $page, $perPage, $direction, $sort);
