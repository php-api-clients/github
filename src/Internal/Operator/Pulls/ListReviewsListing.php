...
final readonly class ListReviewsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Pulls\ListReviewsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
