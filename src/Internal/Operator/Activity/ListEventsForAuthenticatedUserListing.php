...
final readonly class ListEventsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Activity\ListEventsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
