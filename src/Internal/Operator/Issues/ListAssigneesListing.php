...
final readonly class ListAssigneesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Issues\ListAssigneesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
