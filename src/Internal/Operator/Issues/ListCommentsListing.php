...
final readonly class ListCommentsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Issues\ListCommentsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $since, $perPage, $page);
