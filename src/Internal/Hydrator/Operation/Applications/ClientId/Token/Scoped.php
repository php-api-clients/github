...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Applications\ClientId\Token;
...
class Scoped implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Authorization(array $payload): Authorization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Authorization⚡️App(array $payload): App
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ScopedInstallation(array $payload): ScopedInstallation
    {
        $properties    = [];
        $missingFields = [];
        try {
