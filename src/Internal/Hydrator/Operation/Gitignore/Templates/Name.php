...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Gitignore\Templates;
...
class Name implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GitignoreTemplate(array $payload): GitignoreTemplate
    {
        $properties    = [];
        $missingFields = [];
        try {
