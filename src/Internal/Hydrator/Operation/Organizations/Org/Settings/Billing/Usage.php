...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Organizations\Org\Settings\Billing;
...
class Usage implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\BillingUsageReport' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BillingUsageReport($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BillingUsageReport(array $payload): BillingUsageReport
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\BillingUsageReport', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\BillingUsageReport' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BillingUsageReport($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BillingUsageReport(mixed $object): mixed
    {
