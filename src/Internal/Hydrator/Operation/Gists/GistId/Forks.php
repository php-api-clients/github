...
class Forks implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist(array $payload): BaseGist
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist⚡️Files(array $payload): Files
    {
        $properties    = [];
        $missingFields = [];
        try {
