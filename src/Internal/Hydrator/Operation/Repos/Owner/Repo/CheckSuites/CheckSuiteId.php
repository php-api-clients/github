...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\CheckSuites;
...
class CheckSuiteId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CheckSuite(array $payload): CheckSuite
    {
        $properties    = [];
        $missingFields = [];
        try {
