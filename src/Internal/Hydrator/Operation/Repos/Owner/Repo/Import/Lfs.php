...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Import;
...
class Lfs implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Import(array $payload): Import
    {
        $properties    = [];
        $missingFields = [];
        try {
