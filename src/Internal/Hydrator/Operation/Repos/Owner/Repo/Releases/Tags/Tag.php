...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\Tags;
...
class Tag implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Release(array $payload): Release
    {
        $properties    = [];
        $missingFields = [];
        try {
