...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\ReleaseId;
...
class Assets implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ReleaseAsset(array $payload): ReleaseAsset
    {
        $properties    = [];
        $missingFields = [];
        try {
