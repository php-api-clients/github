...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Pages;
...
class Health implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PagesHealthCheck(array $payload): PagesHealthCheck
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PagesHealthCheck⚡️Domain(array $payload): Domain
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PagesHealthCheck⚡️AltDomain(array $payload): AltDomain
    {
        $properties    = [];
        $missingFields = [];
        try {
