...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Codeowners;
...
class Errors implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeownersErrors(array $payload): CodeownersErrors
    {
        $properties    = [];
        $missingFields = [];
        try {
