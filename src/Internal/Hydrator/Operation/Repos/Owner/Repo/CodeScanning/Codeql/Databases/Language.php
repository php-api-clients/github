...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Codeql\Databases;
...
class Language implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningCodeqlDatabase(array $payload): CodeScanningCodeqlDatabase
    {
        $properties    = [];
        $missingFields = [];
        try {
