...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Sarifs;
...
class SarifId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningSarifsStatus(array $payload): CodeScanningSarifsStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
