...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Codeql\VariantAnalyses;
...
class CodeqlVariantAnalysisId implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis($payload),
                ...
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories($payload),
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysisSkippedRepoGroup' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($payload),
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories\NotFoundRepos' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis(array $payload): CodeScanningVariantAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories(array $payload): SkippedRepositories
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup(array $payload): CodeScanningVariantAnalysisSkippedRepoGroup
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysisSkippedRepoGroup', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos(array $payload): NotFoundRepos
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories\NotFoundRepos', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis($object),
                ...
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories($object),
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysisSkippedRepoGroup' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($object),
                'ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories\NotFoundRepos' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis(mixed $object): mixed
    {
        ...
        $controllerRepo                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SimpleRepository($controllerRepo);
        ...
        $skippedRepositories                                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories($skippedRepositories);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories(mixed $object): mixed
    {
        assert($object instanceof SkippedRepositories);
        $result = [];

        $accessMismatchRepos                                               = $object->accessMismatchRepos;
        $accessMismatchRepos                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($accessMismatchRepos);
        after_accessMismatchRepos:        $result['access_mismatch_repos'] = $accessMismatchRepos;

        $notFoundRepos                                         = $object->notFoundRepos;
        $notFoundRepos                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos($notFoundRepos);
        after_notFoundRepos:        $result['not_found_repos'] = $notFoundRepos;

        $noCodeqlDbRepos                                            = $object->noCodeqlDbRepos;
        $noCodeqlDbRepos                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($noCodeqlDbRepos);
        after_noCodeqlDbRepos:        $result['no_codeql_db_repos'] = $noCodeqlDbRepos;

        $overLimitRepos                                          = $object->overLimitRepos;
        $overLimitRepos                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup($overLimitRepos);
        after_overLimitRepos:        $result['over_limit_repos'] = $overLimitRepos;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysisSkippedRepoGroup(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodeScanningVariantAnalysis⚡️SkippedRepositories⚡️NotFoundRepos(mixed $object): mixed
    {
