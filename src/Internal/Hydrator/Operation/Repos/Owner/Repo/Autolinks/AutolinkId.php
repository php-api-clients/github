...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Autolinks;
...
class AutolinkId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Autolink(array $payload): Autolink
    {
        $properties    = [];
        $missingFields = [];
        try {
