...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Blobs;
...
class FileSha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Blob(array $payload): Blob
    {
        $properties    = [];
        $missingFields = [];
        try {
