...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Ref;
...
class Ref implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GitRef(array $payload): GitRef
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GitRef⚡️Object_(array $payload): Object_
    {
        $properties    = [];
        $missingFields = [];
        try {
