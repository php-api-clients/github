...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Trees;
...
class TreeSha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GitTree(array $payload): GitTree
    {
        $properties    = [];
        $missingFields = [];
        try {
