...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId\Statuses;
...
class StatusId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️DeploymentStatus(array $payload): DeploymentStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
