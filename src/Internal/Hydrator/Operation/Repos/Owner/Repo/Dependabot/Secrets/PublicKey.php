...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Dependabot\Secrets;
...
class PublicKey implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️DependabotPublicKey(array $payload): DependabotPublicKey
    {
        $properties    = [];
        $missingFields = [];
        try {
