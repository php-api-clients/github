...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Collaborators;
...
class Username implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryInvitation(array $payload): RepositoryInvitation
    {
        $properties    = [];
        $missingFields = [];
        try {
