...
class RequestedReviewers implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PullRequestReviewRequest(array $payload): PullRequestReviewRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PullRequestSimple(array $payload): PullRequestSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PullRequestSimple⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PullRequestSimple⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PullRequestSimple⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
