...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Keys;
...
class KeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️DeployKey(array $payload): DeployKey
    {
        $properties    = [];
        $missingFields = [];
        try {
