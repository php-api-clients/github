...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Readme;
...
class Dir implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ContentFile(array $payload): ContentFile
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ContentFile⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
