...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\SecretScanning\Alerts;
...
class AlertNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningAlert(array $payload): SecretScanningAlert
    {
        $properties    = [];
        $missingFields = [];
        try {
