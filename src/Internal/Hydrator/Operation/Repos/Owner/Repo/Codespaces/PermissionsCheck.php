...
class PermissionsCheck implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\CodespacesPermissionsCheckForDevcontainer' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespacesPermissionsCheckForDevcontainer($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespacesPermissionsCheckForDevcontainer(array $payload): CodespacesPermissionsCheckForDevcontainer
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodespacesPermissionsCheckForDevcontainer', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\CodespacesPermissionsCheckForDevcontainer' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespacesPermissionsCheckForDevcontainer($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespacesPermissionsCheckForDevcontainer(mixed $object): mixed
    {
