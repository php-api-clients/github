...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Codespaces\Secrets;
...
class SecretName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepoCodespacesSecret(array $payload): RepoCodespacesSecret
    {
        $properties    = [];
        $missingFields = [];
        try {
