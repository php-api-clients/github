...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Comments;
...
class CommentId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CommitComment(array $payload): CommitComment
    {
        $properties    = [];
        $missingFields = [];
        try {
