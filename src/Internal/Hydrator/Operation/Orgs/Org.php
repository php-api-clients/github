...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs;
...
class Org implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrganizationFull(array $payload): OrganizationFull
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrganizationFull⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
