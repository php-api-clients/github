...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Actions\Oidc\Customization;
...
class Sub implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OidcCustomSub(array $payload): OidcCustomSub
    {
        $properties    = [];
        $missingFields = [];
        try {
