...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Actions\Secrets;
...
class SecretName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrganizationActionsSecret(array $payload): OrganizationActionsSecret
    {
        $properties    = [];
        $missingFields = [];
        try {
