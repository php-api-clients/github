...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Actions\Variables;
...
class Name implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrganizationActionsVariable(array $payload): OrganizationActionsVariable
    {
        $properties    = [];
        $missingFields = [];
        try {
