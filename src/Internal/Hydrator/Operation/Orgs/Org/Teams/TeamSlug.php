...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Teams;
...
class TeamSlug implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️TeamFull(array $payload): TeamFull
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️TeamOrganization(array $payload): TeamOrganization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️TeamOrganization⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
