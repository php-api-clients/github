...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions\DiscussionNumber\Comments\CommentNumber;
...
class Reactions implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Reaction(array $payload): Reaction
    {
        $properties    = [];
        $missingFields = [];
        try {
