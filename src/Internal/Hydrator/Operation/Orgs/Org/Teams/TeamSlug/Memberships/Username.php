...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Memberships;
...
class Username implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️TeamMembership(array $payload): TeamMembership
    {
        $properties    = [];
        $missingFields = [];
        try {
