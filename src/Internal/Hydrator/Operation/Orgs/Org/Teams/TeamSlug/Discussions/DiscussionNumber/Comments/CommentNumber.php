...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions\DiscussionNumber\Comments;
...
class CommentNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️TeamDiscussionComment(array $payload): TeamDiscussionComment
    {
        $properties    = [];
        $missingFields = [];
        try {
