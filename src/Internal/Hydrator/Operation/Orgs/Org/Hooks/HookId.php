...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Hooks;
...
class HookId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgHook(array $payload): OrgHook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgHook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
