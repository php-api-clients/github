...
class SecretName implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\OrgPrivateRegistryConfiguration' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgPrivateRegistryConfiguration($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgPrivateRegistryConfiguration(array $payload): OrgPrivateRegistryConfiguration
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\OrgPrivateRegistryConfiguration', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\OrgPrivateRegistryConfiguration' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgPrivateRegistryConfiguration($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgPrivateRegistryConfiguration(mixed $object): mixed
    {
