...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Dependabot\Secrets;
...
class SecretName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrganizationDependabotSecret(array $payload): OrganizationDependabotSecret
    {
        $properties    = [];
        $missingFields = [];
        try {
