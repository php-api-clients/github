...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Projects\ProjectId;
...
class Columns implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProjectColumn(array $payload): ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
