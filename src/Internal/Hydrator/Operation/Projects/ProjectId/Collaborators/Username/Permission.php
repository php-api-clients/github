...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Projects\ProjectId\Collaborators\Username;
...
class Permission implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ProjectCollaboratorPermission(array $payload): ProjectCollaboratorPermission
    {
        $properties    = [];
        $missingFields = [];
        try {
