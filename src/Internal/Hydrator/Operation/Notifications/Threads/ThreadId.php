...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Notifications\Threads;
...
class ThreadId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Thread(array $payload): Thread
    {
        $properties    = [];
        $missingFields = [];
        try {
