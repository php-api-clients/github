...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Notifications\Threads\ThreadId;
...
class Subscription implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️ThreadSubscription(array $payload): ThreadSubscription
    {
        $properties    = [];
        $missingFields = [];
        try {
