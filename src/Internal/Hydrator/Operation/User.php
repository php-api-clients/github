...
class User implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PrivateUser(array $payload): PrivateUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️PrivateUser⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
