...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Users\Username\Settings\Billing;
...
class SharedStorage implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CombinedBillingUsage(array $payload): CombinedBillingUsage
    {
        $properties    = [];
        $missingFields = [];
        try {
