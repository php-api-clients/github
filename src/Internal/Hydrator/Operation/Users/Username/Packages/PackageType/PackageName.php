...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\Users\Username\Packages\PackageType;
...
class PackageName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Package(array $payload): Package
    {
        $properties    = [];
        $missingFields = [];
        try {
