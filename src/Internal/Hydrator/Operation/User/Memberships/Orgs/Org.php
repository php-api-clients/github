...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Memberships\Orgs;
...
class Org implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgMembership(array $payload): OrgMembership
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️OrgMembership⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
