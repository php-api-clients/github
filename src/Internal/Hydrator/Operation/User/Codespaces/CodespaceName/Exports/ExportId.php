...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Codespaces\CodespaceName\Exports;
...
class ExportId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceExportDetails(array $payload): CodespaceExportDetails
    {
        $properties    = [];
        $missingFields = [];
        try {
