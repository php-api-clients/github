...
namespace ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Codespaces\CodespaceName;
...
class Publish implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\CodespaceWithFullRepository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository($payload),
                ...
                'ApiClients\Client\GitHub\Schema\SecurityAndAnalysis\SecretScanningAiDetection' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository(array $payload): CodespaceWithFullRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️FullRepository(array $payload): FullRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️FullRepository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection(array $payload): SecretScanningAiDetection
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\SecurityAndAnalysis\SecretScanningAiDetection', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceMachine(array $payload): CodespaceMachine
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus(array $payload): GitStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodespaceWithFullRepository\GitStatus', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints(array $payload): RuntimeConstraints
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\CodespaceWithFullRepository\RuntimeConstraints', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\SecurityAndAnalysis\SecretScanningAiDetection' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository(mixed $object): mixed
    {
        ...
        $gitStatus                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($gitStatus);
        ...
        $runtimeConstraints                                             = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($runtimeConstraints);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis(mixed $object): mixed
    {
        ...
        $secretScanningAiDetection                                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection($secretScanningAiDetection);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningAiDetection(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints(mixed $object): mixed
    {
