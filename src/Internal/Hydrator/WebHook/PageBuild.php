...
use ApiClients\Client\GitHub\Schema\WebhookPageBuild;
...
class PageBuild implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPageBuild(array $payload): WebhookPageBuild
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): Build
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(array $payload): Error
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
