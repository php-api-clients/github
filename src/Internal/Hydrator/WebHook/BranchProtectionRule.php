...
use ApiClients\Client\GitHub\Schema\WebhookBranchProtectionRuleCreated;
use ApiClients\Client\GitHub\Schema\WebhookBranchProtectionRuleDeleted;
use ApiClients\Client\GitHub\Schema\WebhookBranchProtectionRuleEdited;
...
class BranchProtectionRule implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookBranchProtectionRuleCreated' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleCreated($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksRule' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleCreated(array $payload): WebhookBranchProtectionRuleCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule(array $payload): WebhooksRule
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksRule', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleDeleted(array $payload): WebhookBranchProtectionRuleDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited(array $payload): WebhookBranchProtectionRuleEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced(array $payload): AdminEnforced
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames(array $payload): AuthorizedActorNames
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorsOnly(array $payload): AuthorizedActorsOnly
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedDismissalActorsOnly(array $payload): AuthorizedDismissalActorsOnly
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel(array $payload): LinearHistoryRequirementEnforcementLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️RequiredStatusChecksEnforcementLevel(array $payload): RequiredStatusChecksEnforcementLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksRule' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookBranchProtectionRuleCreated(mixed $object): mixed
    {
        ...
        $rule                              = $object->rule;
        $rule                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule($rule);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksRule(mixed $object): mixed
    {
