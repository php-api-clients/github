...
use ApiClients\Client\GitHub\Schema\WebhookWorkflowJobCompleted;
use ApiClients\Client\GitHub\Schema\WebhookWorkflowJobInProgress;
use ApiClients\Client\GitHub\Schema\WebhookWorkflowJobQueued;
use ApiClients\Client\GitHub\Schema\WebhookWorkflowJobWaiting;
...
class WorkflowJob implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobCompleted(array $payload): WebhookWorkflowJobCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Integration(array $payload): Integration
    {
        ...
        try {
            ...
            if ($ownerCaster1 === null) {
                $ownerCaster1 = new \ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Schema\Integration\Owner(...[]);
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobInProgress(array $payload): WebhookWorkflowJobInProgress
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobQueued(array $payload): WebhookWorkflowJobQueued
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobWaiting(array $payload): WebhookWorkflowJobWaiting
    {
        $properties    = [];
        $missingFields = [];
        try {
