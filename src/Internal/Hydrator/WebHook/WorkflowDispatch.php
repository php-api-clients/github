...
use ApiClients\Client\GitHub\Schema\WebhookWorkflowDispatch;
...
class WorkflowDispatch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowDispatch(array $payload): WebhookWorkflowDispatch
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs(array $payload): Inputs
    {
        $properties    = [];
        $missingFields = [];
        try {
