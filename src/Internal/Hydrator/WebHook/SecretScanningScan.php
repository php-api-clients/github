...
use ApiClients\Client\GitHub\Schema\WebhookSecretScanningScanCompleted;
...
class SecretScanningScan implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookSecretScanningScanCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningScanCompleted($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningScanCompleted(array $payload): WebhookSecretScanningScanCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookSecretScanningScanCompleted', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookSecretScanningScanCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningScanCompleted($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningScanCompleted(mixed $object): mixed
    {
