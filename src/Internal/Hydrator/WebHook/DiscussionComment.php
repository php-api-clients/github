...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionCommentCreated\Comment;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionCommentCreated\Comment\Reactions;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionCommentCreated\Comment\User;
...
class DiscussionComment implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCommentCreated⚡️Comment(array $payload): Comment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCommentCreated⚡️Comment⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCommentCreated⚡️Comment⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
