...
use ApiClients\Client\GitHub\Schema\WebhookDelete;
...
class Delete implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDelete(array $payload): WebhookDelete
    {
        $properties    = [];
        $missingFields = [];
        try {
