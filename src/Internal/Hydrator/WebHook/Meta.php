...
use ApiClients\Client\GitHub\Schema\WebhookMetaDeleted;
...
class Meta implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMetaDeleted(array $payload): WebhookMetaDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
