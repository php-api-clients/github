...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetCreated;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetDeleted;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited;
...
class RepositoryRuleset implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetCreated' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetCreated($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetDeleted($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Rules' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetCreated(array $payload): WebhookRepositoryRulesetCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleset($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetDeleted(array $payload): WebhookRepositoryRulesetDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetDeleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited(array $payload): WebhookRepositoryRulesetEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Name', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(array $payload): Enforcement
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(array $payload): \ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(array $payload): Rules
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Rules', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetCreated($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetDeleted($object),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited($object),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($object),
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetCreated(mixed $object): mixed
    {
        ...
        $repositoryRuleset                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryRuleset($repositoryRuleset);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetDeleted(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited(mixed $object): mixed
    {
        ...
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($changes);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $name                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($name);
        after_name:        $result['name'] = $name;
        ...
        $enforcement                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($enforcement);
        after_enforcement:        $result['enforcement'] = $enforcement;
        ...
        $conditions                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($conditions);
        after_conditions:        $result['conditions'] = $conditions;
        ...
        $rules                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($rules);
        after_rules:        $result['rules'] = $rules;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(mixed $object): mixed
    {
