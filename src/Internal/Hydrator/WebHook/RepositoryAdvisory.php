...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryAdvisoryPublished;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryAdvisoryReported;
...
class RepositoryAdvisory implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryAdvisoryPublished(array $payload): WebhookRepositoryAdvisoryPublished
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryAdvisoryReported(array $payload): WebhookRepositoryAdvisoryReported
    {
        $properties    = [];
        $missingFields = [];
        try {
