...
class SecurityAdvisory implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAdvisoryPublished(array $payload): WebhookSecurityAdvisoryPublished
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAdvisoryUpdated(array $payload): WebhookSecurityAdvisoryUpdated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn(array $payload): WebhookSecurityAdvisoryWithdrawn
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn(mixed $object): mixed
    {
        ...
        $securityAdvisory                                           = $object->securityAdvisory;
        $securityAdvisory                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn⚡️SecurityAdvisory($securityAdvisory);
        after_securityAdvisory:        $result['security_advisory'] = $securityAdvisory;
