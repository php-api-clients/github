...
class RepositoryDispatch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample(array $payload): WebhookRepositoryDispatchSample
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload(array $payload): ClientPayload
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample(mixed $object): mixed
    {
        ...
        $clientPayload                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($clientPayload);
