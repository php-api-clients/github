...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryImport;
...
class RepositoryImport implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryImport(array $payload): WebhookRepositoryImport
    {
        $properties    = [];
        $missingFields = [];
        try {
