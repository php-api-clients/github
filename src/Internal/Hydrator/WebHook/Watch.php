...
use ApiClients\Client\GitHub\Schema\WebhookWatchStarted;
...
class Watch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWatchStarted(array $payload): WebhookWatchStarted
    {
        $properties    = [];
        $missingFields = [];
        try {
