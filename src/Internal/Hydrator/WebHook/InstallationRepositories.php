...
use ApiClients\Client\GitHub\Schema\WebhookInstallationRepositoriesAdded;
use ApiClients\Client\GitHub\Schema\WebhookInstallationRepositoriesAdded\Requester;
use ApiClients\Client\GitHub\Schema\WebhookInstallationRepositoriesRemoved;
...
class InstallationRepositories implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationRepositoriesAdded(array $payload): WebhookInstallationRepositoriesAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationRepositoriesRemoved(array $payload): WebhookInstallationRepositoriesRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
