...
class DeploymentReview implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository⚡️Owner($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository⚡️Owner($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadCommit' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadCommit($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadCommit($payload),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadCommit($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved(array $payload): WebhookDeploymentReviewApproved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Actor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadCommit($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️TriggeringActor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository(array $payload): HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️TriggeringActor(array $payload): TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected(array $payload): WebhookDeploymentReviewRejected
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowRun';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'actor';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Actor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'headCommit';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadCommit($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'headRepository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'triggeringActor';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️TriggeringActor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Actor(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Actor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Actor(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Actor', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️TriggeringActor(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\TriggeringActor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\TriggeringActor(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\TriggeringActor', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested(array $payload): WebhookDeploymentReviewRequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJobRun';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowJobRun($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowRun';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'actor';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Actor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'headCommit';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadCommit($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'headRepository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'triggeringActor';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Actor(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository⚡️Owner(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadCommit(array $payload): HeadCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadCommit', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadCommit(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadCommit', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadCommit(array $payload): \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository⚡️Owner($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository⚡️Owner($object),
                'ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved(mixed $object): mixed
    {
        ...
        $workflowRun                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun($workflowRun);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Actor($actor);
        ...
        $headCommit                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadCommit($headCommit);
        ...
        $headRepository                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository($headRepository);
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggeringActor                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️TriggeringActor($triggeringActor);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Actor(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository(mixed $object): mixed
    {
        ...
        $owner                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️HeadRepository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️Repository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\Repository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewApproved⚡️WorkflowRun⚡️TriggeringActor(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun);
        $result = [];
        ...
        $actor                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Actor($actor);
        after_actor:        $result['actor'] = $actor;
        ...
        $headCommit                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadCommit($headCommit);
        after_headCommit:        $result['head_commit'] = $headCommit;
        ...
        $headRepository                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository($headRepository);
        after_headRepository:        $result['head_repository'] = $headRepository;
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggeringActor                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️TriggeringActor($triggeringActor);
        after_triggeringActor:        $result['triggering_actor'] = $triggeringActor;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Actor(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Actor);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️HeadRepository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\HeadRepository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️Repository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\Repository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRejected⚡️WorkflowRun⚡️TriggeringActor(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRejected\WorkflowRun\TriggeringActor);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested(mixed $object): mixed
    {
        ...
        $workflowJobRun                                          = $object->workflowJobRun;
        $workflowJobRun                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowJobRun($workflowJobRun);
        after_workflowJobRun:        $result['workflow_job_run'] = $workflowJobRun;
        ...
        $workflowRun                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun($workflowRun);
        after_workflowRun:        $result['workflow_run'] = $workflowRun;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun);
        $result = [];
        ...
        $actor                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Actor($actor);
        after_actor:        $result['actor'] = $actor;
        ...
        $headCommit                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadCommit($headCommit);
        after_headCommit:        $result['head_commit'] = $headCommit;
        ...
        $headRepository                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository($headRepository);
        after_headRepository:        $result['head_repository'] = $headRepository;
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggeringActor                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor($triggeringActor);
        after_triggeringActor:        $result['triggering_actor'] = $triggeringActor;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Actor(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️HeadRepository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️Repository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentReviewRequested⚡️WorkflowRun⚡️TriggeringActor(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor);
        $result = [];
