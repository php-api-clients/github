...
use ApiClients\Client\GitHub\Schema\WebhookOrganizationDeleted;
use ApiClients\Client\GitHub\Schema\WebhookOrganizationMemberAdded;
use ApiClients\Client\GitHub\Schema\WebhookOrganizationMemberInvited;
...
use ApiClients\Client\GitHub\Schema\WebhookOrganizationMemberRemoved;
use ApiClients\Client\GitHub\Schema\WebhookOrganizationRenamed;
...
class Organization implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookOrganizationDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationDeleted($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksMembership' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksMembership\User' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationDeleted(array $payload): WebhookOrganizationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership(array $payload): WebhooksMembership
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksMembership', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksMembership\User', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberAdded(array $payload): WebhookOrganizationMemberAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberInvited(array $payload): WebhookOrganizationMemberInvited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberInvited⚡️Invitation(array $payload): Invitation
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberInvited⚡️Invitation⚡️Inviter(array $payload): Inviter
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberRemoved(array $payload): WebhookOrganizationMemberRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationRenamed(array $payload): WebhookOrganizationRenamed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationRenamed⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationRenamed⚡️Changes⚡️Login(array $payload): Login
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksMembership' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership($object),
                'ApiClients\Client\GitHub\Schema\WebhooksMembership\User' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationDeleted(mixed $object): mixed
    {
        ...
        $membership                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership($membership);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership(mixed $object): mixed
    {
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User($user);
        after_user:        $result['user'] = $user;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksMembership⚡️User(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationMemberInvited(mixed $object): mixed
    {
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksUser($user);
        after_user:        $result['user'] = $user;
