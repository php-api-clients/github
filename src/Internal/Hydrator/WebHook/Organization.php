...
use ApiClients\Client\GitHub\Schema\WebhookOrganizationDeleted\Membership;
use ApiClients\Client\GitHub\Schema\WebhookOrganizationDeleted\Membership\User;
...
class Organization implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationDeleted⚡️Membership(array $payload): Membership
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookOrganizationDeleted⚡️Membership⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
