...
use ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Member;
use ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Sender;
use ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Team;
use ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Team\Parent_;
...
class Membership implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMembershipAdded⚡️Member(array $payload): Member
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMembershipAdded⚡️Team(array $payload): Team
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMembershipAdded⚡️Team⚡️Parent_(array $payload): Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
