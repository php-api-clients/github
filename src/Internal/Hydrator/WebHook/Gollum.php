...
use ApiClients\Client\GitHub\Schema\WebhookGollum;
...
class Gollum implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookGollum(array $payload): WebhookGollum
    {
        $properties    = [];
        $missingFields = [];
        try {
