...
use ApiClients\Client\GitHub\Schema\WebhookSecurityAndAnalysis;
...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAndAnalysis(array $payload): WebhookSecurityAndAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
