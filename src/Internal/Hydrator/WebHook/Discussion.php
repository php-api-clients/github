...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionAnswered;
...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionClosed;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionCreated;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionDeleted;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionEdited;
...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionLabeled;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionLocked;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionPinned;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionReopened;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionUnanswered;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionUnlabeled;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionUnlocked;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionUnpinned;
...
class Discussion implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookDiscussionAnswered' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer\Reactions' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer\User' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionClosed' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionClosed($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionReopened' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionReopened($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered(array $payload): WebhookDiscussionAnswered
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer($value);
                } finally {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer(array $payload): WebhooksAnswer
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksAnswer', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksAnswer\Reactions', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksAnswer\User', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️AnswerChosenBy(array $payload): AnswerChosenBy
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️Category(array $payload): Category
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCategoryChanged(array $payload): WebhookDiscussionCategoryChanged
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCategoryChanged⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCategoryChanged⚡️Changes⚡️Category⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionClosed(array $payload): WebhookDiscussionClosed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDiscussionClosed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCreated(array $payload): WebhookDiscussionCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionDeleted(array $payload): WebhookDiscussionDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionEdited(array $payload): WebhookDiscussionEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionEdited⚡️Changes⚡️Body(array $payload): Body
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionEdited⚡️Changes⚡️Title(array $payload): Title
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionLabeled(array $payload): WebhookDiscussionLabeled
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionLocked(array $payload): WebhookDiscussionLocked
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionPinned(array $payload): WebhookDiscussionPinned
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionReopened(array $payload): WebhookDiscussionReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDiscussionReopened', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred(array $payload): WebhookDiscussionTransferred
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnanswered(array $payload): WebhookDiscussionUnanswered
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnlabeled(array $payload): WebhookDiscussionUnlabeled
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnlocked(array $payload): WebhookDiscussionUnlocked
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnpinned(array $payload): WebhookDiscussionUnpinned
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer($object),
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer\Reactions' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions($object),
                'ApiClients\Client\GitHub\Schema\WebhooksAnswer\User' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionClosed' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionClosed($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionReopened' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionReopened($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered(mixed $object): mixed
    {
        ...
        $answer                                = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer($answer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer(mixed $object): mixed
    {
        ...
        $reactions                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions($reactions);
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User($user);
        after_user:        $result['user'] = $user;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️Reactions(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer⚡️User(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionClosed(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionReopened(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes(mixed $object): mixed
    {
        ...
        $newRepository                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepositoryWebhooks($newRepository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnanswered(mixed $object): mixed
    {
        ...
        $oldAnswer                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksAnswer($oldAnswer);
