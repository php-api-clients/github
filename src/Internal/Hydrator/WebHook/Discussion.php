...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionAnswered\Answer;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionAnswered\Answer\Reactions;
use ApiClients\Client\GitHub\Schema\WebhookDiscussionAnswered\Answer\User;
...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionLabeled\Label;
...
use ApiClients\Client\GitHub\Schema\WebhookDiscussionUnanswered\OldAnswer;
...
class Discussion implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered⚡️Answer(array $payload): Answer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered⚡️Answer⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionAnswered⚡️Answer⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionLabeled⚡️Label(array $payload): Label
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionUnanswered⚡️OldAnswer(array $payload): OldAnswer
    {
        $properties    = [];
        $missingFields = [];
        try {
