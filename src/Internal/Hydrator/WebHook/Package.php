...
use ApiClients\Client\GitHub\Schema\WebhookPackagePublished;
...
use ApiClients\Client\GitHub\Schema\WebhookPackageUpdated;
...
class Package implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookPackagePublished' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Labels' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Manifest' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Author($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Bugs' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bugs($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\DevDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\PeerDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\OptionalDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Dist' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Dist($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Repository' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Repository($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Scripts' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Engines' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Engines($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Bin' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bin($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Man' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Man($payload),
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Directories' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Directories($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished(array $payload): WebhookPackagePublished
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion(array $payload): PackageVersion
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata(array $payload): ContainerMetadata
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Tag(array $payload): Tag
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata(array $payload): NpmMetadata
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'author';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Author($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bugs($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Dist($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Repository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Engines($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bin($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Man($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Directories($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️Release(array $payload): Release
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️Registry(array $payload): Registry
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackageUpdated(array $payload): WebhookPackageUpdated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Labels(array $payload): Labels
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Labels', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest(array $payload): Manifest
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Manifest', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Author(array $payload): \ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Author', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bugs(array $payload): Bugs
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Bugs', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Dependencies(array $payload): Dependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies(array $payload): DevDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\DevDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies(array $payload): PeerDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\PeerDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies(array $payload): OptionalDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\OptionalDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Dist(array $payload): Dist
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Dist', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Repository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Scripts(array $payload): Scripts
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Scripts', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Engines(array $payload): Engines
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Engines', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bin(array $payload): Bin
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Bin', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Man(array $payload): Man
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Man', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Directories(array $payload): Directories
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Directories', $exception, stack: $this->hydrationStack);
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata(mixed $object): mixed
    {
        ...
        $labels                                = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($labels);
        ...
        $manifest                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($manifest);
        after_manifest:        $result['manifest'] = $manifest;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata(mixed $object): mixed
    {
        ...
        $author                                = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Author($author);
        after_author:        $result['author'] = $author;
        ...
        $bugs                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bugs($bugs);
        ...
        $devDependencies                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($devDependencies);
        ...
        $peerDependencies                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($peerDependencies);
        ...
        $optionalDependencies                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($optionalDependencies);
        ...
        $dist                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Dist($dist);
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Repository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $scripts                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($scripts);
        ...
        $engines                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Engines($engines);
        ...
        $bin                             = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Bin($bin);
        ...
        $man                             = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Man($man);
        ...
        $directories                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata⚡️Directories($directories);
