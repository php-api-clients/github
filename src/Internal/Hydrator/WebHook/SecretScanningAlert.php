...
use ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertPubliclyLeaked;
...
class SecretScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertCreated' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertCreated($payload),
                'ApiClients\Client\GitHub\Schema\SecretScanningAlertWebhook' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningAlertWebhook($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertPubliclyLeaked' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertCreated(array $payload): WebhookSecretScanningAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningAlertWebhook(array $payload): SecretScanningAlertWebhook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked(array $payload): WebhookSecretScanningAlertPubliclyLeaked
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertPubliclyLeaked', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertReopened(array $payload): WebhookSecretScanningAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertResolved(array $payload): WebhookSecretScanningAlertResolved
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertValidated(array $payload): WebhookSecretScanningAlertValidated
    {
        ...
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertValidated', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\SecretScanningAlertWebhook' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningAlertWebhook($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertPubliclyLeaked' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningAlertWebhook(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked(mixed $object): mixed
    {
