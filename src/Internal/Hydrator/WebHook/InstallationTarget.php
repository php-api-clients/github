...
use ApiClients\Client\GitHub\Schema\WebhookInstallationTargetRenamed;
...
class InstallationTarget implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationTargetRenamed(array $payload): WebhookInstallationTargetRenamed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Account(array $payload): Account
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes⚡️Login(array $payload): Login
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes⚡️Slug(array $payload): Slug
    {
        $properties    = [];
        $missingFields = [];
        try {
