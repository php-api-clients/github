...
class Installation implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationCreated(array $payload): WebhookInstallationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationDeleted(array $payload): WebhookInstallationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(array $payload): WebhookInstallationNewPermissionsAccepted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationSuspend(array $payload): WebhookInstallationSuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookInstallationUnsuspend(array $payload): WebhookInstallationUnsuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
