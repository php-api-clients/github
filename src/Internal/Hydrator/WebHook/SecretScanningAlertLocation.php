...
use ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertLocationCreated;
use ApiClients\Client\GitHub\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded;
...
class SecretScanningAlertLocation implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated(array $payload): WebhookSecretScanningAlertLocationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SecretScanningLocation(array $payload): SecretScanningLocation
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded(array $payload): WebhookSecretScanningAlertLocationCreatedFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
