...
use ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished;
...
use ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated;
...
class RegistryPackage implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\ContainerMetadata\Labels' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\ContainerMetadata\Manifest' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Dependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Dependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\DevDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\PeerDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\OptionalDependencies' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Scripts' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Engines' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Engines($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Bin' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Bin($payload),
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Man' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Man($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️Registry($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished(array $payload): WebhookRegistryPackagePublished
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion(array $payload): PackageVersion
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata(array $payload): ContainerMetadata
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Tag(array $payload): Tag
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata(array $payload): NpmMetadata
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if ($authorCaster1 === null) {
                $authorCaster1 = new \ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Author(...[]);
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Dependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Engines($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Bin($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Man($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️Release(array $payload): Release
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️Registry(array $payload): Registry
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated(array $payload): WebhookRegistryPackageUpdated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage(array $payload): \ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'registry';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️Registry($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Labels(array $payload): Labels
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\ContainerMetadata\Labels', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest(array $payload): Manifest
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\ContainerMetadata\Manifest', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Dependencies(array $payload): Dependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Dependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies(array $payload): DevDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\DevDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies(array $payload): PeerDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\PeerDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies(array $payload): OptionalDependencies
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\OptionalDependencies', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Scripts(array $payload): Scripts
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Scripts', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Engines(array $payload): Engines
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Engines', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Bin(array $payload): Bin
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Bin', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Man(array $payload): Man
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata\Man', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️Registry(array $payload): \ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage\Registry', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata(mixed $object): mixed
    {
        ...
        $labels                                = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Labels($labels);
        ...
        $manifest                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata⚡️Manifest($manifest);
        after_manifest:        $result['manifest'] = $manifest;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata(mixed $object): mixed
    {
        ...
        $dependencies                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Dependencies($dependencies);
        ...
        $devDependencies                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️DevDependencies($devDependencies);
        ...
        $peerDependencies                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️PeerDependencies($peerDependencies);
        ...
        $optionalDependencies                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️OptionalDependencies($optionalDependencies);
        ...
        $scripts                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Scripts($scripts);
        ...
        $engines                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Engines($engines);
        ...
        $bin                             = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Bin($bin);
        ...
        $man                             = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata⚡️Man($man);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $registry                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️Registry($registry);
        after_registry:        $result['registry'] = $registry;
