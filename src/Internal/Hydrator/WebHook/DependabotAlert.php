...
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened;
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertCreated;
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertDismissed;
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertFixed;
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertReintroduced;
use ApiClients\Client\GitHub\Schema\WebhookDependabotAlertReopened;
...
class DependabotAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoDismissed($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoReopened($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(array $payload): WebhookDependabotAlertAutoDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoReopened(array $payload): WebhookDependabotAlertAutoReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertCreated(array $payload): WebhookDependabotAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertDismissed(array $payload): WebhookDependabotAlertDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertFixed(array $payload): WebhookDependabotAlertFixed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertReintroduced(array $payload): WebhookDependabotAlertReintroduced
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertReopened(array $payload): WebhookDependabotAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoDismissed' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoDismissed($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDependabotAlertAutoReopened' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoReopened($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDependabotAlertAutoReopened(mixed $object): mixed
    {
