...
use ApiClients\Client\GitHub\Schema\WebhookMergeGroupChecksRequested;
use ApiClients\Client\GitHub\Schema\WebhookMergeGroupDestroyed;
...
class MergeGroup implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookMergeGroupChecksRequested' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupChecksRequested($payload),
                ...
                'ApiClients\Client\GitHub\Schema\MergeGroup' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookMergeGroupDestroyed' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupDestroyed($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupChecksRequested(array $payload): WebhookMergeGroupChecksRequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup(array $payload): \ApiClients\Client\GitHub\Schema\MergeGroup
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\MergeGroup', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\MergeGroup::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\MergeGroup(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\MergeGroup', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SimpleCommit(array $payload): SimpleCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SimpleCommit⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️SimpleCommit⚡️Committer(array $payload): Committer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupDestroyed(array $payload): WebhookMergeGroupDestroyed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookMergeGroupDestroyed', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\MergeGroup' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookMergeGroupDestroyed' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupDestroyed($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupChecksRequested(mixed $object): mixed
    {
        ...
        $mergeGroup                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup($mergeGroup);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️MergeGroup(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\MergeGroup);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookMergeGroupDestroyed(mixed $object): mixed
    {
