...
use ApiClients\Client\GitHub\Schema\WebhookStarCreated;
use ApiClients\Client\GitHub\Schema\WebhookStarDeleted;
...
class Star implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookStarCreated(array $payload): WebhookStarCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookStarDeleted(array $payload): WebhookStarDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
