...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryArchived;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryCreated;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryDeleted;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryEdited;
...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryPrivatized;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryPublicized;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryRenamed;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryRenamed\Changes\Repository\Name;
use ApiClients\Client\GitHub\Schema\WebhookRepositoryTransferred;
...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryUnarchived;
...
class Repository implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryArchived(array $payload): WebhookRepositoryArchived
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryCreated(array $payload): WebhookRepositoryCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDeleted(array $payload): WebhookRepositoryDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited(array $payload): WebhookRepositoryEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes⚡️DefaultBranch(array $payload): DefaultBranch
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes⚡️Description(array $payload): Description
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes⚡️Homepage(array $payload): Homepage
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes⚡️Topics(array $payload): Topics
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryPrivatized(array $payload): WebhookRepositoryPrivatized
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryPublicized(array $payload): WebhookRepositoryPublicized
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRenamed(array $payload): WebhookRepositoryRenamed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryRenamed⚡️Changes⚡️Repository⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryTransferred(array $payload): WebhookRepositoryTransferred
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryTransferred⚡️Changes⚡️Owner⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryTransferred⚡️Changes⚡️Owner⚡️From⚡️Organization(array $payload): Organization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryTransferred⚡️Changes⚡️Owner⚡️From⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryUnarchived(array $payload): WebhookRepositoryUnarchived
    {
        $properties    = [];
        $missingFields = [];
        try {
