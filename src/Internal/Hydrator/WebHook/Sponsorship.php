...
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipCreated;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipEdited;
...
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipPendingCancellation;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipPendingTierChange;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipTierChanged;
...
class Sponsorship implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookSponsorshipCancelled' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Sponsorable' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Tier' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier($payload),
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier\From' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled(array $payload): WebhookSponsorshipCancelled
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksSponsorship', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer(array $payload): Maintainer
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Maintainer', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor(array $payload): Sponsor
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Sponsor', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable(array $payload): Sponsorable
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Sponsorable', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier(array $payload): Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Tier', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCreated(array $payload): WebhookSponsorshipCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipEdited(array $payload): WebhookSponsorshipEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes⚡️PrivacyLevel(array $payload): PrivacyLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipPendingCancellation(array $payload): WebhookSponsorshipPendingCancellation
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipPendingTierChange(array $payload): WebhookSponsorshipPendingTierChange
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'changes';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8(array $payload): WebhooksChanges8
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'tier';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksChanges8', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier(array $payload): \ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier\From', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipTierChanged(array $payload): WebhookSponsorshipTierChanged
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Sponsorable' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($object),
                'ApiClients\Client\GitHub\Schema\WebhooksSponsorship\Tier' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8($object),
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier($object),
                'ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier\From' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled(mixed $object): mixed
    {
        ...
        $sponsorship                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship($sponsorship);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship(mixed $object): mixed
    {
        ...
        $maintainer                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($maintainer);
        ...
        $sponsor                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($sponsor);
        ...
        $sponsorable                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($sponsorable);
        after_sponsorable:        $result['sponsorable'] = $sponsorable;

        $tier                              = $object->tier;
        $tier                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier($tier);
        after_tier:        $result['tier'] = $tier;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksSponsorship⚡️Tier(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipPendingTierChange(mixed $object): mixed
    {
        ...
        $changes                                 = $object->changes;
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8($changes);
        after_changes:        $result['changes'] = $changes;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8(mixed $object): mixed
    {
        assert($object instanceof WebhooksChanges8);
        $result = [];

        $tier                              = $object->tier;
        $tier                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier($tier);
        after_tier:        $result['tier'] = $tier;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhooksChanges8\Tier);
        $result = [];

        $from                              = $object->from;
        $from                              = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($from);
        after_from:        $result['from'] = $from;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From(mixed $object): mixed
    {
