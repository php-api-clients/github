...
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipCancelled\Sponsorship\Maintainer;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsor;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsorable;
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier;
...
use ApiClients\Client\GitHub\Schema\WebhookSponsorshipPendingTierChange\Changes\Tier\From;
...
class Sponsorship implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Maintainer(array $payload): Maintainer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Sponsor(array $payload): Sponsor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Sponsorable(array $payload): Sponsorable
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier(array $payload): Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipPendingTierChange⚡️Changes⚡️Tier⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
