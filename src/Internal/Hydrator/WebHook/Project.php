...
use ApiClients\Client\GitHub\Schema\WebhookProjectClosed\Project\Creator;
...
class Project implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectClosed⚡️Project⚡️Creator(array $payload): Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
