...
use ApiClients\Client\GitHub\Schema\WebhookProjectColumnCreated;
use ApiClients\Client\GitHub\Schema\WebhookProjectColumnDeleted;
use ApiClients\Client\GitHub\Schema\WebhookProjectColumnEdited;
...
use ApiClients\Client\GitHub\Schema\WebhookProjectColumnMoved;
...
class ProjectColumn implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookProjectColumnCreated' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnCreated($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksProjectColumn' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnCreated(array $payload): WebhookProjectColumnCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn(array $payload): WebhooksProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhooksProjectColumn', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnDeleted(array $payload): WebhookProjectColumnDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnEdited(array $payload): WebhookProjectColumnEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnMoved(array $payload): WebhookProjectColumnMoved
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhooksProjectColumn' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectColumnCreated(mixed $object): mixed
    {
        ...
        $projectColumn                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn($projectColumn);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhooksProjectColumn(mixed $object): mixed
    {
