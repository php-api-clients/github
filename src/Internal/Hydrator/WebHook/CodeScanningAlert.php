...
use ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch;
...
use ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopenedByUser;
...
class CodeScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch(array $payload): WebhookCodeScanningAlertAppearedInBranch
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert(array $payload): Alert
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️DismissedBy(array $payload): DismissedBy
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance(array $payload): MostRecentInstance
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance⚡️Location(array $payload): Location
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance⚡️Message(array $payload): Message
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️Rule(array $payload): Rule
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️Tool(array $payload): Tool
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser(array $payload): WebhookCodeScanningAlertClosedByUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertFixed(array $payload): WebhookCodeScanningAlertFixed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopened(array $payload): WebhookCodeScanningAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert(array $payload): \ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'dismissedBy';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopenedByUser(array $payload): WebhookCodeScanningAlertReopenedByUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy(array $payload): \ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy', $exception, stack: $this->hydrationStack);
        }
    }
