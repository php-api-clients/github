...
class CommitComment implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCommitCommentCreated(array $payload): WebhookCommitCommentCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment(array $payload): Comment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
