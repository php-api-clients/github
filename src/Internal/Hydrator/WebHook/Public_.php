...
use ApiClients\Client\GitHub\Schema\WebhookPublic;
...
class Public_ implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPublic(array $payload): WebhookPublic
    {
        $properties    = [];
        $missingFields = [];
        try {
