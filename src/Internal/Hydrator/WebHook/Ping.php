...
use ApiClients\Client\GitHub\Schema\WebhookPingFormEncoded;
...
class Ping implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPing(array $payload): WebhookPing
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPing⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPingFormEncoded(array $payload): WebhookPingFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
