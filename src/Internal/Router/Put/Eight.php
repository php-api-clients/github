...
final class Eight
{
    ...
    /** @return array{code:int}|Schema\EmptyObject|Schema\Operations\Actions\ListLabelsForSelfHostedRunnerForOrg\Response\ApplicationJson\Ok|Schema\DeploymentBranchPolicy|Schema\PullRequestReview */
