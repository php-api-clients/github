...
class RepositorySimple extends BaseRepositorySimple
{
    ...
    {
        return $this->wait($this->handleCommand(new BuildAsyncFromSyncCommand(self::HYDRATE_CLASS, $this))->then(static function (RepositorySimpleInterface $repositorySimple) {
