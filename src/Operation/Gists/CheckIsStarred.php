...
final class CheckIsStarred
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Gists\CbGistIdRcb\Star $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Gists\CbGistIdRcb\Star $hydrator, string $gist_id)
    {
