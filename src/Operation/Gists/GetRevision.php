...
final class GetRevision
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Gists\CbGistIdRcb\CbShaRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Gists\CbGistIdRcb\CbShaRcb $hydrator, string $gist_id, string $sha)
    {
