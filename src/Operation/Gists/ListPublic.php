...
final class ListPublic
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Gists\Public_ $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Gists\Public_ $hydrator, string $since, int $per_page = 30, int $page = 1)
    {
        $this->since = $since;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\BaseGist>|\ApiClients\Client\Github\Schema\ValidationError|\ApiClients\Client\Github\Schema\BasicError
     */
