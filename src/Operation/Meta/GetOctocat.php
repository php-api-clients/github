...
final class GetOctocat
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Octocat $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Octocat $hydrator, string $s)
    {
        $this->s = $s;
