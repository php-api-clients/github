...
final class GetArchiveForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Archive $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Archive $hydrator, int $migration_id)
    {
