...
final class DeleteReviewComment
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Pulls\Comments\CbCommentIdRcb $hydrator, string $owner, string $repo, int $comment_id)
    {
        $this->owner = $owner;
        $this->repo = $repo;
