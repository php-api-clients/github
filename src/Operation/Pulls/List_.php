...
final class List_
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Pulls $hydrator, string $owner, string $repo, string $head, string $base, string $direction, string $state = 'open', string $sort = 'created', int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
        $this->head = $head;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\PullRequestSimple>|\ApiClients\Client\Github\Schema\ValidationError
     */
