...
final class GetAllCodesOfConduct
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\CodesOfConduct $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\CodesOfConduct $hydrator)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\CodeOfConduct>
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : \ApiClients\Client\Github\Schema\CodeOfConduct {
