...
final class ListMembershipsForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Memberships\Orgs $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Memberships\Orgs $hydrator, string $state, int $per_page = 30, int $page = 1)
    {
        $this->state = $state;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\OrgMembership>|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\ValidationError
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : \ApiClients\Client\Github\Schema\OrgMembership {
