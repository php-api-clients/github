...
final class SetPublicMembershipForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\PublicMembers\CbUsernameRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\PublicMembers\CbUsernameRcb $hydrator, string $org, string $username)
    {
        $this->org = $org;
