...
final class GetMembershipForAuthenticatedUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Memberships\Orgs\CbOrgRcb $hydrator, string $org)
    {
        $this->org = $org;
