...
final class PingWebhook
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Hooks\CbHookIdRcb\Pings $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Hooks\CbHookIdRcb\Pings $hydrator, string $org, int $hook_id)
    {
        $this->org = $org;
