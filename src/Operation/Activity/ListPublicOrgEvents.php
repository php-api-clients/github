...
final class ListPublicOrgEvents
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Events $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Events $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
