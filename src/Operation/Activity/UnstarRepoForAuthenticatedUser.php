...
final class UnstarRepoForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Starred\CbOwnerRcb\CbRepoRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Starred\CbOwnerRcb\CbRepoRcb $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
