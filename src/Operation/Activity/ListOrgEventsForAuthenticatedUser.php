...
final class ListOrgEventsForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Events\Orgs\CbOrgRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Events\Orgs\CbOrgRcb $hydrator, string $username, string $org, int $per_page = 30, int $page = 1)
    {
