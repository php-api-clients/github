...
final class ListPublicEventsForRepoNetwork
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Networks\CbOwnerRcb\CbRepoRcb\Events $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Networks\CbOwnerRcb\CbRepoRcb\Events $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\Event>|\ApiClients\Client\Github\Schema\BasicError
     */
