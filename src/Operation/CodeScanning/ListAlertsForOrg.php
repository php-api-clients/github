...
final class ListAlertsForOrg
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\CodeScanning\Alerts $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\CodeScanning\Alerts $hydrator, string $org, string $tool_name, string|null $tool_guid, string $before, string $after, string $state, string $severity, int $page = 1, int $per_page = 30, string $direction = 'desc', string $sort = 'created')
    {
        $this->org = $org;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\CodeScanningOrganizationAlertItems>|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\CodeScanningOrganizationAlertItems::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : \ApiClients\Client\Github\Schema\CodeScanningOrganizationAlertItems {
                            return $this->hydrator->hydrateObject('\\ApiClients\\Client\\Github\\Schema\\CodeScanningOrganizationAlertItems', $body);
                        });
                }
                break;
            /**Service unavailable**/
