...
final class List_
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Users $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Users $hydrator, int $since, int $per_page = 30)
    {
        $this->since = $since;
