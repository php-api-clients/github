...
final class ListFollowingForUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Following $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Following $hydrator, string $username, int $per_page = 30, int $page = 1)
    {
