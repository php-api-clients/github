...
final class ListFollowedByAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Following $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Following $hydrator, int $per_page = 30, int $page = 1)
    {
