...
final class GetGpgKeyForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\GpgKeys\CbGpgKeyIdRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\GpgKeys\CbGpgKeyIdRcb $hydrator, int $gpg_key_id)
    {
    ...
    /**
     * @return \ApiClients\Client\Github\Schema\GpgKey|\ApiClients\Client\Github\Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\Schema\GpgKey|\ApiClients\Client\Github\Schema\BasicError
    {
