...
final class ListGpgKeysForAuthenticatedUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\GpgKeys $hydrator, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\GpgKey>|\ApiClients\Client\Github\Schema\BasicError
     */
