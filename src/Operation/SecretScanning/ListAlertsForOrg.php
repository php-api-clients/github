...
final class ListAlertsForOrg
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\SecretScanning\Alerts $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\SecretScanning\Alerts $hydrator, string $org, string $state, string $secret_type, string $resolution, string $before, string $after, string $sort = 'created', string $direction = 'desc', int $page = 1, int $per_page = 30)
    {
        $this->org = $org;
        $this->state = $state;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\OrganizationSecretScanningAlert>|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\OrganizationSecretScanningAlert::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : \ApiClients\Client\Github\Schema\OrganizationSecretScanningAlert {
                            return $this->hydrator->hydrateObject('\\ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert', $body);
                        });
                }
                break;
            /**Service unavailable**/
