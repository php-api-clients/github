...
final class ListForUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Repos $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Users\CbUsernameRcb\Repos $hydrator, string $username, string $direction, string $type = 'owner', string $sort = 'full_name', int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\MinimalRepository>
     */
