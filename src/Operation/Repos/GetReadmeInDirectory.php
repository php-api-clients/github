...
final class GetReadmeInDirectory
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Readme\CbDirRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Readme\CbDirRcb $hydrator, string $owner, string $repo, string $dir, string $ref)
    {
        $this->owner = $owner;
        $this->repo = $repo;
        $this->dir = $dir;
