...
final class ListPublic
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Repositories $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repositories $hydrator, int $since)
    {
        $this->since = $since;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\MinimalRepository>|\ApiClients\Client\Github\Schema\ValidationError
     */
