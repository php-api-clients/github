...
final class GetCodeFrequencyStats
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Stats\CodeFrequency $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Stats\CodeFrequency $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\Operation\Repos\GetCodeFrequencyStats\Response\Applicationjson\H200>|\ApiClients\Client\Github\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Dependencies
     */
