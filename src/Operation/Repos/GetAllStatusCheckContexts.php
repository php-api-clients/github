...
final class GetAllStatusCheckContexts
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\RequiredStatusChecks\Contexts $hydrator, string $owner, string $repo, string $branch)
    {
        $this->owner = $owner;
        $this->repo = $repo;
        $this->branch = $branch;
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent>|\ApiClients\Client\Github\Schema\BasicError
     */
