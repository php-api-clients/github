...
final class AddUserAccessRestrictions
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\Restrictions\Users $hydrator;
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\Repos\SetUserAccessRestrictions\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\SimpleUser>|\ApiClients\Client\Github\Schema\ValidationError
     */
