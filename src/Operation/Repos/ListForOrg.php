...
final class ListForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Repos $hydrator, string $org, string $direction, string $type = 'all', string $sort = 'created', int $perPage = 30, int $page = 1)
    {
        $this->org       = $org;
