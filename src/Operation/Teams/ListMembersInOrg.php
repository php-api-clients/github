...
final class ListMembersInOrg
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\Members $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\Members $hydrator, string $org, string $team_slug, string $role = 'all', int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
