...
final class ListDiscussionsLegacy
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Teams\CbTeamIdRcb\Discussions $hydrator, int $team_id, string $direction = 'desc', int $per_page = 30, int $page = 1)
    {
