...
final class ListPackagesForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Packages $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Packages $hydrator, string $package_type, string $visibility)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\Package>
     */
