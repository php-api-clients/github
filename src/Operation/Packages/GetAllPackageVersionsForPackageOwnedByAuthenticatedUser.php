...
final class GetAllPackageVersionsForPackageOwnedByAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions $hydrator, string $package_type, string $package_name, int $page = 1, int $per_page = 30, string $state = 'active')
    {
