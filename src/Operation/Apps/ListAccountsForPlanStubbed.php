...
final class ListAccountsForPlanStubbed
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Plans\CbPlanIdRcb\Accounts $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Plans\CbPlanIdRcb\Accounts $hydrator, int $plan_id, string $direction, string $sort = 'created', int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\MarketplacePurchase>|\ApiClients\Client\Github\Schema\BasicError
     */
