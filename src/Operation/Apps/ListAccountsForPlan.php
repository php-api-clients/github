...
final class ListAccountsForPlan
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Plans\CbPlanIdRcb\Accounts $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Plans\CbPlanIdRcb\Accounts $hydrator, int $plan_id, string $direction, string $sort = 'created', int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\MarketplacePurchase>|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\ValidationError
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : \ApiClients\Client\Github\Schema\MarketplacePurchase {
