...
final class GetSubscriptionPlanForAccountStubbed
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Accounts\CbAccountIdRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Accounts\CbAccountIdRcb $hydrator, int $account_id)
    {
