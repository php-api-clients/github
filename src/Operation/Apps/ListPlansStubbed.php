...
final class ListPlansStubbed
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Plans $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\MarketplaceListing\Stubbed\Plans $hydrator, int $per_page = 30, int $page = 1)
    {
