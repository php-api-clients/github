...
final class GetRestrictionsForRepo
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\InteractionLimits $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
