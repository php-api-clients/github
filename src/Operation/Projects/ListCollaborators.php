...
final class ListCollaborators
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators $hydrator, int $project_id, string $affiliation = 'all', int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<\ApiClients\Client\Github\Schema\SimpleUser>|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\ValidationError
     */
