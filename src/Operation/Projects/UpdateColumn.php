...
final class UpdateColumn
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Projects\Columns\CbColumnIdRcb $hydrator, int $column_id)
    {
    ...
    /**
     * @return \ApiClients\Client\Github\Schema\ProjectColumn|\ApiClients\Client\Github\Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\Schema\ProjectColumn|\ApiClients\Client\Github\Schema\BasicError
    {
