...
final class RemoveCollaborator
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators\CbUsernameRcb $hydrator, int $project_id, string $username)
    {
