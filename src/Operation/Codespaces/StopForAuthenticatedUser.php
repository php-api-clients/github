...
final class StopForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Stop $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Stop $hydrator, string $codespace_name)
    {
