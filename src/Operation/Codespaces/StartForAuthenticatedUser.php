...
final class StartForAuthenticatedUser
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Start $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Start $hydrator, string $codespace_name)
    {
    ...
    /**
     * @return \ApiClients\Client\Github\Schema\Codespace|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\ScimError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \ApiClients\Client\Github\Schema\Codespace|\ApiClients\Client\Github\Schema\BasicError|\ApiClients\Client\Github\Schema\ScimError
    {
