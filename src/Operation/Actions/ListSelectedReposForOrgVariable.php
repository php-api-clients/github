...
final class ListSelectedReposForOrgVariable
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Variables\CbNameRcb\Repositories $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Variables\CbNameRcb\Repositories $hydrator, string $org, string $name, int $page = 1, int $per_page = 30)
    {
        $this->org = $org;
        $this->name = $name;
        $this->page = $page;
