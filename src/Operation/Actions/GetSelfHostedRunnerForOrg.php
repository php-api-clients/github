...
final class GetSelfHostedRunnerForOrg
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Runners\CbRunnerIdRcb $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, \ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Actions\Runners\CbRunnerIdRcb $hydrator, string $org, int $runner_id)
    {
        $this->org = $org;
