...
final class SetWorkflowAccessToRepository
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\ActionsWorkflowAccessToRepository::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
