...
final class SetGithubActionsPermissionsRepository
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\Actions\SetGithubActionsPermissionsRepository\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
