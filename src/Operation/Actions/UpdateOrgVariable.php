...
final class UpdateOrgVariable
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\Actions\UpdateOrgVariable\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
