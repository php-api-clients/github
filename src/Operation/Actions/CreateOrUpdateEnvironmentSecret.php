...
final class CreateOrUpdateEnvironmentSecret
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\Actions\CreateOrUpdateEnvironmentSecret\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
