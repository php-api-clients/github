...
final class Orgs
{
    ...
    public function listBlockedUsers(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\Orgs\ListBlockedUsers($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Blocks());
    ...
    public function listFailedInvitations(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\Orgs\ListFailedInvitations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀FailedInvitations());
    ...
    public function listPendingInvitations(array $params): iterable
    {
        ...
        $operator = new Operator\Orgs\ListPendingInvitations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Invitations());
    ...
    public function checkBlockedUser(array $params): array
    {
        ...
        $arguments['username'] = $params['username'];
        unset($params['username']);
        $operator = new Operator\Orgs\CheckBlockedUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Blocks🌀Username());
    ...
    public function listInvitationTeams(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\Orgs\ListInvitationTeams($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Invitations🌀InvitationId🌀Teams());
