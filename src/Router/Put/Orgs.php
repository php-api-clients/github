...
final class Orgs
{
    ...
    public function blockUser(array $params): array
    {
        ...
        $operator = new Operator\Orgs\BlockUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Blocks🌀Username());
