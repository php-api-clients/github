...
final class Copilot
{
    ...
    public function addCopilotForBusinessSeatsForTeams(array $params): Created|array
    {
        ...
        unset($params['org']);
        $operator = new Operator\Copilot\AddCopilotForBusinessSeatsForTeams($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedTeams());
    ...
    public function addCopilotForBusinessSeatsForUsers(array $params): Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Copilot\AddCopilotForBusinessSeatsForUsers($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedUsers());
