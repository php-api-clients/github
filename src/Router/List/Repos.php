...
final class Repos
{
    ...
    public function getOrgRulesetsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\GetOrgRulesetsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Rulesets());
    ...
    public function getRepoRulesetsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\GetRepoRulesetsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Rulesets());
    ...
    public function getBranchRulesListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\GetBranchRulesListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Rules🌀Branches🌀Branch());
