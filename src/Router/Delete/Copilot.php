...
final class Copilot
{
    ...
    public function cancelCopilotSeatAssignmentForTeams(array $params): Ok|array
    {
        ...
        unset($params['org']);
        $operator = new Operator\Copilot\CancelCopilotSeatAssignmentForTeams($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedTeams());
    ...
    public function cancelCopilotSeatAssignmentForUsers(array $params): Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Copilot\CancelCopilotSeatAssignmentForUsers($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedUsers());
