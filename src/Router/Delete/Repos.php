...
final class Repos
{
    ...
    public function deleteOrgRuleset(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeleteOrgRuleset($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Rulesets🌀RulesetId());
    ...
    public function disablePrivateVulnerabilityReporting(array $params): array
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Operator\Repos\DisablePrivateVulnerabilityReporting($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀PrivateVulnerabilityReporting());
    ...
    public function deleteRepoRuleset(array $params): array
    {
        ...
        $arguments['ruleset_id'] = $params['ruleset_id'];
        unset($params['ruleset_id']);
        $operator = new Operator\Repos\DeleteRepoRuleset($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Rulesets🌀RulesetId());
