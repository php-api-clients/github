...
final class Orgs
{
    ...
    public function cancelInvitation(array $params): array
    {
        ...
        $operator = new Operator\Orgs\CancelInvitation($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Invitations🌀InvitationId());
