...
final readonly class GetRepoRulesetsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\GetRepoRulesetsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page, $includesParents);
