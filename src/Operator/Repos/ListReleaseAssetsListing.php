...
final readonly class ListReleaseAssetsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListReleaseAssetsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId, $perPage, $page);
