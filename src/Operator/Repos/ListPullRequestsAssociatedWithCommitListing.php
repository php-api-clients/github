...
final readonly class ListPullRequestsAssociatedWithCommitListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListPullRequestsAssociatedWithCommitListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha, $perPage, $page);
