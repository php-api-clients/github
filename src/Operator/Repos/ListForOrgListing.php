...
final readonly class ListForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $direction, $type, $sort, $perPage, $page);
