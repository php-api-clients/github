...
final readonly class ListCollaboratorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListCollaboratorsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $permission, $affiliation, $perPage, $page);
