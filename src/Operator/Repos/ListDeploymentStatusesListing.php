...
final readonly class ListDeploymentStatusesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListDeploymentStatusesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $deploymentId, $perPage, $page);
