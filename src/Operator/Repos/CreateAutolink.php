...
final readonly class CreateAutolink
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\CreateAutolink($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
