...
final readonly class ListCommitCommentsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListCommitCommentsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
