...
final readonly class SetTeamAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\SetTeamAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
