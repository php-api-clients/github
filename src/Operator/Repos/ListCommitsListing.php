...
final readonly class ListCommitsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Repos\ListCommitsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sha, $path, $author, $committer, $since, $until, $perPage, $page);
