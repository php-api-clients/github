...
final readonly class ListRepoOrganizationSecrets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Actions\ListRepoOrganizationSecrets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
