...
final readonly class ReRunWorkflow
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Actions\ReRunWorkflow($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
