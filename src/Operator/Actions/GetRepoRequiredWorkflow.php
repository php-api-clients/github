...
final readonly class GetRepoRequiredWorkflow
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Actions\GetRepoRequiredWorkflow($this->responseSchemaValidator, $this->hydrator, $org, $repo, $requiredWorkflowIdForRepo);
