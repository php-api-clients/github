...
final readonly class ListRequiredWorkflowRuns
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Actions\ListRequiredWorkflowRuns($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $requiredWorkflowIdForRepo, $actor, $branch, $event, $status, $created, $checkSuiteId, $headSha, $perPage, $page, $excludePullRequests);
