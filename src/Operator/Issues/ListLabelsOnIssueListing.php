...
final readonly class ListLabelsOnIssueListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Issues\ListLabelsOnIssueListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
