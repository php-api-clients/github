...
final readonly class ListEventsForTimeline
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Issues\ListEventsForTimeline($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
