...
final readonly class ListCommentsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Issues\ListCommentsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $direction, $since, $sort, $perPage, $page);
