...
final readonly class ListEventsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Issues\ListEventsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
