...
final readonly class ListForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Issues\ListForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $labels, $since, $filter, $state, $sort, $direction, $perPage, $page);
