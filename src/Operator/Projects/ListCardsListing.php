...
final readonly class ListCardsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Projects\ListCardsListing($this->responseSchemaValidator, $this->hydrator, $columnId, $archivedState, $perPage, $page);
