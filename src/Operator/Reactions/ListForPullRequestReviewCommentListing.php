...
final readonly class ListForPullRequestReviewCommentListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Reactions\ListForPullRequestReviewCommentListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId, $content, $perPage, $page);
