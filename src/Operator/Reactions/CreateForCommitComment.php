...
final readonly class CreateForCommitComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Reactions\CreateForCommitComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
