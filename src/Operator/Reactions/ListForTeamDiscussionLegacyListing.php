...
final readonly class ListForTeamDiscussionLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Reactions\ListForTeamDiscussionLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber, $content, $perPage, $page);
