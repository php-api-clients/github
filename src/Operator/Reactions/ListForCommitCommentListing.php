...
final readonly class ListForCommitCommentListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Reactions\ListForCommitCommentListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId, $content, $perPage, $page);
