...
final readonly class ListAlertInstancesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\CodeScanning\ListAlertInstancesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber, $ref, $page, $perPage);
