...
final readonly class ListPatGrantsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListPatGrantsListing($this->responseSchemaValidator, $this->hydrator, $org, $owner, $repository, $permission, $lastUsedBefore, $lastUsedAfter, $perPage, $page, $sort, $direction);
