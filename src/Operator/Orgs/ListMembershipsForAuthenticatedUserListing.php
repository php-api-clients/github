...
final readonly class ListMembershipsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListMembershipsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $state, $perPage, $page);
