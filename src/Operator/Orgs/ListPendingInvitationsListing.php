...
final readonly class ListPendingInvitationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListPendingInvitationsListing($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page, $role, $invitationSource);
