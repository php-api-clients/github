...
final readonly class ListPatGrantRequestRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListPatGrantRequestRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patRequestId, $perPage, $page);
