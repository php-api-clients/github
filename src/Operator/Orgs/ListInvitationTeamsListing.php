...
final readonly class ListInvitationTeamsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListInvitationTeamsListing($this->responseSchemaValidator, $this->hydrator, $org, $invitationId, $perPage, $page);
