...
final readonly class ListOutsideCollaboratorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListOutsideCollaboratorsListing($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
