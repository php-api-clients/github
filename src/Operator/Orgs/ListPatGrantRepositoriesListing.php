...
final readonly class ListPatGrantRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListPatGrantRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patId, $perPage, $page);
