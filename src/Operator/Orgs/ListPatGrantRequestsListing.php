...
final readonly class ListPatGrantRequestsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Orgs\ListPatGrantRequestsListing($this->responseSchemaValidator, $this->hydrator, $org, $owner, $repository, $permission, $lastUsedBefore, $lastUsedAfter, $perPage, $page, $sort, $direction);
