...
final readonly class GetCopilotSeatAssignmentDetailsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Copilot\GetCopilotSeatAssignmentDetailsForUser($this->responseSchemaValidator, $this->hydrator, $org, $username);
