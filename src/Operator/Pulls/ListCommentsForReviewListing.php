...
final readonly class ListCommentsForReviewListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Pulls\ListCommentsForReviewListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $reviewId, $perPage, $page);
