...
final readonly class ListCommitsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Pulls\ListCommitsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
