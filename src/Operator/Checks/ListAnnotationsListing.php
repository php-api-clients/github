...
final readonly class ListAnnotationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Checks\ListAnnotationsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId, $perPage, $page);
