...
final readonly class UpdateImport
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Migrations\UpdateImport($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
