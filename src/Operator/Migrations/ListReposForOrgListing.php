...
final readonly class ListReposForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Migrations\ListReposForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $migrationId, $perPage, $page);
