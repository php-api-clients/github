...
final readonly class GetAllPackageVersionsForPackageOwnedByOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrgListing($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org, $page, $perPage, $state);
