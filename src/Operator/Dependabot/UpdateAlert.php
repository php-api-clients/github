...
final readonly class UpdateAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Dependabot\UpdateAlert($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber);
