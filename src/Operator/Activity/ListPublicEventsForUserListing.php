...
final readonly class ListPublicEventsForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListPublicEventsForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
