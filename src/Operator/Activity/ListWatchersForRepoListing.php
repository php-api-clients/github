...
final readonly class ListWatchersForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListWatchersForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
