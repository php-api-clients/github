...
final readonly class ListReceivedEventsForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListReceivedEventsForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
