...
final readonly class ListReposWatchedByUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListReposWatchedByUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
