...
final readonly class ListRepoNotificationsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListRepoNotificationsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $since, $before, $all, $participating, $perPage, $page);
