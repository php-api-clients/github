...
final readonly class ListReposStarredByAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListReposStarredByAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $sort, $direction, $perPage, $page);
