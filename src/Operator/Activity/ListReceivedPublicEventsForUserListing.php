...
final readonly class ListReceivedPublicEventsForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Activity\ListReceivedPublicEventsForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
