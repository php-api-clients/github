...
final readonly class ListAccountsForPlanStubbedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Apps\ListAccountsForPlanStubbedListing($this->responseSchemaValidator, $this->hydrator, $planId, $direction, $sort, $perPage, $page);
