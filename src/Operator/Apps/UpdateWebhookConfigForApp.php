...
final readonly class UpdateWebhookConfigForApp
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Apps\UpdateWebhookConfigForApp($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
