...
final readonly class DeleteCodespacesBillingUsers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Codespaces\DeleteCodespacesBillingUsers($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
