...
final readonly class ListDiscussionsInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Teams\ListDiscussionsInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $pinned, $direction, $perPage, $page);
