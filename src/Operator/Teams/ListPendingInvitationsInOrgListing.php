...
final readonly class ListPendingInvitationsInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Teams\ListPendingInvitationsInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
