...
final readonly class ListPendingInvitationsLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Teams\ListPendingInvitationsLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $perPage, $page);
