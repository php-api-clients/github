...
final readonly class ListMembersInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Teams\ListMembersInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $role, $perPage, $page);
