...
final readonly class ListDiscussionsInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Teams\ListDiscussionsInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $pinned, $direction, $perPage, $page);
