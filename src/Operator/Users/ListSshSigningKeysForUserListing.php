...
final readonly class ListSshSigningKeysForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Users\ListSshSigningKeysForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
