...
final readonly class ListFollowersForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Users\ListFollowersForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
