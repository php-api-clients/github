...
final readonly class ListSocialAccountsForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Users\ListSocialAccountsForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
