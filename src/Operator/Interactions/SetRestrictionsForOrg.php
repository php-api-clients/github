...
final readonly class SetRestrictionsForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Operation\Interactions\SetRestrictionsForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
