...
final class Fork implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\WebHook\Fork $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\Hydrator\WebHook\Fork $hydrator)
    {
        $this->requestSchemaValidator = $requestSchemaValidator;
    }
    public function resolve(array $headers, array $data) : \ApiClients\Client\Github\Schema\WebhookFork
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookFork::class, $data);
