...
final class BranchProtectionRule implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\WebHook\BranchProtectionRule $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\Hydrator\WebHook\BranchProtectionRule $hydrator)
    {
        $this->requestSchemaValidator = $requestSchemaValidator;
    }
    public function resolve(array $headers, array $data) : \ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleCreated|\ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleDeleted|\ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleEdited
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleCreated::class, $data);
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleDeleted::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaab;
            }
        }
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookBranchProtectionRuleEdited::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaac;
            }
        }
