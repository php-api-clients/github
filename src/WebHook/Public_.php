...
final class Public_ implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\WebHook\Public_ $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\Hydrator\WebHook\Public_ $hydrator)
    {
        $this->requestSchemaValidator = $requestSchemaValidator;
    }
    public function resolve(array $headers, array $data) : \ApiClients\Client\Github\Schema\WebhookPublic
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookPublic::class, $data);
