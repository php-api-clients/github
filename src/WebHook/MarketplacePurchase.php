...
final class MarketplacePurchase implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    ...
    private readonly \ApiClients\Client\Github\Hydrator\WebHook\MarketplacePurchase $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \ApiClients\Client\Github\Hydrator\WebHook\MarketplacePurchase $hydrator)
    {
        $this->requestSchemaValidator = $requestSchemaValidator;
    }
    public function resolve(array $headers, array $data) : \ApiClients\Client\Github\Schema\WebhookMarketplacePurchaseCancelled|\ApiClients\Client\Github\Schema\WebhookMarketplacePurchaseChanged|\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePendingChange|\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePendingChangeCancelled|\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePurchased
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookMarketplacePurchaseCancelled::class, $data);
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookMarketplacePurchaseChanged::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaab;
            }
        }
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePendingChange::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaac;
            }
        }
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePendingChangeCancelled::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaad;
            }
        }
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], \cebe\openapi\Reader::readFromJson(\ApiClients\Client\Github\Schema\WebHookHeader\UserAgent::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                return $this->hydrator->hydrateObject(\ApiClients\Client\Github\Schema\WebhookMarketplacePurchasePurchased::class, $data);
            } catch (\Throwable $error) {
                goto actions_aaaae;
            }
        }
