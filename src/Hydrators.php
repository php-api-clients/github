...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest', 'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokenRequests()->hydrateObject($className, $payload),
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectClosed', 'ApiClients\\Client\\GitHub\\Schema\\ProjectsV2', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectCreated', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectDeleted', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectEdited', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectEdited\\Changes', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectEdited\\Changes\\Public_', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectEdited\\Changes\\Title', 'ApiClients\\Client\\GitHub\\Schema\\WebhookProjectsV2ProjectReopened' => $this->getObjectMapperWebHook🪝ProjectsV2()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest', 'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokenRequests()->serializeObject($object),
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseCreated', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseCreated\\Release', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseCreated\\Release\\Assets', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseDeleted', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseEdited', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseEdited\\Changes', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseEdited\\Changes\\MakeLatest', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleasePrereleased', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleasePublished', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseReleased', 'ApiClients\\Client\\GitHub\\Schema\\WebhookReleaseUnpublished' => $this->getObjectMapperWebHook🪝Release()->serializeObject($object),
