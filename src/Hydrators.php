...
final class Hydrators implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery', '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery\\Request', '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery\\Response' => $this->getObjectMapperOperation🌀App🌀Hook🌀Deliveries🌀DeliveryId()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\WebhookDeploymentCreated\\Deployment\\Payload\\Zero' => $this->getObjectMapperOperation🌀App🌀Hook🌀Deliveries🌀DeliveryId🌀Attempts()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions\\Organization' => $this->getObjectMapperOperation🌀Emojis()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\GistSimple', '\\ApiClients\\Client\\GitHub\\Schema\\GistSimple\\ForkOf' => $this->getObjectMapperOperation🌀Gists()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\BaseGist' => $this->getObjectMapperOperation🌀Gists🌀GistId🌀Forks()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Thread', '\\ApiClients\\Client\\GitHub\\Schema\\MinimalRepository', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\MinimalRepository\\License', '\\ApiClients\\Client\\GitHub\\Schema\\SecurityAndAnalysis', '\\ApiClients\\Client\\GitHub\\Schema\\SecurityAndAnalysis\\AdvancedSecurity', '\\ApiClients\\Client\\GitHub\\Schema\\Thread\\Subject' => $this->getObjectMapperOperation🌀Notifications🌀Threads🌀ThreadId()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationFull', '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationFull\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀Org()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRequiredWorkflows\\Response\\ApplicationJson\\Ok', '\\ApiClients\\Client\\GitHub\\Schema\\RequiredWorkflow' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀RequiredWorkflows()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\AuthenticationToken' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RegistrationToken()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\Runner' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RunnerId()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListLabelsForSelfHostedRunnerForOrg\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RunnerId🌀Labels()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Orgs\\RemoveOutsideCollaborator\\Response\\ApplicationJson\\UnprocessableEntity' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀OutsideCollaborators🌀Username()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Repository', '\\ApiClients\\Client\\GitHub\\Schema\\LicenseSimple', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository\\Owner' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Repos()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset', '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset\\Links\\Self_' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Rulesets()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamFull', '\\ApiClients\\Client\\GitHub\\Schema\\TeamSimple', '\\ApiClients\\Client\\GitHub\\Schema\\TeamOrganization' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamProject', '\\ApiClients\\Client\\GitHub\\Schema\\TeamProject\\Permissions' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀Projects🌀ProjectId()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamRepository' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀Repos🌀Owner🌀Repo()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Projects\\MoveCard\\Response\\ApplicationJson\\Forbidden', '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Projects\\MoveCard\\Response\\ApplicationJson\\ServiceUnavailable' => $this->getObjectMapperOperation🌀Projects🌀Columns🌀Cards🌀CardId🌀Moves()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRepoRequiredWorkflows\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\RepoRequiredWorkflow' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage\\Billable', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage\\Billable\\Ubuntu' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo🌀Timing()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\FullRepository', '\\ApiClients\\Client\\GitHub\\Schema\\FullRepository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\CodeOfConductSimple' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRequiredWorkflowRuns\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo🌀Runs()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRun', '\\ApiClients\\Client\\GitHub\\Schema\\SimpleCommit', '\\ApiClients\\Client\\GitHub\\Schema\\SimpleCommit\\Author' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage\\Billable', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage\\Billable\\Ubuntu' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Timing()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\CodeScanningAnalysis', '\\ApiClients\\Client\\GitHub\\Schema\\Deployment\\Payload\\Zero', '\\ApiClients\\Client\\GitHub\\Schema\\CodeScanningAnalysisDeletion' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Analyses🌀AnalysisId()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\ContentTree', '\\ApiClients\\Client\\GitHub\\Schema\\ContentTree\\Entries\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Content', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Content\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Author', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Tree', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Verification' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Contents🌀Path()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlert', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertWithRepository\\Dependency', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertPackage', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityAdvisory', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityAdvisory\\Cvss', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityVulnerability', '\\ApiClients\\Client\\GitHub\\Schema\\DependabotAlertSecurityVulnerability\\FirstPatchedVersion' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Dependabot🌀Alerts🌀AlertNumber()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Deployment' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Author', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Tree', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Verification' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Git🌀Commits()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\LicenseContent' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀License()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Head', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Head\\Repo', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Head\\Repo\\Owner', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Head\\Repo\\License', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Base', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequest\\Base\\Repo', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestSimple\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\Link', '\\ApiClients\\Client\\GitHub\\Schema\\AutoMerge' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestMergeResult' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Merge()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestReviewRequest', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestSimple', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestSimple\\Head' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀RequestedReviewers()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestReview', '\\ApiClients\\Client\\GitHub\\Schema\\TimelineReviewedEvent\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\TimelineReviewedEvent\\Links\\Html' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Reviews()->hydrateObject($className, $payload),
            '\\ApiClients\\Client\\GitHub\\Schema\\ContentFile' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Readme()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\PrivateUser', '\\ApiClients\\Client\\GitHub\\Schema\\PublicUser\\Plan' => $this->getObjectMapperOperation🌀User()->hydrateObject($className, $payload),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\CodespaceWithFullRepository' => $this->getObjectMapperOperation🌀User🌀Codespaces🌀CodespaceName🌀Publish()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery', '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery\\Request', '\\ApiClients\\Client\\GitHub\\Schema\\HookDelivery\\Response' => $this->getObjectMapperOperation🌀App🌀Hook🌀Deliveries🌀DeliveryId()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\WebhookDeploymentCreated\\Deployment\\Payload\\Zero' => $this->getObjectMapperOperation🌀App🌀Hook🌀Deliveries🌀DeliveryId🌀Attempts()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions\\Organization' => $this->getObjectMapperOperation🌀Emojis()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\GistSimple', '\\ApiClients\\Client\\GitHub\\Schema\\GistSimple\\ForkOf' => $this->getObjectMapperOperation🌀Gists()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\BaseGist' => $this->getObjectMapperOperation🌀Gists🌀GistId🌀Forks()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Thread', '\\ApiClients\\Client\\GitHub\\Schema\\MinimalRepository', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\MinimalRepository\\License', '\\ApiClients\\Client\\GitHub\\Schema\\SecurityAndAnalysis', '\\ApiClients\\Client\\GitHub\\Schema\\SecurityAndAnalysis\\AdvancedSecurity', '\\ApiClients\\Client\\GitHub\\Schema\\Thread\\Subject' => $this->getObjectMapperOperation🌀Notifications🌀Threads🌀ThreadId()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationFull', '\\ApiClients\\Client\\GitHub\\Schema\\OrganizationFull\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀Org()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRequiredWorkflows\\Response\\ApplicationJson\\Ok', '\\ApiClients\\Client\\GitHub\\Schema\\RequiredWorkflow' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀RequiredWorkflows()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\AuthenticationToken' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RegistrationToken()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\Runner' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RunnerId()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListLabelsForSelfHostedRunnerForOrg\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀RunnerId🌀Labels()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Orgs\\RemoveOutsideCollaborator\\Response\\ApplicationJson\\UnprocessableEntity' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀OutsideCollaborators🌀Username()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Repository', '\\ApiClients\\Client\\GitHub\\Schema\\LicenseSimple', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository', '\\ApiClients\\Client\\GitHub\\Schema\\Repository\\TemplateRepository\\Owner' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Repos()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset', '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\RepositoryRuleset\\Links\\Self_' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Rulesets()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamFull', '\\ApiClients\\Client\\GitHub\\Schema\\TeamSimple', '\\ApiClients\\Client\\GitHub\\Schema\\TeamOrganization' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamProject', '\\ApiClients\\Client\\GitHub\\Schema\\TeamProject\\Permissions' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀Projects🌀ProjectId()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\TeamRepository' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀Repos🌀Owner🌀Repo()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Projects\\MoveCard\\Response\\ApplicationJson\\Forbidden', '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Projects\\MoveCard\\Response\\ApplicationJson\\ServiceUnavailable' => $this->getObjectMapperOperation🌀Projects🌀Columns🌀Cards🌀CardId🌀Moves()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRepoRequiredWorkflows\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\RepoRequiredWorkflow' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage\\Billable', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowUsage\\Billable\\Ubuntu' => $this->getObjectMapperOperation🌀Repos🌀Org🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo🌀Timing()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\FullRepository', '\\ApiClients\\Client\\GitHub\\Schema\\FullRepository\\Permissions', '\\ApiClients\\Client\\GitHub\\Schema\\CodeOfConductSimple' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Operations\\Actions\\ListRequiredWorkflowRuns\\Response\\ApplicationJson\\Ok' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀RequiredWorkflows🌀RequiredWorkflowIdForRepo🌀Runs()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRun', '\\ApiClients\\Client\\GitHub\\Schema\\SimpleCommit', '\\ApiClients\\Client\\GitHub\\Schema\\SimpleCommit\\Author' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage\\Billable', '\\ApiClients\\Client\\GitHub\\Schema\\WorkflowRunUsage\\Billable\\Ubuntu' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Timing()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\CodeScanningAnalysis', '\\ApiClients\\Client\\GitHub\\Schema\\Deployment\\Payload\\Zero', '\\ApiClients\\Client\\GitHub\\Schema\\CodeScanningAnalysisDeletion' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Analyses🌀AnalysisId()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\ContentTree', '\\ApiClients\\Client\\GitHub\\Schema\\ContentTree\\Entries\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Content', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Content\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Author', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Tree', '\\ApiClients\\Client\\GitHub\\Schema\\FileCommit\\Commit\\Verification' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Contents🌀Path()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\Deployment' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Author', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Tree', '\\ApiClients\\Client\\GitHub\\Schema\\GitCommit\\Verification' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Git🌀Commits()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\LicenseContent' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀License()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestMergeResult' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Merge()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestReviewRequest', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestSimple', '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestSimple\\Head' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀RequestedReviewers()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\PullRequestReview', '\\ApiClients\\Client\\GitHub\\Schema\\TimelineReviewedEvent\\Links', '\\ApiClients\\Client\\GitHub\\Schema\\TimelineReviewedEvent\\Links\\Html' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Reviews()->serializeObject($object),
            '\\ApiClients\\Client\\GitHub\\Schema\\ContentFile' => $this->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Readme()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\PrivateUser', '\\ApiClients\\Client\\GitHub\\Schema\\PublicUser\\Plan' => $this->getObjectMapperOperation🌀User()->serializeObject($object),
            ...
            '\\ApiClients\\Client\\GitHub\\Schema\\CodespaceWithFullRepository' => $this->getObjectMapperOperation🌀User🌀Codespaces🌀CodespaceName🌀Publish()->serializeObject($object),
