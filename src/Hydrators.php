...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant', 'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant', 'ApiClients\\Client\\GitHub\\Schema\\OrganizationProgrammaticAccessGrant\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->serializeObject($object),
