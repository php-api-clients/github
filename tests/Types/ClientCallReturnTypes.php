...
assertType('Schema\\Operations\\Actions\\ListHostedRunnersForOrg\\Response\\ApplicationJson\\Ok', $client->call('GET /orgs/{org}/actions/hosted-runners'));
assertType('Schema\\ActionsHostedRunner', $client->call('POST /orgs/{org}/actions/hosted-runners'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersGithubOwnedImagesForOrg\\Response\\ApplicationJson\\Ok', $client->call('GET /orgs/{org}/actions/hosted-runners/images/github-owned'));
...
assertType('Schema\\Operations\\Actions\\GetHostedRunnersMachineSpecsForOrg\\Response\\ApplicationJson\\Ok', $client->call('GET /orgs/{org}/actions/hosted-runners/machine-sizes'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersPlatformsForOrg\\Response\\ApplicationJson\\Ok', $client->call('GET /orgs/{org}/actions/hosted-runners/platforms'));
