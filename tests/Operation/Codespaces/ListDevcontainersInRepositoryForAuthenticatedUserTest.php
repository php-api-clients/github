...
final class ListDevcontainersInRepositoryForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHub\Operation\Codespaces\ListDevcontainersInRepositoryForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
