...
final class RemoveRepositoryForSecretForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_401_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHub\Operation\Codespaces\RemoveRepositoryForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
