...
final class ListRepositoriesForSecretForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHub\Operation\Codespaces\ListRepositoriesForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
