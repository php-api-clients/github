...
/** @covers \ApiClients\Client\GitHub\Operation\Actions\RemoveCustomLabelFromSelfHostedRunnerForRepo */
final class RemoveCustomLabelFromSelfHostedRunnerForRepoTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Actions\ListLabelsForSelfHostedRunnerForOrg\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA, true)));
