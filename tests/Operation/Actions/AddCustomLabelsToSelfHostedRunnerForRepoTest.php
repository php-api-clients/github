...
final class AddCustomLabelsToSelfHostedRunnerForRepoTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runners/9/labels', Argument::type('array'), Schema\Actions\AddCustomLabelsToSelfHostedRunnerForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runners/9/labels', Argument::type('array'), Schema\Actions\AddCustomLabelsToSelfHostedRunnerForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->actions()->addCustomLabelsToSelfHostedRunnerForRepo('generated', 'generated', 9, json_decode(Schema\Actions\AddCustomLabelsToSelfHostedRunnerForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
